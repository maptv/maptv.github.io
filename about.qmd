...
My blog is organized into two series of posts. The first series focuses on [tools](blog#category=tool) for authoring and publishing digital content, while the second series covers many topics in [machine learning](blog#category=ml).
