...
A [tzo]{.tool data-bs-toggle="tooltip" data-bs-title="time zone offset"} that is displayed as part of a Dec time can be an integer, fraction, or decimal. The structure of a Dec time can be summarized as [tod]{.tool data-bs-toggle="tooltip" data-bs-title="time of day"}[-]{.mono}[tzo]{.tool data-bs-toggle="tooltip" data-bs-title="time zone offset"}. The [UT]{.tool data-bs-toggle="tooltip" data-bs-title="Universal Time"} that corresponds to the [tzo]{.tool data-bs-toggle="tooltip" data-bs-title="time zone offset"} shown above is \${leapTodHsl0}[-]{.mono}\${leapTzoHsl1}. In essence, Dec times are math expressions that can be simplified to the Zone [0]{.color0} [tod]{.tool data-bs-toggle="tooltip" data-bs-title="time of day"}: \${leapTodHsl1} -- \${leapTzoHsl2} = \${zeroTimeHsl4}.
