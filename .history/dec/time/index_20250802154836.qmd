...
ha
With [sda]{.tool data-bs-toggle="tooltip" data-bs-title="solar declination angle"}($\gamma$), we can calculate the "solar hour angle" ([sha]{.tool data-bs-toggle="tooltip" data-bs-title="solar hour angle"}). In the [sha]{.tool data-bs-toggle="tooltip" data-bs-title="solar hour angle"} equation below, the "solar zenith angle" ([sza]{.tool data-bs-toggle="tooltip" data-bs-title="solar zenith angle"}) is set to 0.2523 turns. Instead of radians or degrees, Dec measures angles such as [sda]{.tool data-bs-toggle="tooltip" data-bs-title="solar declination angle"}, [sza]{.tool data-bs-toggle="tooltip" data-bs-title="solar zenith angle"}, and [sha]{.tool data-bs-toggle="tooltip" data-bs-title="solar hour angle"} in turns. The trigonometric functions of most --- if not all -- programming languages accept radians. To convert turns into radians, we multiply by $\tau$. The Dec unit of latitude, the meridian ($\phi$), is a type of turn.
...
$$\text{sha} = \pm \arccos\left( \frac{\cos(0.2523\tau)}{\cos(\phi\tau) \cdot \cos(\text{sda}\tau)} - \tan(\text{$\phi\tau$}) \cdot \tan(\text{sda}\tau) \right)$$
