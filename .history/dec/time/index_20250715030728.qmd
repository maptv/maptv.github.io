...
A Dec time consists of a "time of day" ([tod]{.tool data-bs-toggle="tooltip" data-bs-title="time of day"}) and a time zone: \${selTimeHsl1}[--]{style="font-family:monospace;"}\${selZoneHsl}. The [tod]{.tool data-bs-toggle="tooltip" data-bs-title="time of day"} denoted by the red🔴dot is \${selTimeDay} days or \${selTimeHsl0} [decidays]{.tool data-bs-toggle="tooltip" data-bs-title="tenths of a day"}. The "day of year" ([doy]{.tool data-bs-toggle="tooltip" data-bs-title="day of year"}) indicated by the red<font color=red>—</font>line is \${selDateHsl}. Together, a [doy]{.tool data-bs-toggle="tooltip" data-bs-title="day of year"} and [tod]{.tool data-bs-toggle="tooltip" data-bs-title="time of day"} form either a "yearly day aggregate" ([yda]{.tool data-bs-toggle="tooltip" data-bs-title="yearly day aggregate"}), \${selSnapDay}, or a "yearly deciday aggregate" ([ydda]{.tool data-bs-toggle="tooltip" data-bs-title="yearly deciday aggregate"}): \${selSnapDec}.

## Yearly day aggregate (yda) {#yda .hiddenheading}

The first three digits of an [yda]{.tool data-bs-toggle="tooltip" data-bs-title="yearly-day-aggregate"} are a [doy]{.tool data-bs-toggle="tooltip" data-bs-title="day of year"}, \${decDateHsl}, its first two digits are a group of ten days called a dek, , its third digit is a "day of dek" ([dod]{.tool data-bs-toggle="tooltip" data-bs-title="day of dek"}), \${decDodHsl}, and the remaining digits are a [tod]{.tool data-bs-toggle="tooltip" data-bs-title="time of day"}: . The [doy]{.tool data-bs-toggle="tooltip" data-bs-title="day of year"} identifies a day in an unspecified year like a [Gregorian calendar](https://en.wikipedia.org/wiki/Gregorian_calendar#:~:text=the%20calendar%20used%20in%20most%20parts%20of%20the%20world) month and "day of month" ([dom]{.tool data-bs-toggle="tooltip" data-bs-title="day of month"}) pair, the [dod]{.tool data-bs-toggle="tooltip" data-bs-title="day of dek"} classifies that day as a work or rest day like a "day of week" ([dow]{.tool data-bs-toggle="tooltip" data-bs-title="day of week"}), and the [tod]{.tool data-bs-toggle="tooltip" data-bs-title="time of day"} specifies a point in that day like an "hour minute second" ([hms]{.tool data-bs-toggle="tooltip" data-bs-title="hour minute second"}) triplet.
...
In the same manner as an [eda]{.tool data-bs-toggle="tooltip" data-bs-title="epochal day aggregate"} tracks the days since the Dec epoch, a [Julian date](https://en.wikipedia.org/wiki/Julian_day#:~:text=the%20Julian%20day%20number%20plus%20the%20fraction%20of%20a%20day%20since%20the%20preceding%20noon) tallies the days since the beginning of the [Julian period](https://en.wikipedia.org/wiki/Julian_day#:~:text=a%20chronological%20interval%20of%207980%C2%A0years%2C%20derived%20from%20three%20multi%2Dyear%20cycles:%20the%20Indiction%2C%20Solar%2C%20and%20Lunar%20cycles). Whereas the Dec and UNIX epochs occurred at midnight ([0]{.color0} [decidays]{.tool data-bs-toggle="tooltip" data-bs-title="tenths of a day"}), the [Julian period](https://en.wikipedia.org/wiki/Julian_day#:~:text=a%20chronological%20interval%20of%207980%C2%A0years%2C%20derived%20from%20three%20multi%2Dyear%20cycles:%20the%20Indiction%2C%20Solar%2C%20and%20Lunar%20cycles) started at noon ([5]{.color5} [decidays]{.tool data-bs-toggle="tooltip" data-bs-title="tenths of a day"}). Therefore, a [tod]{.tool data-bs-toggle="tooltip" data-bs-title="time of day"} derived from UNIX time is half a day ([5]{.color5} [decidays]{.tool data-bs-toggle="tooltip" data-bs-title="tenths of a day"}) apart from a Julian date-derived [tod]{.tool data-bs-toggle="tooltip" data-bs-title="times-of-day"}.
