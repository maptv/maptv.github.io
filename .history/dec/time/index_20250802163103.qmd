...
We can turn an [yda]{.tool data-bs-toggle="tooltip" data-bs-title="yearly day aggregate"} into a [tod]{.tool data-bs-toggle="tooltip" data-bs-title="time of day"} by [keeping the remainder after dividing](https://en.wikipedia.org/wiki/Modulo#:~:text=returns%20the%20remainder) by one to isolate the [decimal part](https://en.wikipedia.org/wiki/Fractional_part#:~:text=the%20excess%20beyond%20that%20number%27s%20integer%20part) of the [quotient](https://en.wikipedia.org/wiki/Quotient#:~:text=a%20quantity%20produced%20by%20the%20division%20of%20two%20numbers): \${zeroYdaHsl} mod 1 = \${zeroTimeHsl0}. We can use this same approach to obtain a [tod]{.tool data-bs-toggle="tooltip" data-bs-title="time of day"} from an "epochal day aggregate" ([eda]{.tool data-bs-toggle="tooltip" data-bs-title="epochal day aggregate"}): \${zeroDoteHsl} mod 1 = \${zeroTimeHsl1}. The current [eda]{.tool data-bs-toggle="tooltip" data-bs-title="epochal day aggregate"} tells us how many days have passed since the Dec [epoch](https://en.wikipedia.org/wiki/Epoch#:~:text=an%20instant%20in%20time%20chosen%20as%20the%20origin%20of%20a%20particular%20calendar%20era).
...
With an [sda]{.tool data-bs-toggle="tooltip" data-bs-title="solar declination angle"}($\gamma$), "solar zenith angle" ([sza]{.tool data-bs-toggle="tooltip" data-bs-title="solar zenith angle"}), and latitude ($\phi$), we can calculate a "solar hour angle" ([sha]{.tool data-bs-toggle="tooltip" data-bs-title="solar hour angle"}). In the [sha]{.tool data-bs-toggle="tooltip" data-bs-title="solar hour angle"} equation below, the [sza]{.tool data-bs-toggle="tooltip" data-bs-title="solar zenith angle"} is set to 0.2523 turns. Dec measures angles such as [sda]{.tool data-bs-toggle="tooltip" data-bs-title="solar declination angle"}, [sza]{.tool data-bs-toggle="tooltip" data-bs-title="solar zenith angle"}, $\phi$, and [sza]{.tool data-bs-toggle="tooltip" data-bs-title="solar zenith angle"} in turns. The trigonometric functions of most --- if not all -- programming languages accept radians. To convert turns into radians, we multiply by $\tau$.
...
$$\text{sha} = \pm \arccos\left( \frac{\cos(0.2523\times\tau)}{\cos(\phi\times\tau) \cdot \cos(\text{sda}\times\tau)} - \tan(\text{$\phi\times\tau$}) \cdot \tan(\text{sda}\times\tau) \right)$$

The Zone [0]{.color0} sunrise [tod]{.tool data-bs-toggle="tooltip" data-bs-title="time of day"} of any location is the difference between solar noon and [sha]{.tool data-bs-toggle="tooltip" data-bs-title="solar hour angle"}. Likewise, the sum of solar noon and [sha]{.tool data-bs-toggle="tooltip" data-bs-title="solar hour angle"} is Zone [0]{.color0} sunset [tod]{.tool data-bs-toggle="tooltip" data-bs-title="time of day"}. Instead of subtracting the sunset tod from the sunrise tod, we can double the [sha]{.tool data-bs-toggle="tooltip" data-bs-title="solar hour angle"} to get the daylight duration in days or multiply it by twenty.
...
both cases, we are adding a [tzo]{.tool data-bs-toggle="tooltip" data-bs-title="time zone offset"} to the We can turn mean solar time
A Dec time consists of a [tod]{.tool data-bs-toggle="tooltip" data-bs-title="time of day"} and a [tzo]{.tool data-bs-toggle="tooltip" data-bs-title="time zone offset"}. The current Dec time in Zone [0]{.color0} is [-]{.mono}[0]{.color0}. If we add [[27]{.color1by320} seconds](https://en.wikipedia.org/wiki/Leap_second#:~:text=27%20leap%20seconds%20have%20been%20added%20to%20UTC) to the Zone [0]{.color0} time, we will get the time in Zone [0.003125]{.color1by320}: \${zeroTimeHsl3}[-]{.mono}[0.003125]{.color1by320}. We can evaluate any Dec time like a math expression to obtain a Zone [0]{.color0} [tod]{.tool data-bs-toggle="tooltip" data-bs-title="time of day"}: \${zeroTimeHsl4} [-]{.mono} [0.003125]{.color1by320} = \${zeroTimeHsl5}.
...
[0003125]{.color1by320}. new [tzo]{.tool data-bs-toggle="tooltip" data-bs-title="time zone offset"} will be [0.003125]{.color1by320} and the new [uzi]{.tool data-bs-toggle="tooltip" data-bs-title="unique zone identifier"} will be . the Dec time will be \${zeroTimeHsl3}[-]{.mono}[0003125]{.color1by320}. The [0003125]{.color1by320} The [uzi]{.tool data-bs-toggle="tooltip" data-bs-title="unique zone identifier"} tells us that the go from [0]{.color0} to [0003125] and the D
