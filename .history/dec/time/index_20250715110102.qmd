...
We can move or even remove the decimal separator in a [tod]{.tool data-bs-toggle="tooltip" data-bs-title="time of day"} or [yda]{.tool data-bs-toggle="tooltip" data-bs-title="yearly day aggregate"} by converting between [submultiples](https://en.wikipedia.org/wiki/Multiple_%28mathematics%29#Submultiple:~:text=of%20%22a%20being-,a%20unit%20fraction,-of%20b%22%20) of days. For example, the y-axis of the area chart expresses [tods]{.tool data-bs-toggle="tooltip" data-bs-title="times of day"} as three-digit integer [millidays]{.tool data-bs-toggle="tooltip" data-bs-title="thousandths of a day"}. The [doys]{.tool data-bs-toggle="tooltip" data-bs-title="days of year"} on the area chart x-axis
