...
The [UT]{.tool data-bs-toggle="tooltip" data-bs-title="Universal Time"} that corresponds to the offset shown above is \${leapTodHsl0}[-]{.mono}\${leapTzoHsl1}. Dec times are structured like math expressions that can be simplified to the Zone [0]{.color0} [tod]{.tool data-bs-toggle="tooltip" data-bs-title="time of day"}: \${leapTodHsl1} -- \${leapTzoHsl2} = \${zeroTimeHsl4}. The structure of Dec times can be summarized as `tod-tzo`. Dec measures [tzos]{.tool data-bs-toggle="tooltip" data-bs-title="time zone offsets"} in [decidays]{.tool data-bs-toggle="tooltip" data-bs-title="tenths of a day"} and typically represents [tzos]{.tool data-bs-toggle="tooltip" data-bs-title="time zone offsets"} derived from hours, minutes, and seconds as fractions.
