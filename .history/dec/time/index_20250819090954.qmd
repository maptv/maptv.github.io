...
Dec measures [tzos]{.tool data-bs-toggle="tooltip" data-bs-title="time zone offsets"} in [decidays]{.tool data-bs-toggle="tooltip" data-bs-title="tenths of a day"}. There are three main [tzo]{.tool data-bs-toggle="tooltip" data-bs-title="time zone offset"} types: integer, fraction, and decimal. Integer [tzos]{.tool data-bs-toggle="tooltip" data-bs-title="time zone offsets"} facilitate time calculations and are easier to display as part of a Dec time. The structure of Dec times can be summarized as `tod-tzo`. Dec times are structured like math expressions that can be simplified to the Zone [0]{.color0} [tod]{.tool data-bs-toggle="tooltip" data-bs-title="time of day"}: \${leapTodHsl1} -- \${leapTzoHsl2} = \${zeroTimeHsl4}.
