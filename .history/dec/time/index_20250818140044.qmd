...
leapTodHsl0 = textcolor(leapTod, d3.color(piecewiseColor(leapTod)).formatHex())
leapTodHsl1 = textcolor(leapTod, d3.color(piecewiseColor(leapTod)).formatHex())
