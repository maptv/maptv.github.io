...
The structure of Dec times can be summarized as `tod-tzo` and described as the difference between a [tod]{.tool data-bs-toggle="tooltip" data-bs-title="time of day"} and a [tzo]{.tool data-bs-toggle="tooltip" data-bs-title="time zone offset"}. If we add the offset shown above to the current Zone [0]{.color0} time: \${zeroTimeHsl3}--[0]{.color0}, the resulting [UT]{.tool data-bs-toggle="tooltip" data-bs-title="Universal Time"} will be \${leapTodHsl0}--\${leapTzoHsl1}.
