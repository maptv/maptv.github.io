...
Whereas a zonal [tzo]{.tool data-bs-toggle="tooltip" data-bs-title="time zone offset"} has its decimal part removed to make it an integer, a solar [tzo]{.tool data-bs-toggle="tooltip" data-bs-title="time zone offset"} will have up to four digits after its [decimal separator](https://en.wikipedia.org/wiki/Decimal_separator#:~:text=a%20symbol%20that%20separates%20the%20integer%20part%20from%20the%20fractional%20part%20of%20a%20number) for a total of five digits. Dec also displays each [tod]{.tool data-bs-toggle="tooltip" data-bs-title="time of day"} with at most five digits. If we add more than five digits to a tod, the additional digits will change so quickly that they will appear as a blur: .
