...
With an [sda]{.tool data-bs-toggle="tooltip" data-bs-title="solar declination angle"}($\gamma$), "solar zenith angle" ([sza]{.tool data-bs-toggle="tooltip" data-bs-title="solar zenith angle"}), and latitude ($\phi$), we can get a "solar hour angle" ([sha]{.tool data-bs-toggle="tooltip" data-bs-title="solar hour angle"}). If the [sza]{.tool data-bs-toggle="tooltip" data-bs-title="solar zenith angle"} in the equation below is 0.2523 turns, we get the sunrise [sha]{.tool data-bs-toggle="tooltip" data-bs-title="solar hour angle"}. Dec measures angles in turns. The trigonometric functions of most --- if not all -- programming languages require radians. To convert turns into radians, we multiply by $\tau$.
