...
A Dec time consists of a "time of day" ([tod]{.tool data-bs-toggle="tooltip" data-bs-title="time of day"}) and a time zone: \${selTimeHsl1}[--]{style="font-family:monospace;"}\${selZoneHsl}. The [tod]{.tool data-bs-toggle="tooltip" data-bs-title="time of day"} denoted by the red🔴dot is \${selTimeDay} days. The "day of year" ([doy]{.tool data-bs-toggle="tooltip" data-bs-title="day of year"}) indicated by the red<font color=red>—</font>line is \${selDateHsl}. Together, this [doy]{.tool data-bs-toggle="tooltip" data-bs-title="day of year"} and [tod]{.tool data-bs-toggle="tooltip" data-bs-title="time of day"} form a "yearly day aggregate" ([yda]{.tool data-bs-toggle="tooltip" data-bs-title="yearly day aggregate"}), \${selSnapDay}, which is the fractional days since [Day [0]{.color0}]{.tool data-bs-toggle="tooltip" data-bs-title="March 1"}.

## Yearly day aggregate (yda) {#yda .hiddenheading}

The first three digits of an [yda]{.tool data-bs-toggle="tooltip" data-bs-title="yearly-day-aggregate"} is a [doy]{.tool data-bs-toggle="tooltip" data-bs-title="day of year"} that identifies a day in an unspecified year like a [Gregorian calendar](https://en.wikipedia.org/wiki/Gregorian_calendar#:~:text=the%20calendar%20used%20in%20most%20parts%20of%20the%20world) month and "day of month" ([dom]{.tool data-bs-toggle="tooltip" data-bs-title="day of month"}) pair, its third digit is a "day of dek" ([dod]{.tool data-bs-toggle="tooltip" data-bs-title="day of dek"}) which classifies that day as a work or rest day like a "day of week" ([dow]{.tool data-bs-toggle="tooltip" data-bs-title="day of week"}), and its remaining digits are a [tod]{.tool data-bs-toggle="tooltip" data-bs-title="time of day"} which specifies a point in that day like an "hour minute second" ([hms]{.tool data-bs-toggle="tooltip" data-bs-title="hour minute second"}) triplet.
