...
With [sda]{.tool data-bs-toggle="tooltip" data-bs-title="solar declination angle"}($\gamma$), "solar zenith angle" ([sza]{.tool data-bs-toggle="tooltip" data-bs-title="solar zenith angle"}), and latitude ($\phi$), we can calculate the "solar hour angle" ([sha]{.tool data-bs-toggle="tooltip" data-bs-title="solar hour angle"}). In the [sha]{.tool data-bs-toggle="tooltip" data-bs-title="solar hour angle"} equation below, the [sza]{.tool data-bs-toggle="tooltip" data-bs-title="solar zenith angle"} is set to 0.2523 turns. Dec measures angles such as [sda]{.tool data-bs-toggle="tooltip" data-bs-title="solar declination angle"}, [sza]{.tool data-bs-toggle="tooltip" data-bs-title="solar zenith angle"}, and latitude ($\phi$) in turns. The trigonometric functions of most --- if not all -- programming languages accept radians. To convert turns into radians, we multiply by $\tau$.
