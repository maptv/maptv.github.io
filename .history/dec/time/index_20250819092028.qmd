...
Dec measures [tzos]{.tool data-bs-toggle="tooltip" data-bs-title="time zone offsets"} in [decidays]{.tool data-bs-toggle="tooltip" data-bs-title="tenths of a day"}. There are three main [tzo]{.tool data-bs-toggle="tooltip" data-bs-title="time zone offset"} types: integer, fraction, and decimal. Integer [tzos]{.tool data-bs-toggle="tooltip" data-bs-title="time zone offsets"} are easier to work with and to display as part of a Dec time. In essence, Dec times are math expressions that can be simplified to the Zone [0]{.color0} [tod]{.tool data-bs-toggle="tooltip" data-bs-title="time of day"}: \${leapTodHsl1} -- \${leapTzoHsl2} = \${zeroTimeHsl4}. The structure of a Dec time can be summarized as `tod-tzo`.
