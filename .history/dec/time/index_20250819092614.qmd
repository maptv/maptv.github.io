...
Dec measures [tzos]{.tool data-bs-toggle="tooltip" data-bs-title="time zone offsets"} in [decidays]{.tool data-bs-toggle="tooltip" data-bs-title="tenths of a day"}. There are three main [tzo]{.tool data-bs-toggle="tooltip" data-bs-title="time zone offset"} types: integer, fraction, and decimal. Of the three types, integer [tzos]{.tool data-bs-toggle="tooltip" data-bs-title="time zone offsets"} require the least space when displayed as part of a Dec time. The structure of a Dec time can be summarized as [tod]{.tool data-bs-toggle="tooltip" data-bs-title="time of day"}[-]{.mono}[tzo]{.tool data-bs-toggle="tooltip" data-bs-title="time zone offset"}. In essence, Dec times are math expressions that can be simplified to the Zone [0]{.color0} [tod]{.tool data-bs-toggle="tooltip" data-bs-title="time of day"}: \${leapTodHsl1} -- \${leapTzoHsl2} = \${zeroTimeHsl4}.

The [UT]{.tool data-bs-toggle="tooltip" data-bs-title="Universal Time"} that corresponds to the [tzo]{.tool data-bs-toggle="tooltip" data-bs-title="time zone offset"} shown above is \${leapTodHsl0}[-]{.mono}\${leapTzoHsl1}.

The time Any time produced by an integer [tzo]{.tool data-bs-toggle="tooltip" data-bs-title="time zone offset"} will match the time in one of the ten Dec time zones. If a [tzo]{.tool data-bs-toggle="tooltip" data-bs-title="time zone offset"} is not an integer, Dec will either express it as All other [tzos]{.tool data-bs-toggle="tooltip" data-bs-title="time zone offsets"} will not be compatible with any of the twn Dec time zones, but may match either [UT]{.tool data-bs-toggle="tooltip" data-bs-title="Universal Time"} or the time in a [[UTC]{.tool data-bs-toggle="tooltip" data-bs-title="Coordinated Universal Time"} time zone](https://en.wikipedia.org/wiki/List_of_UTC_offsets).


Dec measures [tzos]{.tool data-bs-toggle="tooltip" data-bs-title="time zone offsets"} in [decidays]{.tool data-bs-toggle="tooltip" data-bs-title="tenths of a day"}. Any [tzo]{.tool data-bs-toggle="tooltip" data-bs-title="time zone offset"} that is an integer will produce a time that matches the time in one of the ten Dec time zones.
