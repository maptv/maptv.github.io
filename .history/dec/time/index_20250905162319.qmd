...
A Dec beat lasts 864 [milliseconds]{.tool data-bs-toggle="tooltip" data-bs-title="thousandths of a second"}. A [tod]{.tool data-bs-toggle="tooltip" data-bs-title="time of day"} that shows beats is therefore 125/108 times more precise than an [hms]{.tool data-bs-toggle="tooltip" data-bs-title="hour minute second"} triplet with an integer [som]{.tool data-bs-toggle="tooltip" data-bs-title="second of minute"}. If more precision is required, we can increase the level of precision tenfold with each additional digit that we append to a [tod]{.tool data-bs-toggle="tooltip" data-bs-title="time of day"}, but any additional digits will appear as a blur if included as part of the current [tod]{.tool data-bs-toggle="tooltip" data-bs-title="time of day"}.
