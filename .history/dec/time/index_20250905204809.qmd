...
With geographic coordinates that are accurate to within one [zem]{.tool data-bs-toggle="tooltip" data-bs-title="zone equatorial meter"}, we could pinpoint a specific room in a building or a particular car in a parking lot, but this level of precision is a thousandfold too high for [tods]{.tool data-bs-toggle="tooltip" data-bs-title="times of day"} that can be displayed on clocks and watches. As we move from the Equator towards the North or South Pole, the length of a [$\lambda$]{.tool data-bs-toggle="tooltip" data-bs-title="parallel"} decreases, but a [$\lambda$]{.tool data-bs-toggle="tooltip" data-bs-title="parallel"} represents a day at any latitude. The equatorial length of a [$\lambda$]{.tool data-bs-toggle="tooltip" data-bs-title="parallel"} is roughly 100000 [kilozem]{.tool data-bs-toggle="tooltip" data-bs-title="a thousand zone equatorial meters"} ([kz]{.tool data-bs-toggle="tooltip" data-bs-title="kilozem"}). If we move one [kz]{.tool data-bs-toggle="tooltip" data-bs-title="kilozem"} along the Equator, our longitude will change by about one centimilliparallel ([$\text{cm}\lambda$]{.tool data-bs-toggle="tooltip" data-bs-title="centimilliparallel"}). When we convert longitude to a solar tzo, one [$\text{cm}\lambda$]{.tool data-bs-toggle="tooltip" data-bs-title="centimilliparallel"} translates to one [beat]{.tool data-bs-toggle="tooltip" data-bs-title="centimilliday"}.
