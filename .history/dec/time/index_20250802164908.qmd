...
With an [sda]{.tool data-bs-toggle="tooltip" data-bs-title="solar declination angle"}($\gamma$), "solar zenith angle" ([sza]{.tool data-bs-toggle="tooltip" data-bs-title="solar zenith angle"}), and latitude ($\phi$), we can get a "solar hour angle" ([sha]{.tool data-bs-toggle="tooltip" data-bs-title="solar hour angle"}). In the sunrise [sha]{.tool data-bs-toggle="tooltip" data-bs-title="solar hour angle"} equation below, the sunrise [sza]{.tool data-bs-toggle="tooltip" data-bs-title="solar zenith angle"} is 0.2523 turns. Dec measures angles in turns. The trigonometric functions of most --- if not all -- programming languages require radians. To convert turns into radians, we multiply by $\tau$.
...
$$\text{sha} = \arccos\left( \frac{\cos(0.2523\times\tau)}{\cos(\phi\times\tau) \cdot \cos(\text{sda}\times\tau)} - \tan(\text{$\phi\times\tau$}) \cdot \tan(\text{sda}\times\tau) \right)$$

The Zone [0]{.color0} sunrise [tod]{.tool data-bs-toggle="tooltip" data-bs-title="time of day"} of any location is the difference between its solar noon and its sunrise [sha]{.tool data-bs-toggle="tooltip" data-bs-title="solar hour angle"}. Likewise, the sum of the solar noon and sunrise [sha]{.tool data-bs-toggle="tooltip" data-bs-title="solar hour angle"} of a location is the Zone [0]{.color0} [tod]{.tool data-bs-toggle="tooltip" data-bs-title="time of day"} of its sunset. To get the daylight duration in decidays, we subtract the sunset [tod]{.tool data-bs-toggle="tooltip" data-bs-title="times of day"} from the sunrise [tod]{.tool data-bs-toggle="tooltip" data-bs-title="times of day"} or multiply the sunrise [sha]{.tool data-bs-toggle="tooltip" data-bs-title="solar hour angle"} by twenty.
