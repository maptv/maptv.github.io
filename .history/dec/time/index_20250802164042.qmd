...
With an [sda]{.tool data-bs-toggle="tooltip" data-bs-title="solar declination angle"}($\gamma$), "solar zenith angle" ([sza]{.tool data-bs-toggle="tooltip" data-bs-title="solar zenith angle"}), and latitude, we can get a "solar hour angle" ([sha]{.tool data-bs-toggle="tooltip" data-bs-title="solar hour angle"}). In the [sha]{.tool data-bs-toggle="tooltip" data-bs-title="solar hour angle"} equation below, the [sza]{.tool data-bs-toggle="tooltip" data-bs-title="solar zenith angle"} is 0.2523 turns. Dec measures angles in turns and latitude in turns called meridians ($\phi$). The trigonometric functions of most --- if not all -- programming languages require radians. To convert turns into radians, we multiply by $\tau$.
