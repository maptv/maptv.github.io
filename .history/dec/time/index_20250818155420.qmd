...
Dec measures all [tzos]{.tool data-bs-toggle="tooltip" data-bs-title="time zone offsets"} in [decidays]{.tool data-bs-toggle="tooltip" data-bs-title="tenths of a day"} and displays [UT]{.tool data-bs-toggle="tooltip" data-bs-title="Universal Time"} and [UTC]{.tool data-bs-toggle="tooltip" data-bs-title="Coordinated Universal Time"} [tzos]{.tool data-bs-toggle="tooltip" data-bs-title="time zone offsets"} as integers when possible but most often as fractions. If we add the [tzo]{.tool data-bs-toggle="tooltip" data-bs-title="time zone offset"} shown above to the current Zone [0]{.color0} time: \${zeroTimeHsl3}[-]{.mono}[0]{.color0}, the resulting [UT]{.tool data-bs-toggle="tooltip" data-bs-title="Universal Time"} will be \${leapTodHsl0}[-]{.mono}\${leapTzoHsl1}. Dec times are structured like math expressions that can be simplified to the Zone [0]{.color0} [tod]{.tool data-bs-toggle="tooltip" data-bs-title="time of day"}: \${leapTodHsl1} -- \${leapTzoHsl2} = \${zeroTimeHsl4}.
