...
A [tod]{.tool data-bs-toggle="tooltip" data-bs-title="time of day"} that shows [beats]{.tool data-bs-toggle="tooltip" data-bs-title="centimillidays"} is 125/108 times more precise than an [hms]{.tool data-bs-toggle="tooltip" data-bs-title="hour minute second"} triplet with an integer [som]{.tool data-bs-toggle="tooltip" data-bs-title="second of minute"}. If even more precision is required, we can increase the level of precision tenfold with each additional digit. When shown as part of the current [tod]{.tool data-bs-toggle="tooltip" data-bs-title="time of day"}, [microdays]{.tool data-bs-toggle="tooltip" data-bs-title="millionths of a day"} change too quickly to be read out loud and units smaller than [microdays]{.tool data-bs-toggle="tooltip" data-bs-title="millionths of a day"} change so quickly that they appear as a blur.
