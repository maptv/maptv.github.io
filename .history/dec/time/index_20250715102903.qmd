...
The red<font color=red>—</font>line indicates a the "day of year" ([doy]{.tool data-bs-toggle="tooltip" data-bs-title="day of year"}), \${selDateHsl}, and the red🔴dot denotes a [tod]{.tool data-bs-toggle="tooltip" data-bs-title="time of day"}: \${selTimeDay}. The [doy]{.tool data-bs-toggle="tooltip" data-bs-title="day of year"} identifies a day in an unspecified year like a [Gregorian calendar](https://en.wikipedia.org/wiki/Gregorian_calendar#:~:text=the%20calendar%20used%20in%20most%20parts%20of%20the%20world) month and "day of month" ([dom]{.tool data-bs-toggle="tooltip" data-bs-title="day of month"}) pair. The [tod]{.tool data-bs-toggle="tooltip" data-bs-title="time of day"} specifies a point in that day like an "hour minute second" ([hms]{.tool data-bs-toggle="tooltip" data-bs-title="hour minute second"}) triplet. We can move or even remove the decimal in a [tod]{.tool data-bs-toggle="tooltip" data-bs-title="time of day"} by converting between submultiples of days.

Together, a [doy]{.tool data-bs-toggle="tooltip" data-bs-title="day of year"} and [tod]{.tool data-bs-toggle="tooltip" data-bs-title="time of day"} form a "yearly day aggregate" ([yda]{.tool data-bs-toggle="tooltip" data-bs-title="yearly day aggregate"}), \${selSnapDay}, which is the fractional days since [Day [0]{.color0}]{.tool data-bs-toggle="tooltip" data-bs-title="March 1"}.
