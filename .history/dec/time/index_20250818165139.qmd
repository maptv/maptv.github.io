...
Integer tzos facilitate time calculations and Even if a [UT]{.tool data-bs-toggle="tooltip" data-bs-title="Universal Time"} or [UTC]{.tool data-bs-toggle="tooltip" data-bs-title="Coordinated Universal Time"} [tzo]{.tool data-bs-toggle="tooltip" data-bs-title="time zone offset"} can be displayed as a terminating decimal number, Dec displays as fractions. The [UT]{.tool data-bs-toggle="tooltip" data-bs-title="Universal Time"} that corresponds to the offset shown above is \${leapTodHsl0}[-]{.mono}\${leapTzoHsl1}. Dec times are structured like math expressions that can be simplified to the Zone [0]{.color0} [tod]{.tool data-bs-toggle="tooltip" data-bs-title="time of day"}: \${leapTodHsl1} -- \${leapTzoHsl2} = \${zeroTimeHsl4}.
