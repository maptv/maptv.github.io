...
Any [tzo]{.tool data-bs-toggle="tooltip" data-bs-title="time zone offset"} that is meant to exactly match [UT]{.tool data-bs-toggle="tooltip" data-bs-title="Universal Time"} is expressed by Dec as a fraction. The structure of Dec times can be summarized as `tod-tzo`. The [UT]{.tool data-bs-toggle="tooltip" data-bs-title="Universal Time"} that corresponds to the [tzo]{.tool data-bs-toggle="tooltip" data-bs-title="time zone offset"} shown above is \${leapTodHsl0}[-]{.mono}\${leapTzoHsl1}. Dec times are structured like math expressions that can be simplified to the Zone [0]{.color0} [tod]{.tool data-bs-toggle="tooltip" data-bs-title="time of day"}: \${leapTodHsl1} -- \${leapTzoHsl2} = \${zeroTimeHsl4}.
