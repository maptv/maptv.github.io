...
The structure of Dec times can be summarized as `tod-tzo`. If we add the offset shown above to the current Zone [0]{.color0} time: \${zeroTimeHsl3}--[0]{.color0}, the resulting [UT]{.tool data-bs-toggle="tooltip" data-bs-title="Universal Time"} will be \${leapTodHsl0}--\${leapTzoHsl1}.
Dec times are structured like math expressions that can be simplified to the Zone [0]{.color0} [tod]{.tool data-bs-toggle="tooltip" data-bs-title="time of day"}: \${leapTodHsl1} -- \${leapTzoHsl2} = \${zeroTimeHsl4}.

where the [tod]{.tool data-bs-toggle="tooltip" data-bs-title="time of day"} is the minuend and the [tzo]{.tool data-bs-toggle="tooltip" data-bs-title="time zone offset"} is a subtrahend.
