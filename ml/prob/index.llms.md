...
def loading_plot(
    ...
    for i, label in enumerate(labels):
        if visible is None or visible[i]:
            ...
            ax.text(
                text_x.iloc[i] if text_x.all() else coeff[i, 0] * 1.2 * scale,
                text_y.iloc[i] if text_y.all() else coeff[i, 1] * 1.2 * scale,
                label,
                color="#000" if colors is None else colors[i],
                ha="center",
                va="center",
...
[![](index_files/figure-html/cell-7-output-1.png)](index_files/figure-html/cell-7-output-1.png)
...
[![](index_files/figure-html/cell-8-output-1.png)](index_files/figure-html/cell-8-output-1.png)
...
[![](index_files/figure-html/cell-9-output-1.png)](index_files/figure-html/cell-9-output-1.png)
...
[?Documentation for LogisticRegression](https://scikit-learn.org/1.9/modules/generated/sklearn.linear_model.LogisticRegression.html)iFitted
...
[![](index_files/figure-html/cell-12-output-2.png)](index_files/figure-html/cell-12-output-2.png)

#### 0 Logistic function visualization
...
[?Documentation for GaussianNB](https://scikit-learn.org/1.9/modules/generated/sklearn.naive_bayes.GaussianNB.html)iFitted
...
[![](index_files/figure-html/cell-14-output-2.png)](index_files/figure-html/cell-14-output-2.png)
