...
If we follow Schedule [X]{.tool data-bs-toggle="tooltip" data-bs-title="duotrigesimal X is decimal 28 or binary 11100"}, there will be 4 consecutive work days during any transition from a leap year. To limit the number of consecutive work days to 3, we could right rotate (↻) Schedule [L]{.tool data-bs-toggle="tooltip" data-bs-title="duotrigesimal L is decimal 14 or binary 01110"} and obtain Schedule [F]{.tool data-bs-toggle="tooltip" data-bs-title="duotrigesimal F is decimal 7 or binary 00111"}: [L]{.tool data-bs-toggle="tooltip" data-bs-title="duotrigesimal L is decimal 14 or binary 01110"} ↻ 1 = [F]{.tool data-bs-toggle="tooltip" data-bs-title="duotrigesimal F is decimal 7 or binary 00111"}. Unlike Schedule [X]{.tool data-bs-toggle="tooltip" data-bs-title="duotrigesimal X is decimal 28 or binary 11100"}, Schedule [F]{.tool data-bs-toggle="tooltip" data-bs-title="duotrigesimal F is decimal 7 or binary 00111"} handles yearly transitions just as gracefully as Schedule [L]{.tool data-bs-toggle="tooltip" data-bs-title="duotrigesimal L is decimal 14 or binary 01110"}. Of the three schedules, only Schedule [L]{.tool data-bs-toggle="tooltip" data-bs-title="duotrigesimal L is decimal 14 or binary 01110"} is symmetric.
...
In common years, the symmetry of Schedule [L]{.tool data-bs-toggle="tooltip" data-bs-title="duotrigesimal L is decimal 14 or binary 01110"} pairs well with Dec complement notation, which displays positive digits at the end of [nid]{.tool data-bs-toggle="tooltip" data-bs-title="negative integer days of year"}.

::: {.centered}
### Schedule [L]{.tool data-bs-toggle="tooltip" data-bs-title="duotrigesimal L is decimal 14 or binary 01110"} ([Dox]{.tool data-bs-toggle="tooltip" data-bs-title="days of xún"} [0]{.overline} to [9]{.overline}) common year {.diagtitle}
:::
...
flowchart LR
  ...
  N---O[ ]:::empty
  Q[ ]:::empty---L
  W[ ]:::empty-->A[0]-->B[9]-->C[8]-->D[7]-->E[6]---L[ ]:::empty
  Y[ ]:::empty-->F[5]-->G[4]-->H[3]-->I[2]-->J[1]---O[ ]:::empty
  B~~~P[ ]:::empty---Q
  Y---P
  subgraph workdays[work]
  B
