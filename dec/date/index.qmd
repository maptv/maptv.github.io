...
We can find out that [h]{.tool data-bs-toggle="tooltip" data-bs-title="group of one hundred days"}\${decPih} is \${decDohPid}% done from the current pid: \${decDoty}, that \${decDohPidMid}% is left until [h]{.tool data-bs-toggle="tooltip" data-bs-title="groups of one hundred days"}\${decPihPlus1} from the current three-digit countdown [mid]{.tool data-bs-toggle="tooltip" data-bs-title="mixed integer day of year"} which has a vinculum over its last two digits: \${decPihPlus1}[\${decDohPidMidPad}]{.overline}, that \${decDohNid}% remains until h[\${decNihPlus1}]{.overline} from the current nid: \${decNid}, and that [h]{.tool data-bs-toggle="tooltip" data-bs-title="groups of one hundred days"}[\${decNih}]{.overline} is \${decDohNidMidPad}% finished from the current three-digit countup [mid]{.tool data-bs-toggle="tooltip" data-bs-title="mixed integer day of year"} which has a vinculum over only its first digit: [\${decNih}]{.overline}\${decDohNidMidPad}. 

h[\${decNih}]{.overline} is unfinished: = \${decPih}[\${decDohPidMidPad}]{.overline}.

We can use a [mid]{.tool data-bs-toggle="tooltip" data-bs-title="mixed integer day of year"} to highlight an [h]{.tool data-bs-toggle="tooltip" data-bs-title="groups of one hundred days"} and [doh](#doh){.tool data-bs-toggle="tooltip" data-bs-title="day of hectoday"}. 

from current the three-digit countdown [mid]{.tool data-bs-toggle="tooltip" data-bs-title="mixed integer day of year"}: , that three-digit countdown [mid]{.tool data-bs-toggle="tooltip" data-bs-title="mixed integer day of year"}: .
