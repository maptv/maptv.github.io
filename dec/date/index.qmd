...
To activate the scrubber input, press the "Play"▶️button above⬆️the range inputs. Upon activation, the box around the selected day in each plot will move back and forth between the first "day of year" ([doy](#doy){#dayofyear .tool data-bs-toggle="tooltip" data-bs-title="day of year"}), [d]{#day .tool data-bs-toggle="tooltip" data-bs-title="day"}[0]{.color0}, and the last [doy](#doy){#dayofyear .tool data-bs-toggle="tooltip" data-bs-title="day of year"}, which is either [d]{.tool data-bs-toggle="tooltip" data-bs-title="day"}[364]{.color364by365} or [d]{.tool data-bs-toggle="tooltip" data-bs-title="day"}[365]{.color365by366}. To insert or remove [d]{.tool data-bs-toggle="tooltip" data-bs-title="day"}[365]{.color365by366}, use the "Year length" [radio](https://observablehq.com/@observablehq/input-radio)📻input to set the number of days in the year.
...
In contrast to a week, an [x]{.tool data-bs-toggle="tooltip" data-bs-title="groups of ten days"} can be split evenly into either five pairs of days or two equal halves called "pentadays of xún" ([pox]{.tool data-bs-toggle="tooltip" data-bs-title="pentadays of xún"}). Likewise, a common year can be divided evenly into 73 "pentadays" ([p](#p){#pentaday .tool data-bs-toggle="tooltip" data-bs-title="pentadays"}). The last [p]{.tool data-bs-toggle="tooltip" data-bs-title="pentaday"} of a leap year, [p]{.tool data-bs-toggle="tooltip" data-bs-title="pentaday"}73, consists of the final day of the leap year, [d]{.tool data-bs-toggle="tooltip" data-bs-title="day"}[365]{.color365by366}, and the first four days of the subsequent year: Days 0 to 3.

In the context of a common year, [p]{.tool data-bs-toggle="tooltip" data-bs-title="pentaday"}73 is synonymous with [p]{.tool data-bs-toggle="tooltip" data-bs-title="pentaday"}0 of the subsequent year. To obtain the current [p]{.tool data-bs-toggle="tooltip" data-bs-title="pentaday"}, we double the current [x]{.tool data-bs-toggle="tooltip" data-bs-title="groups of ten days"} and add the current [pox]{.tool data-bs-toggle="tooltip" data-bs-title="pentaday of xún"}, which is 1 if the current [dox]{.tool data-bs-toggle="tooltip" data-bs-title="days of xún"} is greater than 4 and 0 otherwise: ${decPent} = \${decDek} &times; 2 + [\${decDotd} > 4]. If we divide a [dox]{.tool data-bs-toggle="tooltip" data-bs-title="days of xún"} by 5, the remainder will be its corresponding "day of pentaday" ([dop]{.tool data-bs-toggle="tooltip" data-bs-title="days of pentaday"}): \${decDek} [mod](https://en.wikipedia.org/wiki/Modulo#:~:text=returns%20the%20remainder) 5 = \${decDotp}. 
...
Dec identifies groups of days between [Dop]{.tool data-bs-toggle="tooltip" data-bs-title="day of pentaday"} 0 and 4 and betwixt [Dox]{.tool data-bs-toggle="tooltip" data-bs-title="days of xún"} 0 and 9 as "pentaday interquintile ranges" ([pir]{.tool data-bs-toggle="tooltip" data-bs-title="pentaday interquintile ranges"}) and "xún interdecile ranges" ([xir]{.tool data-bs-toggle="tooltip" data-bs-title="xún interdecile ranges"}), respectively. The acronyms [pir]{.tool data-bs-toggle="tooltip" data-bs-title="pentaday interquintile range"} and [xir]{.tool data-bs-toggle="tooltip" data-bs-title="xún interdecile range"} are derived from the terms [quintile](https://en.wiktionary.org/wiki/quintile#:~:text=quantiles%20which%20divide%20an%20ordered%20sample%20population%20into%20five%20equally%20numerous%20subsets), [decile](https://en.wikipedia.org/wiki/Decile#:~:text=nine%20values%20that%20divide%20the%20sorted%20data%20into%20ten%20equal%20parts), and [interquartile range](https://en.wikipedia.org/wiki/Interquartile_range#:~:text=a%20measure%20of%20statistical%20dispersion). If we follow Schedule [L]{.tool data-bs-toggle="tooltip" data-bs-title="duotrigesimal L is decimal 14 or binary 01110"}, a [pir]{.tool data-bs-toggle="tooltip" data-bs-title="pentaday interquintile ranges"} is to a [workweek](https://en.wikipedia.org/wiki/Workweek_and_weekend#:~:text=the%20part%20of%20the%20seven%2Dday%20week%20devoted%20to%20working) as a [p](#p){.tool data-bs-toggle="tooltip" data-bs-title="pentaday"} is to a week and as a [x]{.tool data-bs-toggle="tooltip" data-bs-title="groups of ten days"} is to a [fortnight](https://en.wikipedia.org/wiki/Fortnight#:~:text=a%20unit%20of%20time%20equal%20to%2014%20days).
...
Each of the 32 base Dec schedules can be expressed as a 5-bit [binary](https://en.wikipedia.org/wiki/Binary_number#:~:text=only%20two%20symbols%20for%20the%20natural%20numbers%3A%20typically%200%20%28zero%29%20and%201%20%28one%29) ([base2]{.tool data-bs-toggle="tooltip" data-bs-title="binary"}) sequences. Of these 32 binary sequences, 8 are palindromes. If a Dec schedule can be represented as a 5-bit palindrome, we can identify its work and rest days by the last digit of not only the [pid]{.tool data-bs-toggle="tooltip" data-bs-title="positive integer days of year"} but also either the subsequent [nid]{.tool data-bs-toggle="tooltip" data-bs-title="negative integer day of year"} ([ni[d]{.acute}]{.tool data-bs-toggle="tooltip" data-bs-title="next negative integer day of year"}) in common years or the [nid]{.tool data-bs-toggle="tooltip" data-bs-title="negative integer day of year"} after next ([ni[d]{.doubleacute}]{.tool data-bs-toggle="tooltip" data-bs-title="negative integer day of year"}) in leap years.

To get the [ni[d]{.acute}]{.tool data-bs-toggle="tooltip" data-bs-title="next negative integer day of year"}, we sum the [nid]{.tool data-bs-toggle="tooltip" data-bs-title="negative integer day of year"} and one: [ni[d]{.acute}]{.tool data-bs-toggle="tooltip" data-bs-title="next negative integer day of year"} = [nid]{.tool data-bs-toggle="tooltip" data-bs-title="negative integer day of year"} + 1. Similarly, the [ni[d]{.doubleacute}]{.tool data-bs-toggle="tooltip" data-bs-title="negative integer day of year after next"} is the sum of the [nid]{.tool data-bs-toggle="tooltip" data-bs-title="negative integer day of year"} and two: [ni[d]{.doubleacute}]{.tool data-bs-toggle="tooltip" data-bs-title="negative integer day of year after next"} = [nid]{.tool data-bs-toggle="tooltip" data-bs-title="negative integer day of year"} + 2. Tables -@tbl-vincommon and -@tbl-vincommon both display the pid and nid of Days 0 to 10 and -11 to -1, but @tbl-vincommon show  the [pid]{.tool data-bs-toggle="tooltip" data-bs-title="positive integer days of year"}, [nid]{.tool data-bs-toggle="tooltip" data-bs-title="negative integer day of year"}, and [ni[d]{.acute}]{.tool data-bs-toggle="tooltip" data-bs-title="next negative integer day of year"} of the first and final 11 days of a common year. [ni[d]{.acute}]{.tool data-bs-toggle="tooltip" data-bs-title="next negative integer day of year"} in common years and [ni[d]{.doubleacute}]{.tool data-bs-toggle="tooltip" data-bs-title="negative integer day of year after next"} in leap years, We can compare  in @tbl-vincommon below. The rightmost column of @tbl-vincommon 

The 5-bit palindromic form of Schedule [L]{.tool data-bs-toggle="tooltip" data-bs-title="duotrigesimal L is decimal 14 or binary 01110"} is 01110. If we want to 
While the [ni[d]{.acute}]{.tool data-bs-toggle="tooltip" data-bs-title="negative integer day of year"} or [ni[d]{.doubleacute}]{.tool data-bs-toggle="tooltip" data-bs-title="negative integer day of year"} approach only works for 5-bit palindromes, we 

@tbl-vincommon below shows the [pid]{.tool data-bs-toggle="tooltip" data-bs-title="positive integer days of year"}, [nid]{.tool data-bs-toggle="tooltip" data-bs-title="negative integer day of year"}, [ni[d]{.acute}]{.tool data-bs-toggle="tooltip" data-bs-title="negative integer day of year"}, and [[mi]{.overline}d]{.tool data-bs-toggle="tooltip" data-bs-title="mixed integer day of year"} of the first and last 11 days of a common year. @tbl-vinculeap is the same as  

In common years, we can classify work and rest days by the last digit of a "mixed integer [doy]{.tool data-bs-toggle="tooltip" data-bs-title="day of year"}" ([mid]{.tool data-bs-toggle="tooltip" data-bs-title="mixed integer day of year"}), which is a [doy]{.tool data-bs-toggle="tooltip" data-bs-title="day of year"} with a mix of positive and negative digits. The horizontal line above all but the last digit in each row of the [[mi]{.overline}d]{.tool data-bs-toggle="tooltip" data-bs-title="mixed integer day of year"} column is called a [vinculum](https://en.wikipedia.org/wiki/Vinculum_(symbol)#:~:text=a%20horizontal%20line%20used%20in%20mathematical%20notation%20for%20various%20purposes).

In Dec, a vinculum negates whatever is beneath it. Negating all of the digits of an integer flips its [sign](https://en.wikipedia.org/wiki/Sign_(mathematics)#:~:text=property%20of%20being%20either%20positive%2C%20negative%2C%20or%200). As demostrated by the [nid]{.tool data-bs-toggle="tooltip" data-bs-title="negative integer day of year"} and [nid]{.overline .tool data-bs-toggle="tooltip" data-bs-title="negative integer day of year"} columns of @tbl-vincommon, removing the [minus sign](https://en.wikipedia.org/wiki/Plus_and_minus_signs#Minus_sign:~:text=When%20it%20is%20placed%20immediately%20before%20an%20unsigned%20number%2C%20the%20combination%20names%20a%20negative%20number%2C%20the%20additive%20inverse%20of%20the%20positive%20number%20that%20the%20numeral%20would%20otherwise%20name) of a negative integer and putting a vinculum over all of its digits does not change its value. Using a vinculum, we can write Day -1, the last day of the Decalendar year, as [d]{.tool data-bs-toggle="tooltip" data-bs-title="day"}[1]{.overline}, [d]{.tool data-bs-toggle="tooltip" data-bs-title="day"}[1]{.overline}9, or [d]{.tool data-bs-toggle="tooltip" data-bs-title="day"}[1]{.overline}99.
...
The last digits of [pid]{.tool data-bs-toggle="tooltip" data-bs-title="positive integer days of year"} and [[mi]{.overline}d]{.tool data-bs-toggle="tooltip" data-bs-title="mixed integer days of year"} are misaligned by 4 days in leap years and by 5 days in common years. To maintain a consistent 5-day misalignment, Dec uses [[mi]{.overline}d]{.tool data-bs-toggle="tooltip" data-bs-title="mixed integer day of year"} in common years and [[mi]{.overline}[d]{.grave}]{.tool data-bs-toggle="tooltip" data-bs-title="mixed integer day of year"} in leap years. To get the [[mi]{.overline}[d]{.grave}]{.tool data-bs-toggle="tooltip" data-bs-title="mixed integer day of year"}, we add one to the [[mi]{.overline}d]{.tool data-bs-toggle="tooltip" data-bs-title="mixed integer day of year"} and then add a grave accent above the last digit: [[mi]{.overline}[d]{.grave}]{.tool data-bs-toggle="tooltip" data-bs-title="mixed integer day of year"} = [[mi]{.overline}d]{.tool data-bs-toggle="tooltip" data-bs-title="mixed integer day of year"} + 1. @tbl-vinculeap below shows the [pid]{.tool data-bs-toggle="tooltip" data-bs-title="positive integer days of year"}, [nid]{.tool data-bs-toggle="tooltip" data-bs-title="negative integer day of year"}, [nid]{.overline .tool data-bs-toggle="tooltip" data-bs-title="negative integer day of year"}, and [[mi]{.overline}[d]{.grave}]{.tool data-bs-toggle="tooltip" data-bs-title="mixed integer day of year"} of the first and last 11 days of a common year.

::::: {#tbl-vinculeap}

::: {.d-block .d-xl-none}
| [pid]{.tool data-bs-toggle="tooltip" data-bs-title="positive integer days of year"} | | | [nid]{.tool data-bs-toggle="tooltip" data-bs-title="negative integer day of year"} | | | [nid]{.overline .tool data-bs-toggle="tooltip" data-bs-title="negative integer day of year"} | [[mi]{.overline}d]{.tool data-bs-toggle="tooltip" data-bs-title="mixed integer day of year"} |
|-----|-|-|------|-|-|------------------|----------------------------|
| 0   | | | -366 | | | [366]{.overline} | [37]{.overline}[5]{.grave} |
| 1   | | | -365 | | | [365]{.overline} | [37]{.overline}[6]{.grave} |
| 2   | | | -364 | | | [364]{.overline} | [37]{.overline}[7]{.grave} |
| 3   | | | -363 | | | [363]{.overline} | [37]{.overline}[8]{.grave} |
| 4   | | | -362 | | | [362]{.overline} | [37]{.overline}[9]{.grave} |
| 5   | | | -361 | | | [361]{.overline} | [36]{.overline}[0]{.grave} |
| 6   | | | -360 | | | [360]{.overline} | [36]{.overline}[1]{.grave} |
| 7   | | | -359 | | | [359]{.overline} | [36]{.overline}[2]{.grave} |
| 8   | | | -358 | | | [358]{.overline} | [36]{.overline}[3]{.grave} |
| 9   | | | -357 | | | [357]{.overline} | [36]{.overline}[4]{.grave} |
| 10  | | | -356 | | | [356]{.overline} | [36]{.overline}[5]{.grave} |
| ... | | | ...  | | | ...              | ...                        |
| 355 | | | -11  | | | [11]{.overline}  | [1]{.overline}[0]{.grave}  |
| 356 | | | -10  | | | [10]{.overline}  | [1]{.overline}[1]{.grave}  |
| 357 | | | -9   | | | [9]{.overline}   | [1]{.overline}[2]{.grave}  |
| 358 | | | -8   | | | [8]{.overline}   | [1]{.overline}[3]{.grave}  |
| 359 | | | -7   | | | [7]{.overline}   | [1]{.overline}[4]{.grave}  |
| 360 | | | -6   | | | [6]{.overline}   | [1]{.overline}[5]{.grave}  |
| 361 | | | -5   | | | [5]{.overline}   | [1]{.overline}[6]{.grave}  |
| 362 | | | -4   | | | [4]{.overline}   | [1]{.overline}[7]{.grave}  |
| 363 | | | -3   | | | [3]{.overline}   | [1]{.overline}[8]{.grave}  |
| 364 | | | -2   | | | [2]{.overline}   | [1]{.overline}[9]{.grave}  |
| 365 | | | -1   | | | [1]{.overline}   | [0]{.overline}[0]{.grave}  |
:::

::: {.d-none .d-xl-block}
| [pid]{.tool data-bs-toggle="tooltip" data-bs-title="positive integer days of year"} | | [nid]{.tool data-bs-toggle="tooltip" data-bs-title="negative integer day of year"} | | [nid]{.overline .tool data-bs-toggle="tooltip" data-bs-title="negative integer day of year"} | [[mi]{.overline}d]{.tool data-bs-toggle="tooltip" data-bs-title="mixed integer day of year"} | | | | | | | | | | [pid]{.tool data-bs-toggle="tooltip" data-bs-title="positive integer days of year"} | | [nid]{.tool data-bs-toggle="tooltip" data-bs-title="negative integer day of year"} | | [nid]{.overline .tool data-bs-toggle="tooltip" data-bs-title="negative integer day of year"} | [[mi]{.overline}d]{.tool data-bs-toggle="tooltip" data-bs-title="mixed integer day of year"} |
|----|-|------|-|------------------|----------------------------|-|-|-|-|-|-|-|-|-|-----|-|-----|-|-----------------|----------------------------|
| 0  | | -366 | | [366]{.overline} | [37]{.overline}[5]{.grave} | | | | | | | | | | 354 | | -11 | | [11]{.overline} | [1]{.overline}[0]{.grave}  |
| 1  | | -365 | | [365]{.overline} | [37]{.overline}[6]{.grave} | | | | | | | | | | 355 | | -10 | | [10]{.overline} | [1]{.overline}[1]{.grave}  |
| 2  | | -364 | | [364]{.overline} | [37]{.overline}[7]{.grave} | | | | | | | | | | 356 | | -9  | | [9]{.overline}  | [1]{.overline}[2]{.grave}  |
| 3  | | -363 | | [363]{.overline} | [37]{.overline}[8]{.grave} | | | | | | | | | | 357 | | -8  | | [8]{.overline}  | [1]{.overline}[3]{.grave}  |
| 4  | | -362 | | [362]{.overline} | [37]{.overline}[9]{.grave} | | | | | | | | | | 358 | | -7  | | [7]{.overline}  | [1]{.overline}[4]{.grave}  |
| 5  | | -361 | | [361]{.overline} | [36]{.overline}[0]{.grave} | | | | | | | | | | 359 | | -6  | | [6]{.overline}  | [1]{.overline}[5]{.grave}  |
| 6  | | -360 | | [360]{.overline} | [36]{.overline}[1]{.grave} | | | | | | | | | | 360 | | -5  | | [5]{.overline}  | [1]{.overline}[6]{.grave}  |
| 7  | | -359 | | [359]{.overline} | [36]{.overline}[2]{.grave} | | | | | | | | | | 361 | | -4  | | [4]{.overline}  | [1]{.overline}[7]{.grave}  |
| 8  | | -358 | | [358]{.overline} | [36]{.overline}[3]{.grave} | | | | | | | | | | 362 | | -3  | | [3]{.overline}  | [1]{.overline}[8]{.grave}  |
| 9  | | -357 | | [357]{.overline} | [36]{.overline}[4]{.grave} | | | | | | | | | | 363 | | -2  | | [2]{.overline}  | [1]{.overline}[9]{.grave}  |
| 10 | | -356 | | [356]{.overline} | [36]{.overline}[5]{.grave} | | | | | | | | | | 364 | | -1  | | [1]{.overline}  | [0]{.overline}[0]{.grave}  |

:::

:::::

The Schedule [L]{.tool data-bs-toggle="tooltip" data-bs-title="duotrigesimal L is decimal 14 or binary 01110"} rule for categorization of work and rest days can be summarized as [[[mi]{.overline}d]{.tool data-bs-toggle="tooltip" data-bs-title="mixed integer day of year"} mod 5 ∈ {1,2,3}] in common years, [[[mi]{.overline}[d]{.grave}]{.tool data-bs-toggle="tooltip" data-bs-title="mixed integer day of year"} mod 5 ∈ {1,2,3}] in leap years, or [[pid]{.tool data-bs-toggle="tooltip" data-bs-title="positive integer days of year"} mod 5 ∈ {1,2,3}] in all years. 
...
| [pid]{.tool data-bs-toggle="tooltip" data-bs-title="positive integer days of year"} | | | [nid]{.tool data-bs-toggle="tooltip" data-bs-title="negative integer day of year"} | | | [nid]{.overline .tool data-bs-toggle="tooltip" data-bs-title="negative integer day of year"} | [[mi]{.overline}d]{.tool data-bs-toggle="tooltip" data-bs-title="mixed integer day of year"} |
|-----|-|-|----------------------|-|-|------------------|----------------------------|
| 0   | | | -36[4]{.doubleacute} | | | [366]{.overline} | [37]{.overline}[5]{.grave} |
| 1   | | | -36[3]{.doubleacute} | | | [365]{.overline} | [37]{.overline}[6]{.grave} |
| 2   | | | -36[2]{.doubleacute} | | | [364]{.overline} | [37]{.overline}[7]{.grave} |
| 3   | | | -36[1]{.doubleacute} | | | [363]{.overline} | [37]{.overline}[8]{.grave} |
| 4   | | | -36[0]{.doubleacute} | | | [362]{.overline} | [37]{.overline}[9]{.grave} |
| 5   | | | -36[9]{.doubleacute} | | | [361]{.overline} | [36]{.overline}[0]{.grave} |
| 6   | | | -35[8]{.doubleacute} | | | [360]{.overline} | [36]{.overline}[1]{.grave} |
| 7   | | | -35[7]{.doubleacute} | | | [359]{.overline} | [36]{.overline}[2]{.grave} |
| 8   | | | -35[6]{.doubleacute} | | | [358]{.overline} | [36]{.overline}[3]{.grave} |
| 9   | | | -35[5]{.doubleacute} | | | [357]{.overline} | [36]{.overline}[4]{.grave} |
| 10  | | | -35[4]{.doubleacute} | | | [356]{.overline} | [36]{.overline}[5]{.grave} |
| ... | | | ...                  | | | ...              | ...                        |
| 355 | | | -[9]{.doubleacute}   | | | [11]{.overline}  | [1]{.overline}[0]{.grave}  |
| 356 | | | -[8]{.doubleacute}   | | | [10]{.overline}  | [1]{.overline}[1]{.grave}  |
| 357 | | | -[7]{.doubleacute}   | | | [9]{.overline}   | [1]{.overline}[2]{.grave}  |
| 358 | | | -[6]{.doubleacute}   | | | [8]{.overline}   | [1]{.overline}[3]{.grave}  |
| 359 | | | -[5]{.doubleacute}   | | | [7]{.overline}   | [1]{.overline}[4]{.grave}  |
| 360 | | | -[4]{.doubleacute}   | | | [6]{.overline}   | [1]{.overline}[5]{.grave}  |
| 361 | | | -[3]{.doubleacute}   | | | [5]{.overline}   | [1]{.overline}[6]{.grave}  |
| 362 | | | -[2]{.doubleacute}   | | | [4]{.overline}   | [1]{.overline}[7]{.grave}  |
| 363 | | | -[1]{.doubleacute}   | | | [3]{.overline}   | [1]{.overline}[8]{.grave}  |
| 364 | | | -[0]{.doubleacute}   | | | [2]{.overline}   | [1]{.overline}[9]{.grave}  |
| 365 | | | -[0]{.acute}         | | | [1]{.overline}   | [0]{.overline}[0]{.grave}  |
:::

::: {.d-none .d-xl-block}
| [pid]{.tool data-bs-toggle="tooltip" data-bs-title="positive integer days of year"} | | [nid]{.tool data-bs-toggle="tooltip" data-bs-title="negative integer day of year"} | | [nid]{.overline .tool data-bs-toggle="tooltip" data-bs-title="negative integer day of year"} | [[mi]{.overline}d]{.tool data-bs-toggle="tooltip" data-bs-title="mixed integer day of year"} | | | | | | | | | | [pid]{.tool data-bs-toggle="tooltip" data-bs-title="positive integer days of year"} | | [nid]{.tool data-bs-toggle="tooltip" data-bs-title="negative integer day of year"} | | [nid]{.overline .tool data-bs-toggle="tooltip" data-bs-title="negative integer day of year"} | [[mi]{.overline}d]{.tool data-bs-toggle="tooltip" data-bs-title="mixed integer day of year"} |
|----|-|------|-|----------------------|----------------------------|-|-|-|-|-|-|-|-|-|-----|-|-----|-|--------------------|----------------------------|
| 0  | | -366 | | -36[4]{.doubleacute} | [37]{.overline}[5]{.grave} | | | | | | | | | | 354 | | -11 | | -[9]{.doubleacute} | [1]{.overline}[0]{.grave}  |
| 1  | | -365 | | -36[3]{.doubleacute} | [37]{.overline}[6]{.grave} | | | | | | | | | | 355 | | -10 | | -[8]{.doubleacute} | [1]{.overline}[1]{.grave}  |
| 2  | | -364 | | -36[2]{.doubleacute} | [37]{.overline}[7]{.grave} | | | | | | | | | | 356 | | -9  | | -[7]{.doubleacute} | [1]{.overline}[2]{.grave}  |
| 3  | | -363 | | -36[1]{.doubleacute} | [37]{.overline}[8]{.grave} | | | | | | | | | | 357 | | -8  | | -[6]{.doubleacute} | [1]{.overline}[3]{.grave}  |
| 4  | | -362 | | -36[0]{.doubleacute} | [37]{.overline}[9]{.grave} | | | | | | | | | | 358 | | -7  | | -[5]{.doubleacute} | [1]{.overline}[4]{.grave}  |
| 5  | | -361 | | -36[9]{.doubleacute} | [36]{.overline}[0]{.grave} | | | | | | | | | | 359 | | -6  | | -[4]{.doubleacute} | [1]{.overline}[5]{.grave}  |
| 6  | | -360 | | -35[8]{.doubleacute} | [36]{.overline}[1]{.grave} | | | | | | | | | | 360 | | -5  | | -[3]{.doubleacute} | [1]{.overline}[6]{.grave}  |
| 7  | | -359 | | -35[7]{.doubleacute} | [36]{.overline}[2]{.grave} | | | | | | | | | | 361 | | -4  | | -[2]{.doubleacute} | [1]{.overline}[7]{.grave}  |
| 8  | | -358 | | -35[6]{.doubleacute} | [36]{.overline}[3]{.grave} | | | | | | | | | | 362 | | -3  | | -[1]{.doubleacute} | [1]{.overline}[8]{.grave}  |
| 9  | | -357 | | -35[5]{.doubleacute} | [36]{.overline}[4]{.grave} | | | | | | | | | | 363 | | -2  | | -[0]{.doubleacute} | [1]{.overline}[9]{.grave}  |
| 10 | | -356 | | -35[4]{.doubleacute} | [36]{.overline}[5]{.grave} | | | | | | | | | | 364 | | -1  | | -[0]{.acute}       | [0]{.overline}[0]{.grave}  |
...
| [pid]{.tool data-bs-toggle="tooltip" data-bs-title="positive integer days of year"} | | | [nid]{.tool data-bs-toggle="tooltip" data-bs-title="negative integer day of year"} | | | [nid]{.overline .tool data-bs-toggle="tooltip" data-bs-title="negative integer day of year"} | [[mi]{.overline}d]{.tool data-bs-toggle="tooltip" data-bs-title="mixed integer day of year"} |
|-----|-|-|------|-|-|------------------|------------------|
| 0   | | | -36[4]{.acute} | | | [365]{.overline} | [37]{.overline}5 |
| 1   | | | -36[3]{.acute} | | | [364]{.overline} | [37]{.overline}6 |
| 2   | | | -36[2]{.acute} | | | [363]{.overline} | [37]{.overline}7 |
| 3   | | | -36[1]{.acute} | | | [362]{.overline} | [37]{.overline}8 |
| 4   | | | -36[0]{.acute} | | | [361]{.overline} | [37]{.overline}9 |
| 5   | | | -35[9]{.acute} | | | [360]{.overline} | [36]{.overline}0 |
| 6   | | | -35[8]{.acute} | | | [359]{.overline} | [36]{.overline}1 |
| 7   | | | -35[7]{.acute} | | | [358]{.overline} | [36]{.overline}2 |
| 8   | | | -35[6]{.acute} | | | [357]{.overline} | [36]{.overline}3 |
| 9   | | | -35[5]{.acute} | | | [356]{.overline} | [36]{.overline}4 |
| 10  | | | -35[4]{.acute} | | | [355]{.overline} | [36]{.overline}5 |
| ... | | | ...  | | | ...              | ...              |
| 354 | | | -1[0]{.acute}  | | | [11]{.overline}  | [2]{.overline}9  |
| 355 | | | -[9]{.acute}   | | | [10]{.overline}  | [1]{.overline}0  |
| 356 | | | -[8]{.acute}   | | | [9]{.overline}   | [1]{.overline}1  |
| 357 | | | -[7]{.acute}   | | | [8]{.overline}   | [1]{.overline}2  |
| 358 | | | -[6]{.acute}   | | | [7]{.overline}   | [1]{.overline}3  |
| 359 | | | -[5]{.acute}   | | | [6]{.overline}   | [1]{.overline}4  |
| 360 | | | -[4]{.acute}   | | | [5]{.overline}   | [1]{.overline}5  |
| 361 | | | -[3]{.acute}   | | | [4]{.overline}   | [1]{.overline}6  |
| 362 | | | -[2]{.acute}   | | | [3]{.overline}   | [1]{.overline}7  |
| 363 | | | -[1]{.acute}   | | | [2]{.overline}   | [1]{.overline}8  |
| 364 | | | -[0]{.acute}   | | | [1]{.overline}   | [1]{.overline}9  |
:::

::: {.d-none .d-xl-block}
| [pid]{.tool data-bs-toggle="tooltip" data-bs-title="positive integer days of year"} | | [nid]{.tool data-bs-toggle="tooltip" data-bs-title="negative integer day of year"} | | [nid]{.overline .tool data-bs-toggle="tooltip" data-bs-title="negative integer day of year"} | [[mi]{.overline}d]{.tool data-bs-toggle="tooltip" data-bs-title="mixed integer day of year"} | | | | | | | | | | [pid]{.tool data-bs-toggle="tooltip" data-bs-title="positive integer days of year"} | | [nid]{.tool data-bs-toggle="tooltip" data-bs-title="negative integer day of year"} | | [nid]{.overline .tool data-bs-toggle="tooltip" data-bs-title="negative integer day of year"} | [[mi]{.overline}d]{.tool data-bs-toggle="tooltip" data-bs-title="mixed integer day of year"} |
|----|-|------|-|------------------|------------------|-|-|-|-|-|-|-|-|-|-----|-|-----|-|-----------------|------------------|
| 0  | | -365 | | -36[4]{.acute}   | [37]{.overline}5 | | | | | | | | | | 354 | | -1[0]{.acute} | | [11]{.overline} | [2]{.overline}9  |
| 1  | | -364 | | -36[3]{.acute}   | [37]{.overline}6 | | | | | | | | | | 355 | | -[9]{.acute}  | | [10]{.overline} | [1]{.overline}0  |
| 2  | | -363 | | -36[2]{.acute}   | [37]{.overline}7 | | | | | | | | | | 356 | | -[8]{.acute}  | | [9]{.overline}  | [1]{.overline}1  |
| 3  | | -362 | | -36[1]{.acute}   | [37]{.overline}8 | | | | | | | | | | 357 | | -[7]{.acute}  | | [8]{.overline}  | [1]{.overline}2  |
| 4  | | -361 | | -36[0]{.acute}   | [37]{.overline}9 | | | | | | | | | | 358 | | -[6]{.acute}  | | [7]{.overline}  | [1]{.overline}3  |
| 5  | | -360 | | -35[9]{.acute}   | [36]{.overline}0 | | | | | | | | | | 359 | | -[5]{.acute}  | | [6]{.overline}  | [1]{.overline}4  |
| 6  | | -359 | | -35[8]{.acute}   | [36]{.overline}1 | | | | | | | | | | 360 | | -[4]{.acute}  | | [5]{.overline}  | [1]{.overline}5  |
| 7  | | -358 | | -35[7]{.acute}   | [36]{.overline}2 | | | | | | | | | | 361 | | -[3]{.acute}  | | [4]{.overline}  | [1]{.overline}6  |
| 8  | | -357 | | -35[6]{.acute}   | [36]{.overline}3 | | | | | | | | | | 362 | | -[2]{.acute}  | | [3]{.overline}  | [1]{.overline}7  |
| 9  | | -356 | | -35[5]{.acute}   | [36]{.overline}4 | | | | | | | | | | 363 | | -[1]{.acute}  | | [2]{.overline}  | [1]{.overline}8  |
| 10 | | -355 | | -35[4]{.acute}   | [36]{.overline}5 | | | | | | | | | | 364 | | -[0]{.acute}  | | [1]{.overline}  | [1]{.overline}9  |

:::

:::::

We can apply the same work and rest day categorization rule to the last digit of a [[mi]{.overline}d]{.tool data-bs-toggle="tooltip" data-bs-title="mixed integer day of year"} in a common year, a [[mi]{.overline}[d]{.grave}]{.tool data-bs-toggle="tooltip" data-bs-title="mixed integer day of year"} in a leap year, or a [pid]{.tool data-bs-toggle="tooltip" data-bs-title="positive integer days of year"} in any year and always. and we can look at  in a common year is [37]{.overline}5 to [1]{.overline}9. In a leap year, Negative and positive digits in a mixed integer cannot fully cancel

For any Dec schedule that designated by a single letter,
work 
[9]{.grave}
...
Just like the last digit of a [pid]{.tool data-bs-toggle="tooltip" data-bs-title="positive integer days of year"} is a dox, the last digit of a mixe[d]{.overline} 
We can obtain the last digit of a number by keeping the remainder after dividing by ten as in @eq-dox: [dox]{.tool data-bs-toggle="tooltip" data-bs-title="days of xún"} = [pid]{.tool data-bs-toggle="tooltip" data-bs-title="positive integer days of year"} [mod](https://en.wikipedia.org/wiki/Modulo#:~:text=returns%20the%20remainder) 10. To can convert between the last digits of the [pid]{.tool data-bs-toggle="tooltip" data-bs-title="positive integer days of year"} and mixe[d]{.overline} columns of @tbl-vincommon above, we add 5 and then keep the remainder after dividing by ten: [dox]{.tool data-bs-toggle="tooltip" data-bs-title="days of xún"} = (mixe[d]{.overline} [mod](https://en.wikipedia.org/wiki/Modulo#:~:text=returns%20the%20remainder) 10 + 5) [mod](https://en.wikipedia.org/wiki/Modulo#:~:text=returns%20the%20remainder) 10, because the last digits are  This approach only works 

in the [pid]{.tool data-bs-toggle="tooltip" data-bs-title="positive integer days of year"} and mixe[d]{.overline} columns 

$$\operatorname{sign}(n) = \begin{cases} -1 & n<0,\\ 0 & n=0,\\ 1 & n>0. \end{cases}$$

$$\text{mixe}\overline{\text{d}} = \text{nid} + 2(\text{nid} \bmod 10)\operatorname{sign}(\text{nid})$$

$$\text{nid} = \operatorname{sign}(\text{mixe}\overline{\text{d}}) \left(10\left\lfloor\frac{|\text{mixe}\overline{\text{d}}|}{10}\right\rfloor - (|\text{mixe}\overline{\text{d}}| \bmod 10) \right)$$

Regardless of whether we follow Schedule [F]{.tool data-bs-toggle="tooltip" data-bs-title="duotrigesimal F is decimal 7 or binary 00111"}, [L]{.tool data-bs-toggle="tooltip" data-bs-title="duotrigesimal L is decimal 14 or binary 01110"}, or [X]{.tool data-bs-toggle="tooltip" data-bs-title="duotrigesimal X is decimal 28 or binary 11100"}, 

In contrast to @tbl-vincommon above, @tbl-vinculeap below displays the last 11 days of a leap year. In the last column of @tbl-vinculeap, Schedule [F]{.tool data-bs-toggle="tooltip" data-bs-title="duotrigesimal F is decimal 7 or binary 00111"} looks like Schedule [L]{.tool data-bs-toggle="tooltip" data-bs-title="duotrigesimal L is decimal 14 or binary 01110"} and Schedule [L]{.tool data-bs-toggle="tooltip" data-bs-title="duotrigesimal L is decimal 14 or binary 01110"} resembles Schedule [X]{.tool data-bs-toggle="tooltip" data-bs-title="duotrigesimal X is decimal 28 or binary 11100"}.

The first row of @tbl-vincommon is essentially mixe[d]{.overline} value 

The equation to obtain the last digit of the numbers in the mixe[d]{.overline} column of @tbl-vincommon is (10 -- |nid| mod 10) mod 10.

= the difference between 10 and the nid mod 10 into dox by adding 5 and keeping the last digit of the sum: (mixe[d]{.overline} + 5) [mod](https://en.wikipedia.org/wiki/Modulo#:~:text=returns%20the%20remainder) 10 = [dox]{.tool data-bs-toggle="tooltip" data-bs-title="days of xún"}.

In the first and last columns of @tbl-vincommon, numbers that end in 0, [0]{.overline}, 4, [4]{.overline}, 5, [5]{.overline}, 9, or [9]{.overline} represent Schedule [L]{.tool data-bs-toggle="tooltip" data-bs-title="duotrigesimal L is decimal 14 or binary 01110"} rest days and numbers that end in 1, [1]{.overline}, 2, [2]{.overline}, 3, [3]{.overline}, 6, [6]{.overline}, 7, [7]{.overline}, 8, or [8]{.overline} represent Schedule [L]{.tool data-bs-toggle="tooltip" data-bs-title="duotrigesimal L is decimal 14 or binary 01110"} work days.


If we follow Schedule [F]{.tool data-bs-toggle="tooltip" data-bs-title="duotrigesimal F is decimal 7 or binary 00111"}, Even though complement notation is [nid]{.tool data-bs-toggle="tooltip" data-bs-title="negative integer day of year"} that end in 0, 1, 5, or 6 represent Schedule [L]{.tool data-bs-toggle="tooltip" data-bs-title="duotrigesimal L is decimal 14 or binary 01110"} rest days and [nid]{.tool data-bs-toggle="tooltip" data-bs-title="negative integer day of year"} that end in 2, 3, 4, 7, 8, or 9 represent Schedule [L]{.tool data-bs-toggle="tooltip" data-bs-title="duotrigesimal L is decimal 14 or binary 01110"} work days, which is a pattern that resembles . In leap years, Schedule [L]{.tool data-bs-toggle="tooltip" data-bs-title="duotrigesimal L is decimal 14 or binary 01110"} work days are no longer aligned in both [pid]{.tool data-bs-toggle="tooltip" data-bs-title="positive integer days of year"} and [nid]{.tool data-bs-toggle="tooltip" data-bs-title="negative integer day of year"}. If we classify work and rest days by the last digit of [nid]{.tool data-bs-toggle="tooltip" data-bs-title="negative integer day of year"} written in Dec complement notation. @tbl-vinculeap below shows the [pid]{.tool data-bs-toggle="tooltip" data-bs-title="positive integer days of year"} and [nid]{.tool data-bs-toggle="tooltip" data-bs-title="negative integer day of year"} of the last 10 days of a common year alongside the one-, two-, and three-digit complements of each [nid]{.tool data-bs-toggle="tooltip" data-bs-title="negative integer day of year"}. In @tbl-vinculeap, numbers that are in the same row are equivalent, numbers that end in 0, 4, 5, or 9 represent Schedule [L]{.tool data-bs-toggle="tooltip" data-bs-title="duotrigesimal L is decimal 14 or binary 01110"} rest days and numbers that end in 1, 2, 3, 6, 7, or 8 represent Schedule [L]{.tool data-bs-toggle="tooltip" data-bs-title="duotrigesimal L is decimal 14 or binary 01110"} work days.

::: {#tbl-vinculeap}
| pid | nid | [nid]{.overline}  | [mi]{.overline}d̀ | mi[d]{.overline} |
|-----|-----|-------------------|------------------|------------------|
| 355 | -11 | [11]{.overline}   | [1]{.overline}0̀  | -2[9]{.overline} |
| 356 | -10 | [10]{.overline}   | [1]{.overline}1̀  | -1[0]{.overline} |
| 357 | -9  | [9]{.overline}    | [1]{.overline}2̀  | -1[1]{.overline} |
| 358 | -8  | [8]{.overline}    | [1]{.overline}3̀  | -1[2]{.overline} |
| 359 | -7  | [7]{.overline}    | [1]{.overline}4̀  | -1[3]{.overline} |
| 360 | -6  | [6]{.overline}    | [1]{.overline}5̀  | -1[4]{.overline} |
| 361 | -5  | [5]{.overline}    | [1]{.overline}6̀  | -1[5]{.overline} |
| 362 | -4  | [4]{.overline}    | [1]{.overline}7̀  | -1[6]{.overline} |
| 363 | -3  | [3]{.overline}    | [1]{.overline}8̀  | -1[7]{.overline} |
| 364 | -2  | [2]{.overline}    | [1]{.overline}9̀  | -1[8]{.overline} |
| 365 | -1  | [1]{.overline}    | [1]{.overline}9  | -1[9]{.overline} |
:::

In a leap year, write the final days in a way that matches a common year. The -1 identifies that the doy belongs to a leap year and makes the Dec schedule classification of work and rest days match for dox and do[x]{.overline}.

::: {#tbl-vinculeapminusone}
| pid | nid-1 | [pure]{.overline}-1 | mi[d]{.overline}-1 |
|-----|-------|---------------------|--------------------|
| 355 | -10-1 | [10]{.overline}-1   | -1[0]{.overline}-1 |
| 356 | -9-1  | [9]{.overline}-1    | -1[1]{.overline}-1 |
| 357 | -8-1  | [8]{.overline}-1    | -1[2]{.overline}-1 |
| 358 | -7-1  | [7]{.overline}-1    | -1[3]{.overline}-1 |
| 359 | -6-1  | [6]{.overline}-1    | -1[4]{.overline}-1 |
| 360 | -5-1  | [5]{.overline}-1    | -1[5]{.overline}-1 |
| 361 | -4-1  | [4]{.overline}-1    | -1[6]{.overline}-1 |
| 362 | -3-1  | [3]{.overline}-1    | -1[7]{.overline}-1 |
| 363 | -2-1  | [2]{.overline}-1    | -1[8]{.overline}-1 |
| 364 | -1-1  | [1]{.overline}-1    | -1[9]{.overline}-1 |
| 365 |  0-1  | [0]{.overline}-1    |   [0]{.overline}-1 |
:::

We can refer to the last day of a common year as [d]{.tool data-bs-toggle="tooltip" data-bs-title="day"}364 or Day -1 (d[1]{.overline}): 364 [mod](https://en.wikipedia.org/wiki/Modulo#:~:text=returns%20the%20remainder) 365 = -1 [mod](https://en.wikipedia.org/wiki/Modulo#:~:text=returns%20the%20remainder) 365. Similarly, the last day of a leap year can be referred to as d365 or d[1]{.overline}: 365 [mod](https://en.wikipedia.org/wiki/Modulo#:~:text=returns%20the%20remainder) 366 = -1 [mod](https://en.wikipedia.org/wiki/Modulo#:~:text=returns%20the%20remainder) 366.  Another way to write d[1]{.overline} is Day -1[9]{.overline}: -1 = -(10 -- 9). This alternative form, which is called the decacomplement, can be read as Xún -1 (x[1]{.overline}) [Dox]{.tool data-bs-toggle="tooltip" data-bs-title="days of xún"} 9.

which is the last [dox]{.tool data-bs-toggle="tooltip" data-bs-title="days of xún"} of the last "negative integer xún" ([nix]{.tool data-bs-toggle="tooltip" data-bs-title="negative integer xún"}) of the year. In common years, "positive integer xún" ([pix]{.tool data-bs-toggle="tooltip" data-bs-title="positive integer xún"}) and [nix]{.tool data-bs-toggle="tooltip" data-bs-title="negative integer xún"} have the same pattern of Schedule [L]{.tool data-bs-toggle="tooltip" data-bs-title="duotrigesimal L is decimal 14 or binary 01110"} work and rest days.

In a leap year, the Schedule [L]{.tool data-bs-toggle="tooltip" data-bs-title="duotrigesimal L is decimal 14 or binary 01110"} rest days are [Dox]{.tool data-bs-toggle="tooltip" data-bs-title="days of xún"} 0, 4, 5, and 9 in [pix]{.tool data-bs-toggle="tooltip" data-bs-title="positive integer xún"} and [Dox]{.tool data-bs-toggle="tooltip" data-bs-title="days of xún"} 3, 4, 8, and 9 in [nix]{.tool data-bs-toggle="tooltip" data-bs-title="negative integer xún"}. Essentially, any schedule we see in a [pix]{.tool data-bs-toggle="tooltip" data-bs-title="positive integer xún"} will appear rotated to the left by one position in [nix]{.tool data-bs-toggle="tooltip" data-bs-title="negative integer xún"} during leap years. The result of rotating Schedule [L]{.tool data-bs-toggle="tooltip" data-bs-title="duotrigesimal L is decimal 14 or binary 01110"} to the left by one position is Schedule [X]{.tool data-bs-toggle="tooltip" data-bs-title="duotrigesimal X is decimal 28 or binary 11100"}: [L]{.tool data-bs-toggle="tooltip" data-bs-title="duotrigesimal L is decimal 14 or binary 01110"} ↺ 1 = [X]{.tool data-bs-toggle="tooltip" data-bs-title="duotrigesimal X is decimal 28 or binary 11100"}. of d365 shifts 5432109876 we can follow a common year, an [nid]{.tool data-bs-toggle="tooltip" data-bs-title="negative integer day of year"} is   if the sum of its last digit and 10 is a Schedule [L]{.tool data-bs-toggle="tooltip" data-bs-title="duotrigesimal L is decimal 14 or binary 01110"} rest day. , 4, 5, or 9 and a work day otherwise.

-264 = -270 + 6 = -26[6]{.overline}

In a common year, with negative dox. changing the pattern of work and rest days. we can subtract 10 from a dox to get the last digit of a pid to get  from positive to negative dox. below shows Schedule [L]{.tool data-bs-toggle="tooltip" data-bs-title="duotrigesimal L is decimal 14 or binary 01110"} with negative dox in a common year. an overline () denotes a negative numbers. symbolizes and thus turn Dox 0 to -10, 1 to -9, 2 to -8, 3 to -7, -4, -3, and -2.  and Dop -3, -2, -1 in a leap year. If we want to use [nid]{.tool data-bs-toggle="tooltip" data-bs-title="negative integer day of year"} to identify work and rest days. depends on the

## Base32 {#b32}

The Schedule [L]{.tool data-bs-toggle="tooltip" data-bs-title="duotrigesimal L is decimal 14 or binary 01110"} pattern of rest and work days can be expressed in [binary](https://en.wikipedia.org/wiki/Binary_number#:~:text=only%20two%20symbols%20for%20the%20natural%20numbers%3A%20typically%200%20%28zero%29%20and%201%20%28one%29) ([base2]{.tool data-bs-toggle="tooltip" data-bs-title="binary"}) as 01110, [decimal](https://en.wikipedia.org/wiki/Decimal#:~:text=a%20numeral%20system%20that%20uses%20ten%20as%20its%20radix%20%28base%29) ([base10]{.tool data-bs-toggle="tooltip" data-bs-title="decimal"}) as 14, or Dec [duotrigesimal](https://en.wiktionary.org/wiki/duotrigesimal#:~:text=Based%20upon%20the%20number%20thirty%2Dtwo) ([base32]{.tool data-bs-toggle="tooltip" data-bs-title="duotrigesimal"}) as [L]{.tool data-bs-toggle="tooltip" data-bs-title="duotrigesimal L is decimal 14 or binary 01110"}. Each of the 32 Dec schedules can be represented by a single letter of the Dec base32 ([b32]{.tool data-bs-toggle="tooltip" data-bs-title="Dec base32"}) alphabet. The [b32]{.tool data-bs-toggle="tooltip" data-bs-title="Dec base32"} letters are listed in @tbl-b32 below alongside their base10 ([b10]{.tool data-bs-toggle="tooltip" data-bs-title="Dec base10"}) and base2 ([b2]{.tool data-bs-toggle="tooltip" data-bs-title="Dec base2"}) values.
...
There are 11 United States (US) [Federal holidays](https://www.opm.gov/policy-data-oversight/pay-leave/federal-holidays/). US Federal holidays that fall on a Gregorian calendar️ rest day, [Dow 0]{.tool data-bs-toggle="tooltip" data-bs-title="Sunday"} or [Dow 6]{.under .tool data-bs-toggle="tooltip" data-bs-title="Saturday"}, are observed on the nearest Gregorian calendar️ work day: [Dow 1]{.tool data-bs-toggle="tooltip" data-bs-title="Monday"} or [Dow 5]{.tool data-bs-toggle="tooltip" data-bs-title="Friday"}. Applying this rule to Schedule [L]{.tool data-bs-toggle="tooltip" data-bs-title="duotrigesimal L is decimal 14 or binary 01110"} and moving holidays from Dox 0 to 1, 4 to 3, 5 to 6, or 9 to 8 is not necessary because we can switch between different Dec schedules.

The last US Federal holiday of the Gregorian calendar year is [Christmas](https://en.wikipedia.org/wiki/Christmas#:~:text=annual%20festival%20commemorating%20the%20birth%20of%20Jesus%20Christ)🎄. The official date of Christmas in Dec is d299, which is the last day of [Hectoday]{.tool data-bs-toggle="tooltip" data-bs-title="hundreds of days"} 2 ([h]{.tool data-bs-toggle="tooltip" data-bs-title="groups of one hundred days"}2), but Christmas is likely to be celebrated on d300, the first day of [Hectoday]{.tool data-bs-toggle="tooltip" data-bs-title="hundreds of days"} 3 ([h]{.tool data-bs-toggle="tooltip" data-bs-title="groups of one hundred days"}3), by people who do not use Dec and live in a UTC time zone with a negative offset. The Dec analog of the [holiday season](https://en.wikipedia.org/wiki/Christmas_and_holiday_season#:~:text=an%20annual%20period%20generally%20spanning%20from%20November%20or%20December%20to%20early%20January%20incorporating%20Christmas%20Day%20and%20New%20Year%27s%20Day) is [Hectoday]{.tool data-bs-toggle="tooltip" data-bs-title="hundreds of days"} -1 ([h]{.tool data-bs-toggle="tooltip" data-bs-title="groups of one hundred days"}[1]{.overline}). 
...
The remainder after dividing a [pid]{.tool data-bs-toggle="tooltip" data-bs-title="positive integer day of year"} or a [nid]{.tool data-bs-toggle="tooltip" data-bs-title="negative integer day of year"} by 100 is a "day of hectoday" ([doh](#doh){#dayofhectoday .tool data-bs-toggle="tooltip" data-bs-title="day of hectoday"}). If we use a [pid]{.tool data-bs-toggle="tooltip" data-bs-title="positive integer day of year"}, the resulting [doh](#doh){#dayofhectoday .tool data-bs-toggle="tooltip" data-bs-title="day of hectoday"} is the percent of a [pih]{.tool data-bs-toggle="tooltip" data-bs-title="positive integer hectoday"} that has passed. A [doh](#doh){#dayofhectoday .tool data-bs-toggle="tooltip" data-bs-title="day of hectoday"} derived from an [nid]{.tool data-bs-toggle="tooltip" data-bs-title="negative integer day of year"} is the percent of an [nih]{.tool data-bs-toggle="tooltip" data-bs-title="negative integer hectoday"} that is still has not passed. The current [pid]{.tool data-bs-toggle="tooltip" data-bs-title="positive integer day of year"}, \${decDoty}, tells us that [h]{.tool data-bs-toggle="tooltip" data-bs-title="groups of one hundred days"}\${decPih} is \${decDohPid}% done and based on the current [nid]{.tool data-bs-toggle="tooltip" data-bs-title="negative integer day of year"}, \${decNid}, we know that [h]{.tool data-bs-toggle="tooltip" data-bs-title="groups of one hundred days"}[\${decNih}]{.overline} is \${decDohNid}% unfinished.
...
after the start of [pih]{.tool data-bs-toggle="tooltip" data-bs-title="positive integer hectoday"} and [nih]{.tool data-bs-toggle="tooltip" data-bs-title="negative integer hectoday"}, 
The connection between [pid](#pid){.tool data-bs-toggle="tooltip" data-bs-title="positive integer days of year"} and seasonal temperature changes requires [pid](#pid){.tool data-bs-toggle="tooltip" data-bs-title="positive integer days of year"} to reset after Day -1 (d[1]{.overline}), the last day of the Decalendar year. If we do not need to keep track of years or seasons, we can use a single integer called a "day of [era](https://en.wikipedia.org/wiki/Calendar_era#:~:text=the%20period%20of%20time%20elapsed%20since%20one%20epoch%20of%20a%20calendar)" ([doe]{.tool data-bs-toggle="tooltip" data-bs-title="day of era"}) instead of a Dec year+day date.
