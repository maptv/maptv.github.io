...
To create a Dec week date, we need two types of Dec date expansion. We use minuend expansion to turn the minuend [d]{.cyan} into the subtrahend [d]{.cyan}-[w]{.wine} and the difference [w]{.wine} and then use dividend expansion to convert the dividend [d]{.cyan}-[w]{.wine}+[w~0~]{.wine} into the divisor 7 and the quotient [W]{.wheat}.
...
Holidays with a reusable♻️floating🛟date fall on the same month,
[dom]{.under .tool data-bs-toggle="tooltip" data-bs-title="day-of-month"}, and [doy]{.under .tool data-bs-toggle="tooltip" data-bs-title="day-of-year"}, but not the same [dow]{.under .tool data-bs-toggle="tooltip" data-bs-title="day-of-week"}, every year. Months and [doms]{.under .tool data-bs-toggle="tooltip" data-bs-title="days-of-month"} are perfectly synchronized with years and doys, but weeks and dows do not aligned with  only used in the Gregorian calendar for date identification. In contrast, [doys]{.under .tool data-bs-toggle="tooltip" data-bs-title="days-of-year"} not only identify dates but also provide all of the information needed for pently schedules. If we used the last digit of the dom to determine work and rest days, we would even up with a very chaotic.

In Dec, [doys]{.under .tool data-bs-toggle="tooltip" data-bs-title="days-of-year"} not only identify dates but also provide all of the information needed for pently schedules. 
