...
An [nih](#nih){.tool data-bs-toggle="tooltip" data-bs-title="negative integer hectoday"} [mid]{.tool data-bs-toggle="tooltip" data-bs-title="mixed integer day of year"}, [\${decNih}]{.overline}\${decDohNidMidPad}, shows the current [nih](#nih){.tool data-bs-toggle="tooltip" data-bs-title="negative integer hectoday"} with its first digit: [\${decNih}]{.overline}, a [doh](#doh){.tool data-bs-toggle="tooltip" data-bs-title="days of hectoday"} with its last two digits: \${decDohNidMidPad}, an [nih](#nih){.tool data-bs-toggle="tooltip" data-bs-title="negative integer hectoday"} "mixed integer xún" ([mix](#mix){.tool data-bs-toggle="tooltip" data-bs-title="mixed integer xún"}) with its first two digits: [\${decNih}]{.overline}\${decDohNidMidPad0}, and a [dox](#dox){.tool data-bs-toggle="tooltip" data-bs-title="days of xún"} with its final digit: \${decDoxNidMid}. During [h]{.tool data-bs-toggle="tooltip" data-bs-title="group of one hundred days"}[1]{.overline .color265by365}, Dec recommends using [nih](#nih){.tool data-bs-toggle="tooltip" data-bs-title="negative integer hectoday"} [mid]{.tool data-bs-toggle="tooltip" data-bs-title="mixed integer day of year"} instead of [pid]{.tool data-bs-toggle="tooltip" data-bs-title="positive integer day of year"} for personal timekeeping because [nih](#nih){.tool data-bs-toggle="tooltip" data-bs-title="negative integer hectodays"} [mid]{.tool data-bs-toggle="tooltip" data-bs-title="mixed integer day of year"} take into account the [dyl]{.tool data-bs-toggle="tooltip" data-bs-title="Decalendar year length"} and thus avoid uncertainty regarding the [eoy](#eoy){.tool data-bs-toggle="tooltip" data-bs-title="end of year"}.

We can convert a [nih](#nih){.tool data-bs-toggle="tooltip" data-bs-title="negative integer hectoday"} [mix](#mix){.tool data-bs-toggle="tooltip" data-bs-title="mixed integer xún"} into a [nix](#nix){.tool data-bs-toggle="tooltip" data-bs-title="negative integer xún"} via simple arithmetic: [\${decNih}]{.overline}\${decDohNidMidPad0} = -\${decNih}0 + \${decDohNidMidPad0} = [\${decNix}]{.overline}. If we then append a [dox](#dox){.tool data-bs-toggle="tooltip" data-bs-title="days of xún"}, we get a [nix](#nix){.tool data-bs-toggle="tooltip" data-bs-title="negative integer xún"} [mid]{.tool data-bs-toggle="tooltip" data-bs-title="mixed integer day of year"}: [\${decNix}]{.overline}\${decDoxNidMid}.


the [nih](#nih){.tool data-bs-toggle="tooltip" data-bs-title="negative integer hectoday"} [mid]{.tool data-bs-toggle="tooltip" data-bs-title="mixed integer day of year"} shows the nih directly is al we not know whether  day after d364 is d365 in a leap year often d0 but may be , whereas d[1]{.overline}99 is always followed by d0.

In the Northern Hemisphere, we can pronounce the first day of [h]{.tool data-bs-toggle="tooltip" data-bs-title="group of one hundred days"}[1]{.overline .color265by365}, d[1]{.overline}00 as "Winter Zero" according to @tbl-hoy.

last two [nih](#nih){.tool data-bs-toggle="tooltip" data-bs-title="negative integer hectoday"} [mid]{.tool data-bs-toggle="tooltip" data-bs-title="mixed integer day of year"} of any year are [1]{.overline}98 and [1]{.overline}99. In a leap year, we may want to write [1]{.overline}98 as [1]{.overline}9[9]{.grave} and [1]{.overline}99 as [0]{.overline}0[0]{.grave}.
