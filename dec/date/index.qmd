...
We can find out that [h]{.tool data-bs-toggle="tooltip" data-bs-title="group of one hundred days"}\${decPih} is \${decDohPid}% done from the current pid: \${decDoty}, that \${decDohPidMid}% is left until [h]{.tool data-bs-toggle="tooltip" data-bs-title="groups of one hundred days"}\${decPihPlus1} from the current three-digit countdown [mid]{.tool data-bs-toggle="tooltip" data-bs-title="mixed integer day of year"} which has a vinculum over its last two digits: \${decPihPlus1}[\${decDohPidMidPad}]{.overline}, that \${decDohNid}% remains until h[\${decNihPlus1}]{.overline} from the current [nid](#nid){.tool data-bs-toggle="tooltip" data-bs-title="negative integer day of year"}: \${decNid}, and that [h]{.tool data-bs-toggle="tooltip" data-bs-title="groups of one hundred days"}[\${decNih}]{.overline} is \${decDohNidMidPad}% finished from the current three-digit countup [mid]{.tool data-bs-toggle="tooltip" data-bs-title="mixed integer day of year"} which has a vinculum over only its first digit: [\${decNih}]{.overline}\${decDohNidMidPad}. 

Any kind of [doy]{.tool data-bs-toggle="tooltip" data-bs-title="days of year"} can each be split into either an [x]{.tool data-bs-toggle="tooltip" data-bs-title="groups of ten days"} and [dox]{.tool data-bs-toggle="tooltip" data-bs-title="days of xún"} or an [h](#h){.tool data-bs-toggle="tooltip" data-bs-title="groups of one hundred days"} and [doh](#doh){.tool data-bs-toggle="tooltip" data-bs-title="days of hectoday"}, but the vinculum in a [mid]{.tool data-bs-toggle="tooltip" data-bs-title="mixed integer day of year"} can can be used to emphasize one of these two options. If we want to categorize work and rest days based on weeks as in the Gregorian calendar instead of according to the last digit of [pid](#pid){.tool data-bs-toggle="tooltip" data-bs-title="positive integer days of year"} or countdown [mid](#mid){.tool data-bs-toggle="tooltip" data-bs-title="mixed integer days of year"}, we can use a "day of [era](https://en.wikipedia.org/wiki/Calendar_era#:~:text=the%20period%20of%20time%20elapsed%20since%20one%20epoch%20of%20a%20calendar)" ([doe](#doe){.tool data-bs-toggle="tooltip" data-bs-title="day of era"}) to calculate a [dow]{.tool data-bs-toggle="tooltip" data-bs-title="days of week"}. 
