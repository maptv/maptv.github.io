...
$$\text{coe} = \biggl \lfloor \frac{\text{yoe}-399\ast[\text{yoe} \geq 0]}{400} \biggr \rfloor$$ {#eq-yoe2coe}
...
$$\text{coe} = \left \lfloor \frac{\text{doe}-146096\ast[\text{doe} \geq 0]}{146097} \right \rfloor$$ {#eq-doe2coe}
...
To convert a [doy]{.tool data-bs-toggle="tooltip" data-bs-title="day of year"} to or from a [POSIX month](https://pubs.opengroup.org/onlinepubs/007904875/utilities/date.html#:~:text=Month%20as%20a%20decimal%20number%20%5B01%2C12%5D) and [dom]{.tool data-bs-toggle="tooltip" data-bs-title="day of month"}, we can use parts of [Howard Hinnant](https://howardhinnant.github.io)'s [`civil_from_days`](https://howardhinnant.github.io/date_algorithms.html#civil_from_days){.mono .under} and [`days_from_civil`](https://howardhinnant.github.io/date_algorithms.html#days_from_civil){.mono .under} algorithms -@hinnant2021date. Unlike POSIX months, [moy]{.tool data-bs-toggle="tooltip" data-bs-title="months of year"} are zero-based and start from [Moy]{.tool data-bs-toggle="tooltip" data-bs-title="month of year"} [0]{.color0} instead of [Moy]{.tool data-bs-toggle="tooltip" data-bs-title="month of year"} [10]{.color5by6}. We can obtain a [moy]{.tool data-bs-toggle="tooltip" data-bs-title="month of year"} from a [doy]{.tool data-bs-toggle="tooltip" data-bs-title="day of year"} using @eq-pid2moy or from a POSIX month number using @eq-month2moy.

:::{.overflowequation}
$$\text{moy} = \lfloor(\text{pid} \ast 5 + 2) \div 153\rfloor$$ {#eq-pid2moy}

$$\text{month} = (\text{moy} + 3) \bmod  12$$ {#eq-moy2month}

$$\text{bom} = \lfloor (\text{moy} \times 153 + 2) \div 5 \rfloor - 1$$ {#eq-moy2bom}

$$\text{dom} = \text{pid} - \text{bom}$$ {#eq-dom}

$$\text{moy} = (\text{month} + 9) \bmod 12$$ {#eq-month2moy}

$$\text{pid} = \text{bom} + \text{dom}$$ {#eq-bomdomsum}
:::

POSIX months and [moy]{.tool data-bs-toggle="tooltip" data-bs-title="months of year"} are shifted in relation to each other because the Dec epoch, [0000]{.color0}+[000]{.color0}, is 2 months later than the Gregorian calendar epoch: -[0001]{.color99by100}+[306]{.color306by365}. To convert years, we add 1 to the [yoe]{.tool data-bs-toggle="tooltip" data-bs-title="year of era"} or subtract 1 from the Gregorian calendar️ "common era year" ([cey]{.tool data-bs-toggle="tooltip" data-bs-title="common era year"}) if the [doy]{.tool data-bs-toggle="tooltip" data-bs-title="day of year"} is greater than 305, the [moy]{.tool data-bs-toggle="tooltip" data-bs-title="month of year"} is greater than 9, or the POSIX month is less than 3.

:::{.overflowequation}
$$\text{cey} = \text{yoe}+[\text{doy}\gt 305\href{https://en.wikipedia.org/wiki/Logical_disjunction}{\lor}\text{moy}\gt 9\href{https://en.wikipedia.org/wiki/Logical_disjunction}{\lor}\text{month}\lt 3]$$ {#eq-cey}
:::

# Summary {.unnumbered #tldr}

This article compares and contrasts the Dec and Gregorian calendars. Dec renders the Gregorian calendar [obsolete](https://en.wikipedia.org/wiki/Obsolescence#:~:text=antiquated%2C%20out%20of%20date%2C%20old%2Dfashioned%2C%20no%20longer%20in%20general%20use%2C%20no%20longer%20useful%2C%20or%20superseded) with time units that supersede both months and weeks, but can nevertheless facilitate the use of weeks by expanding [pid]{.tool data-bs-toggle="tooltip" data-bs-title="positive integer days of year"} into [bow]{.tool data-bs-toggle="tooltip" data-bs-title="beginnings of week"}+[dow]{.tool data-bs-toggle="tooltip" data-bs-title="days of week"}. The only standardized equivalent to a [bow]{.tool data-bs-toggle="tooltip" data-bs-title="beginning of week"}+[dow]{.tool data-bs-toggle="tooltip" data-bs-title="day of week"} is an [RFC 7231](https://datatracker.ietf.org/doc/html/rfc7231#section-7.1.1.1:~:text=preferred%20format%20is-,Sun%2C%2006%20Nov,-1994%2008%3A49) date truncated to 11 characters: \${loadStr} = [\${dotw0doty}+\${dotw}]{.nowrap}.

While [bow]{.tool data-bs-toggle="tooltip" data-bs-title="beginnings of week"}+[dow]{.tool data-bs-toggle="tooltip" data-bs-title="days of week"} are math expressions that evaluate to [pid]{.tool data-bs-toggle="tooltip" data-bs-title="positive integer days of year"}, RFC 7231 dates are character strings that insert [dom]{.tool data-bs-toggle="tooltip" data-bs-title="day of month"} numbers in between  abbreviated month and [dow]{.tool data-bs-toggle="tooltip" data-bs-title="days of week"} names. Unlike names and abbreviations, the math notation that underlies Dec dates is universal. In contrast, the symbols in [RFC 9557](https://www.rfc-editor.org/info/rfc9557/#name-optional-generation-and-ele:~:text=such%20as%3A%C2%B6-,2022%2D07%2D08T00,-%3A14%3A07%2B01) dates are unrelated to math operators:  \${loadIso} = \${decYear}+\${decDotyPad}.

The order in Dec dates and times is always from largest to smallest unit but this pattern is reversed in RFC 7231 dates and then broken when we include  with numbers in an order that differs by locale:

that is preceeded by a [bow]{.tool data-bs-toggle="tooltip" data-bs-title="beginning of week"} or [woy]{.tool data-bs-toggle="tooltip" data-bs-title="week of year"} followed by a . and [dow]{.tool data-bs-toggle="tooltip" data-bs-title="day of week"}. [bom]{.tool data-bs-toggle="tooltip" data-bs-title="beginnings of month"} and weeks in the form of . Even though Dec [x](#x){.tool data-bs-toggle="tooltip" data-bs-title="groups of ten days"} supersede months and weeks, Dec provides better support for weekly planning with . the Gregorian calendar ever could. by expanding the [pid]{.tool data-bs-toggle="tooltip" data-bs-title="positive integer day of year"} in Dec dates to display . Without any expansion, [pid]{.tool data-bs-toggle="tooltip" data-bs-title="positive integer day of year"} display [h](#h){.tool data-bs-toggle="tooltip" data-bs-title="group of one hundred days"}, [doh](#doh){.tool data-bs-toggle="tooltip" data-bs-title="days of hectoday"}, [x](#x){.tool data-bs-toggle="tooltip" data-bs-title="groups of ten days"}, and [dox](#dox){.tool data-bs-toggle="tooltip" data-bs-title="days of xún"}.

Even though the Gregorian calendar . Nevertheless,
using [bom]{.tool data-bs-toggle="tooltip" data-bs-title="beginnings of month"} and weeks using either [bow]{.tool data-bs-toggle="tooltip" data-bs-title="beginnings of week"} or [woy]{.tool data-bs-toggle="tooltip" data-bs-title="weeks of year"}.
