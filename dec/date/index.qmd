...
flowchart LR
   ...
   style decalendar y:110px,x:190px,width:270px,height:140px;
...
alternate form called  T plus (T+), T minus (T-), The `date` function creates Dec dates using part of an elegant algorithm in the [`civil_from_days`](https://howardhinnant.github.io/date_algorithms.html#civil_from_days) function from the [`date` library](https://howardhinnant.github.io/date/date.html) developed by [Howard Hinnant](https://howardhinnant.github.io). Dec uses the full algorithm in the `isom` function that is described in the [month](#month) section of this article.
...
<style>
   #decalendar > g.cluster-label {
     transform: translate(305px, 110px) !important;
   }
   span.cal-swatch {
