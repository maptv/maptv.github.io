...
POSIX months and [moy]{.tool data-bs-toggle="tooltip" data-bs-title="months of year"} are shifted in relation to each other because the Dec epoch, [0000]{.color0}+[000]{.color0}, is 2 months later than the Gregorian calendar epoch: -[0001]{.color99by100}+[306]{.color306by365}. To convert years, we add 1 to the [yoe]{.tool data-bs-toggle="tooltip" data-bs-title="year of era"} or subtract 1 from the Gregorian calendar️ "common era year" ([cey]{.tool data-bs-toggle="tooltip" data-bs-title="common era year"}) if the [pid]{.tool data-bs-toggle="tooltip" data-bs-title="positive integer day of year"} is greater than 305, the [moy]{.tool data-bs-toggle="tooltip" data-bs-title="month of year"} is greater than 9, or the POSIX month is less than 3.
...
A similar adjustment in needed when dealing with a UTC time zone that has a negative offset. Dec does not permit "time zone offsets" ([tzo]{.tool data-bs-toggle="tooltip" data-bs-title="time zone offsets"}) to be negative and therefore adds one day to every negative [tzo]{.tool data-bs-toggle="tooltip" data-bs-title="time zone offset"}. @eq-moy2bom takes into account the possibility of a negative UTC offset and adjusts the [bom]{.tool data-bs-toggle="tooltip" data-bs-title="beginning of month"} accordingly. The images below show every possible adjusted [bom]{.tool data-bs-toggle="tooltip" data-bs-title="beginning of month"}.
...
The adjusted [bom]{.tool data-bs-toggle="tooltip" data-bs-title="beginnings of month"} in the images above are exactly the same as the values in the rightmost column of the first table under the heading "[Computing day-of-year from month and day-of-month](https://howardhinnant.github.io/date_algorithms.html#Computing%20day-of-year%20from%20month%20and%20day-of-month)" in [[`chrono`]{.mono .under}-Compatible Low-Level Date Algorithms](https://howardhinnant.github.io/date_algorithms.html) [@hinnant2021date]. Dec stores dates as a [pid]{.tool data-bs-toggle="tooltip" data-bs-title="positive integer days of year"} with or without a [yoe]{.tool data-bs-toggle="tooltip" data-bs-title="year of era"} and generates other values only if required.

When provided with a month and [dom]{.tool data-bs-toggle="tooltip" data-bs-title="day of month"}, Dec converts the input to a [pid]{.tool data-bs-toggle="tooltip" data-bs-title="positive integer days of year"} and then discards the input along with the [bom]{.tool data-bs-toggle="tooltip" data-bs-title="beginnings of month"} that was created during the conversion. Whereas a month and [dom]{.tool data-bs-toggle="tooltip" data-bs-title="day of month"} can be converted to or obtained from a [pid]{.tool data-bs-toggle="tooltip" data-bs-title="positive integer days of year"}, generating a [dow]{.tool data-bs-toggle="tooltip" data-bs-title="day of week"} also requires a [yoe]{.tool data-bs-toggle="tooltip" data-bs-title="year of era"}. The [yoe]{.tool data-bs-toggle="tooltip" data-bs-title="year of era"} and [pid]{.tool data-bs-toggle="tooltip" data-bs-title="positive integer days of year"} are first converted into a [doe]{.tool data-bs-toggle="tooltip" data-bs-title="day of era"} and then a [dow]{.tool data-bs-toggle="tooltip" data-bs-title="day of week"} as shown in @fig-conv below.
...
@fig-conv above visualizes the conversion of the UNIX epoch Dec date [1969]{.color069}+[306]{.colord306} into the equivalent Gregorian calendar️ [cey]{.tool data-bs-toggle="tooltip" data-bs-title="common era year"}, month, [dom]{.tool data-bs-toggle="tooltip" data-bs-title="day of month"}, and [dow]{.tool data-bs-toggle="tooltip" data-bs-title="day of week"}. To obtain its associated [dow]{.tool data-bs-toggle="tooltip" data-bs-title="day of week"}, we first need to convert a Dec date into a [doe]{.tool data-bs-toggle="tooltip" data-bs-title="day of era"}. Apart from calculating [dow]{.tool data-bs-toggle="tooltip" data-bs-title="days of week"}, Dec uses [doe]{.tool data-bs-toggle="tooltip" data-bs-title="days of era"} for date arithmetic like finding the number of days in between a minuend date and a subtrahend date.

For simplicity, @fig-conv does not show conversion byproducts, such as the [coe]{.under .tool data-bs-toggle="tooltip" data-bs-title="cycle of era"}, [yoc]{.tool data-bs-toggle="tooltip" data-bs-title="year of cycle"}, and [doc]{.tool data-bs-toggle="tooltip" data-bs-title="day of cycle"} needed to convert between [doe]{.tool data-bs-toggle="tooltip" data-bs-title="day of era"} and Dec dates or the [moy]{.tool data-bs-toggle="tooltip" data-bs-title="months of year"} required to either split a [doy]{.tool data-bs-toggle="tooltip" data-bs-title="day of year"} into a month and a [dom]{.tool data-bs-toggle="tooltip" data-bs-title="day of month"} or combine a month and a [dom]{.tool data-bs-toggle="tooltip" data-bs-title="day of month"} into a [doy]{.tool data-bs-toggle="tooltip" data-bs-title="day of year"}. The arrows in @fig-conv represent equations adapted from [[`chrono`]{.mono .under}-Compatible Low-Level Date Algorithms](https://howardhinnant.github.io/date_algorithms.html) -@hinnant2021date.
