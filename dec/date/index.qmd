...
We can refer to the last day of a common year as d364 or Day -1 (d[1]{.overline}): $364 \bmod 365 = -1 \bmod 365$. Similarly, the last day of a leap year can be referred to as d365 or d[1]{.overline}: $365 \bmod 366 = -1 \bmod 366$.  Another way to write d[1]{.overline} is Day -1[9]{.overline}: -1 = -(10 -- 9). This alternative form, which is called the decacomplement, can be read as Xún -1 (x[1]{.overline}) [Dox]{.tool data-bs-toggle="tooltip" data-bs-title="days of xún"} 9, which is the last [dox]{.tool data-bs-toggle="tooltip" data-bs-title="days of xún"} of the last "negative integer xún" ([nix]{.tool data-bs-toggle="tooltip" data-bs-title="negative integer xún"}) of the year. In common years, "positive integer xún" ([pix]{.tool data-bs-toggle="tooltip" data-bs-title="positive integer xún"}) and [nix]{.tool data-bs-toggle="tooltip" data-bs-title="negative integer xún"} have the same pattern of Schedule [L]{.tool data-bs-toggle="tooltip" data-bs-title="duotrigesimal L is decimal 14 or binary 01110"} work and rest days.

In a leap year, the Schedule [L]{.tool data-bs-toggle="tooltip" data-bs-title="duotrigesimal L is decimal 14 or binary 01110"} rest days are [Dox]{.tool data-bs-toggle="tooltip" data-bs-title="days of xún"} 0, 4, 5, and 9 in [pix]{.tool data-bs-toggle="tooltip" data-bs-title="positive integer xún"} and [Dox]{.tool data-bs-toggle="tooltip" data-bs-title="days of xún"} 3, 4, 8, and 9 in [nix]{.tool data-bs-toggle="tooltip" data-bs-title="negative integer xún"}. Essentially, any schedule we see in a [pix]{.tool data-bs-toggle="tooltip" data-bs-title="positive integer xún"} will appear [rotated](https://en.wikipedia.org/wiki/Circular_shift#:~:text=moving%20the%20final%20entry%20to%20the%20first%20position%2C%20while%20shifting%20all%20other%20entries%20to%20the%20next%20position%2C%20or%20by%20performing%20the%20inverse%20operation) to the left by one position in [nix]{.tool data-bs-toggle="tooltip" data-bs-title="negative integer xún"} during leap years. The result of rotating Schedule [L]{.tool data-bs-toggle="tooltip" data-bs-title="duotrigesimal L is decimal 14 or binary 01110"} to the left by one position is Schedule [X]{.tool data-bs-toggle="tooltip" data-bs-title="duotrigesimal X is decimal 28 or binary 11100"}: [L]{.tool data-bs-toggle="tooltip" data-bs-title="duotrigesimal L is decimal 14 or binary 01110"} ↺ 1 = [X]{.tool data-bs-toggle="tooltip" data-bs-title="duotrigesimal X is decimal 28 or binary 11100"}. of d365 shifts 5432109876 we can follow a common year, an [nid]{.tool data-bs-toggle="tooltip" data-bs-title="negative integer day of year"} is   if the sum of its last digit and 10 is a Schedule [L]{.tool data-bs-toggle="tooltip" data-bs-title="duotrigesimal L is decimal 14 or binary 01110"} rest day. , 4, 5, or 9 and a work day otherwise.

-264 = -270 + 6 = -26[6]{.overline}

In a common year, with negative dox. changing the pattern of work and rest days. we can subtract 10 from a dox to get the last digit of a pid to get  from positive to negative dox. @fig-nidcomm below shows Schedule [L]{.tool data-bs-toggle="tooltip" data-bs-title="duotrigesimal L is decimal 14 or binary 01110"} with negative dox in a common year. an overline () denotes a negative numbers. symbolizes and thus turn Dox 0 to -10, 1 to -9, 2 to -8, 3 to -7, -4, -3, and -2.  and Dop -3, -2, -1 in a leap year. If we want to use [nid]{.tool data-bs-toggle="tooltip" data-bs-title="negative integer day of year"} to identify work and rest days. depends on the

::: {#fig-nidcomm .doxdiagram}
```{mermaid}
%%{init: {'theme': 'default', 'themeVariables': { 'fontSize': '29px'}}}%%
flowchart LR
  B~~~M[ ]:::empty----N[ ]:::empty
  ...
  N---O[ ]:::empty
  Q[ ]:::empty---L
  W[ ]:::empty-->A[5]-->B[4]-->C[3]-->D[2]-->E[1]---L[ ]:::empty
  Y[ ]:::empty-->F[10]-->G[9]-->H[8]-->I[7]-->J[6]---O[ ]:::empty
  B~~~P[ ]:::empty---Q
  Y---P
  subgraph workdays[work]
  B
  ...
  classDef empty width:0px;
  class A,B,C,D,E,F,G,H,I,J overline;
```
