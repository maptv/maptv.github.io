...
An [nih](#nih){.tool data-bs-toggle="tooltip" data-bs-title="negative integer hectoday"} [mid]{.tool data-bs-toggle="tooltip" data-bs-title="mixed integer day of year"}, [\${decNih}]{.overline}\${decDohNidMidPadColor}, shows the current [nih](#nih){.tool data-bs-toggle="tooltip" data-bs-title="negative integer hectoday"} with its first digit: [\${decNih}]{.overline}, a [doh](#doh){.tool data-bs-toggle="tooltip" data-bs-title="days of hectoday"} with its last two digits: \${decDohNidMidPadColor1}, an [nih](#nih){.tool data-bs-toggle="tooltip" data-bs-title="negative integer hectoday"} "mixed integer xún" ([mix](#mix){.tool data-bs-toggle="tooltip" data-bs-title="mixed integer xún"}) with its first two digits: [\${decNih}]{.overline}\${decDohNidMidPad0}, and a [dox](#dox){.tool data-bs-toggle="tooltip" data-bs-title="days of xún"} with its final digit: \${decDoxNidMid}. During [h]{.tool data-bs-toggle="tooltip" data-bs-title="group of one hundred days"}[1]{.overline .color265by365}, Dec recommends using [nih](#nih){.tool data-bs-toggle="tooltip" data-bs-title="negative integer hectoday"} [mid]{.tool data-bs-toggle="tooltip" data-bs-title="mixed integer day of year"} in lieu of [pid]{.tool data-bs-toggle="tooltip" data-bs-title="positive integer day of year"} for personal timekeeping because [nih](#nih){.tool data-bs-toggle="tooltip" data-bs-title="negative integer hectodays"} [mid]{.tool data-bs-toggle="tooltip" data-bs-title="mixed integer day of year"} take into account the [syl]{.tool data-bs-toggle="tooltip" data-bs-title="solar year length"} and thus avoid any uncertainty regarding the [eoy](#eoy){.tool data-bs-toggle="tooltip" data-bs-title="end of year"}.

Conversion of a [nih](#nih){.tool data-bs-toggle="tooltip" data-bs-title="negative integer hectoday"} [mix](#mix){.tool data-bs-toggle="tooltip" data-bs-title="mixed integer xún"} to a [nix](#nix){.tool data-bs-toggle="tooltip" data-bs-title="negative integer xún"} only requires simple arithmetic: [\${decNih}]{.overline}\${decDohNidMidPad0} = -\${decNih}0 + \${decDohNidMidPad0} = [\${decNix}]{.overline}. If we then append a [dox](#dox){.tool data-bs-toggle="tooltip" data-bs-title="days of xún"}, we get a [nix](#nix){.tool data-bs-toggle="tooltip" data-bs-title="negative integer xún"} [mid]{.tool data-bs-toggle="tooltip" data-bs-title="mixed integer day of year"} like those in @tbl-vincommon: [\${decNix}]{.overline}\${decDoxNidMid}. During a leap year, we should put a grave accent above the [dox](#dox){.tool data-bs-toggle="tooltip" data-bs-title="days of xún"} in [nih](#nih){.tool data-bs-toggle="tooltip" data-bs-title="negative integer hectoday"} and [nix](#nix){.tool data-bs-toggle="tooltip" data-bs-title="negative integer xún"} [mid]{.tool data-bs-toggle="tooltip" data-bs-title="mixed integer days of year"} as in @tbl-vinculeap to facilitate identification of work and rest days according to a Dec schedule like Schedule [L]{.color14by32 .tool data-bs-toggle="tooltip" data-bs-title="duotrigesimal L is decimal 14 or binary 01110"}: [\${decNihGrave}]{.overline}\${decDohGrave0}[\${decDohGrave1}]{.grave} = [\${decNixGrave}]{.overline}[\${decDoxGrave}]{.grave} = [\${decNih}]{.overline}\${decDohNidMidPadColor2} = [\${decNix}]{.overline}\${decDoxNidMid}.
