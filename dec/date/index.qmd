...
In a common year, the [ni[d]{.acute}]{.tool data-bs-toggle="tooltip" data-bs-title="negative integer day of year"} and [pid]{.tool data-bs-toggle="tooltip" data-bs-title="positive integer days of year"} run antiparallel to each other like complementary strands of [deoxyribonucleic acid](https://en.wikipedia.org/wiki/DNA#:~:text=a%20polymer%20composed%20of%20two%20polynucleotide%20chains%20that%20coil%20around%20each%20other%20to%20form%20a%20double%20helix)🧬, but instead of [adenine](https://en.wikipedia.org/wiki/Adenine#:~:text=a%20purine%20nucleotide%20base%20that%20is%20found%20in%20DNA) bound to [thymine](https://en.wikipedia.org/wiki/Thymine#:~:text=one%20of%20the%20four%20nucleotide%20bases%20in%20the%20nucleic%20acid%20of%20DNA) and [cytosine](https://en.wikipedia.org/wiki/Cytosine#:~:text=one%20of%20the%20four%20nucleotide%20bases%20found%20in%20DNA) bound to [guanine](https://en.wikipedia.org/wiki/Guanine#:~:text=one%20of%20the%20four%20main%20nucleotide%20bases), the correspondence is 0 to [4]{.acute}, 1 to [3]{.acute}, 2 to [2]{.acute}, 3 to [1]{.acute}, and so on. Similarly, there are two sets of overlapping [x]{.tool data-bs-toggle="tooltip" data-bs-title="groups of ten days"}; [x]{.tool data-bs-toggle="tooltip" data-bs-title="groups of ten days"}0 to [x]{.tool data-bs-toggle="tooltip" data-bs-title="groups of ten days"}36 are "positive integer xún" ([pix]{.tool data-bs-toggle="tooltip" data-bs-title="positive integer xún"}) and [x]{.tool data-bs-toggle="tooltip" data-bs-title="groups of ten days"}[37]{.overline} or [x]{.tool data-bs-toggle="tooltip" data-bs-title="groups of ten days"}[4]{.overline}3 to [x]{.tool data-bs-toggle="tooltip" data-bs-title="groups of ten days"}[1]{.overline} or [x]{.tool data-bs-toggle="tooltip" data-bs-title="groups of ten days"}[1]{.overline}9 are equivalently "negative integer xún" ([nix]{.tool data-bs-toggle="tooltip" data-bs-title="negative integer xún"}) or "mixed integer xún" ([mix]{.tool data-bs-toggle="tooltip" data-bs-title="mixed integer xún"}).
...
The Schedule [L]{.tool data-bs-toggle="tooltip" data-bs-title="duotrigesimal L is decimal 14 or binary 01110"} rule for categorization of work and rest days can be summarized as [[mid]{.tool data-bs-toggle="tooltip" data-bs-title="mixed integer day of year"} [mod](https://en.wikipedia.org/wiki/Modulo#:~:text=returns%20the%20remainder) 5 ∈ {1,2,3}] or [[ni[d]{.acute}]{.tool data-bs-toggle="tooltip" data-bs-title="mixed integer day of year"} [mod](https://en.wikipedia.org/wiki/Modulo#:~:text=returns%20the%20remainder) 5 ∈ {1,2,3}] in common years, [mi[d]{.grave}]{.tool data-bs-toggle="tooltip" data-bs-title="next mixed integer day of year"} [mod](https://en.wikipedia.org/wiki/Modulo#:~:text=returns%20the%20remainder) 5 ∈ {1,2,3}] or [[ni[d]{.doubleacute}]{.tool data-bs-toggle="tooltip" data-bs-title="mixed integer day of year"} [mod](https://en.wikipedia.org/wiki/Modulo#:~:text=returns%20the%20remainder) 5 ∈ {1,2,3}] in leap years, or [[pid]{.tool data-bs-toggle="tooltip" data-bs-title="positive integer days of year"} [mod](https://en.wikipedia.org/wiki/Modulo#:~:text=returns%20the%20remainder) 5 ∈ {1,2,3}] in all years. 



We can apply the same work and rest day categorization rule to the last digit of a [mid]{.tool data-bs-toggle="tooltip" data-bs-title="mixed integer day of year"} in a common year, a [mi[d]{.grave}]{.tool data-bs-toggle="tooltip" data-bs-title="next mixed integer day of year"} in a leap year, or a [pid]{.tool data-bs-toggle="tooltip" data-bs-title="positive integer days of year"} in any year and always. and we can look at  in a common year is [37]{.overline}5 to [1]{.overline}9. In a leap year, Negative and positive digits in a mixed integer cannot fully cancel
...
In a leap year, the Schedule [L]{.tool data-bs-toggle="tooltip" data-bs-title="duotrigesimal L is decimal 14 or binary 01110"} rest days are [Dox]{.tool data-bs-toggle="tooltip" data-bs-title="days of xún"} 0, 4, 5, and 9 in [pix]{.tool data-bs-toggle="tooltip" data-bs-title="positive integer xún"} and [Dox]{.tool data-bs-toggle="tooltip" data-bs-title="days of xún"} 3, 4, 8, and 9 in [nix]{.tool data-bs-toggle="tooltip" data-bs-title="negative integer xún"}. Essentially, any schedule we see in a [pix]{.tool data-bs-toggle="tooltip" data-bs-title="positive integer xún"} will appear rotated to the left by one position in [nix]{.tool data-bs-toggle="tooltip" data-bs-title="negative integer xún"} during leap years. The result of rotating Schedule [L]{.tool data-bs-toggle="tooltip" data-bs-title="duotrigesimal L is decimal 14 or binary 01110"} to the left by one position is Schedule [X]{.tool data-bs-toggle="tooltip" data-bs-title="duotrigesimal X is decimal 28 or binary 11100"}: [L]{.tool data-bs-toggle="tooltip" data-bs-title="duotrigesimal L is decimal 14 or binary 01110"} ↺ 1 = [X]{.tool data-bs-toggle="tooltip" data-bs-title="duotrigesimal X is decimal 28 or binary 11100"}. of d365 shifts 5432109876 we can follow a common year, a [nid]{.tool data-bs-toggle="tooltip" data-bs-title="negative integer day of year"} is   if the sum of its last digit and 10 is a Schedule [L]{.tool data-bs-toggle="tooltip" data-bs-title="duotrigesimal L is decimal 14 or binary 01110"} rest day. , 4, 5, or 9 and a work day otherwise.
...
The remainder after dividing a [pid]{.tool data-bs-toggle="tooltip" data-bs-title="positive integer day of year"} or a [nid]{.tool data-bs-toggle="tooltip" data-bs-title="negative integer day of year"} by 100 is a "day of hectoday" ([doh](#doh){#dayofhectoday .tool data-bs-toggle="tooltip" data-bs-title="day of hectoday"}). If we use a [pid]{.tool data-bs-toggle="tooltip" data-bs-title="positive integer day of year"}, the resulting [doh](#doh){#dayofhectoday .tool data-bs-toggle="tooltip" data-bs-title="day of hectoday"} is the percent of a [pih]{.tool data-bs-toggle="tooltip" data-bs-title="positive integer hectoday"} that has passed. A [doh](#doh){#dayofhectoday .tool data-bs-toggle="tooltip" data-bs-title="day of hectoday"} derived from a [nid]{.tool data-bs-toggle="tooltip" data-bs-title="negative integer day of year"} is the percent of a [nih]{.tool data-bs-toggle="tooltip" data-bs-title="negative integer hectoday"} that is still has not passed. The current [pid]{.tool data-bs-toggle="tooltip" data-bs-title="positive integer day of year"}, \${decDoty}, tells us that [h]{.tool data-bs-toggle="tooltip" data-bs-title="groups of one hundred days"}\${decPih} is \${decDohPid}% done and based on the current [nid]{.tool data-bs-toggle="tooltip" data-bs-title="negative integer day of year"}, \${decNid}, we know that [h]{.tool data-bs-toggle="tooltip" data-bs-title="groups of one hundred days"}[\${decNih}]{.overline} is \${decDohNid}% unfinished.
