...
Apart from calculations, dotes can be useful for storing dates as a single number. Dotes allow us to the see the transition between days but not the transition between years.
