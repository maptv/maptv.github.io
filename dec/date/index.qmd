...
My website serves as a demonstration of both the [Quarto](https://quarto.org) publishing📤system and the [Dec](/dec) measurement📐system. I use several clever hacks to get Quarto to display all of the dates on my website in the Dec year+day format. Knowing the basics of the Dec calendar🗓️(Decalendar) will help you to understand the [filter](https://quarto.org/docs/extensions/filters.html), [include](https://quarto.org/docs/output-formats/html-basics.html#includes), and [script](https://quarto.org/docs/projects/scripts.html) articles in the [Quarto section](/quarto) of my site.
...
A dek and [dod]{.tool data-bs-toggle="tooltip" data-bs-title="day of dek"} can be combined into a single integer called a "day of year" ([doy]{.tool data-bs-toggle="tooltip" data-bs-title="day of year"}). Every cell value in the Decalendar plot is a [doy]{.tool data-bs-toggle="tooltip" data-bs-title="day of year"}. The [doy]{.tool data-bs-toggle="tooltip" data-bs-title="day of year"} chosen by the range🎚️inputs to be highlighted with a red🟥background in the plots is \${dotyInput}. You can use the range🎚️inputs to convert a month and a [dom]{.tool data-bs-toggle="tooltip" data-bs-title="day of month"} into a [doy]{.tool data-bs-toggle="tooltip" data-bs-title="day of year"}. Try converting a special date such as your birthday🎂 or anniversary💍!

There are two range🎚️inputs labeled🏷️as "day of year" because every [doy]{.tool data-bs-toggle="tooltip" data-bs-title="day of year"} can be expressed as both a positive and a negative number. The typical range for [doys]{.tool data-bs-toggle="tooltip" data-bs-title="days of year"} is 0 to n[-]{.mono}1, but negative [doys]{.tool data-bs-toggle="tooltip" data-bs-title="days of year"} typically range from -n to -1, where n is the number of days in the year, either 365 or 366. A [doy]{.tool data-bs-toggle="tooltip" data-bs-title="day of year"} outside these [bounds](https://en.wikipedia.org/wiki/Upper_and_lower_bounds#:~:text=an%20upper%20bound%20or%20majorant%5B1%5D%20of%20a%20subset%20S%20of%20some%20preordered%20set%20(K%2C%20%E2%89%A4)%20is%20an%20element%20of%20K%20that%20is%20greater%20than%20or%20equal%20to%20every%20element%20of%20S.%5B2%5D%5B3%5D%20Dually%2C%20a%20lower%20bound%20or%20minorant%20of%20S%20is%20defined%20to%20be%20an%20element%20of%20K%20that%20is%20less%20than%20or%20equal%20to%20every%20element%20of%20S) represents a day in a previous or subsequent year.
...
Dec uses [does]{.tool data-bs-toggle="tooltip" data-bs-title="days of era"} for calculations, such as finding the [POSIX](https://en.wikipedia.org/wiki/POSIX#:~:text=a%20family%20of%20standards%20specified%20by%20the%20IEEE%20Computer%20Society%20for%20maintaining%20compatibility%20between%20operating%20systems) [zero-based [dow]{.tool data-bs-toggle="tooltip" data-bs-title="day of week"}](https://pubs.opengroup.org/onlinepubs/007904875/utilities/date.html#:~:text=weekday%20as%20a%20decimal%20number%20%5B0%2C6%5D%20(0%3Dsunday)) of a given date. This year, the [dow]{.tool data-bs-toggle="tooltip" data-bs-title="day of week"} of [Christmas](https://en.wikipedia.org/wiki/Christmas#:~:text=annual%20festival%20commemorating%20the%20birth%20of%20Jesus%20Christ)🎄is \${xmasDotw} according to the Dec [dow]{.tool data-bs-toggle="tooltip" data-bs-title="day of week"} equation: (\${xmasDote} + 3) [mod](https://en.wikipedia.org/wiki/Modulo#:~:text=returns%20the%20remainder) 7 = \${xmasDotw}. As opposed to the [dow]{.tool data-bs-toggle="tooltip" data-bs-title="day of week"}, the [dod]{.tool data-bs-toggle="tooltip" data-bs-title="day of dek"} is simply the last digit of its [doy]{.tool data-bs-toggle="tooltip" data-bs-title="day of year"}. Using the equations below, we can combine a dek and [dod]{.tool data-bs-toggle="tooltip" data-bs-title="day of dek"} into a [doy]{.tool data-bs-toggle="tooltip" data-bs-title="day of year"} or split a [doy]{.tool data-bs-toggle="tooltip" data-bs-title="day of year"} into a dek and [dod]{.tool data-bs-toggle="tooltip" data-bs-title="day of dek"}.
...
Dates generated by the Dec date equations are guaranteed to be in the standard [yoe]{.tool data-bs-toggle="tooltip" data-bs-title="year of era"}+[doy]{.tool data-bs-toggle="tooltip" data-bs-title="day of year"} format. Therefore, we can standardize Dec dates by performing a [round-trip](https://en.wikipedia.org/wiki/Round-trip_format_conversion#:~:text=converting%20from%20any%20data%20representation%20and%20back%20again) "date to [doe]{.tool data-bs-toggle="tooltip" data-bs-title="day of era"} to date" conversion using the Dec [doe]{.tool data-bs-toggle="tooltip" data-bs-title="day of era"} and date equations consecutively. This allows Dec to handle dates that include a [doy]{.tool data-bs-toggle="tooltip" data-bs-title="day of year"} that is outside the typical range of 0 &le; [doy]{.tool data-bs-toggle="tooltip" data-bs-title="day of year"} &le; 365.

# Epochal year aggregate (eya){#eya}

A [doe]{.tool data-bs-toggle="tooltip" data-bs-title="day of era"} is essentially a Dec date with a [yoe]{.tool data-bs-toggle="tooltip" data-bs-title="year of era"} that is always equal to 0 and a [doy]{.tool data-bs-toggle="tooltip" data-bs-title="day of year"} that is [not restricted](https://en.wikipedia.org/wiki/Bounded_set#:~:text=a%20set%20which%20is%20not%20bounded) to 0 &le; [doy]{.tool data-bs-toggle="tooltip" data-bs-title="day of year"} &le; 365. Similarly, a Dec "epochal year aggregate" ([eya]{.tool data-bs-toggle="tooltip" data-bs-title="epochal year aggregate"}) is basically a Dec date with a non-integer year and a day permanently set to [0]{.color0}. Both [does]{.tool data-bs-toggle="tooltip" data-bs-title="days of era"} and [eyas]{.tool data-bs-toggle="tooltip" data-bs-title="epochal year aggregates"} allow us to represent a date as a single number and obtain the difference between two dates.

Compared to [does]{.tool data-bs-toggle="tooltip" data-bs-title="days of era"}, [eyas]{.tool data-bs-toggle="tooltip" data-bs-title="epochal year aggregates"} are easier to turn into Dec dates. We can convert dates to [eya]{.tool data-bs-toggle="tooltip" data-bs-title="epochal year aggregate"} and vice versa with the Dec [eya]{.tool data-bs-toggle="tooltip" data-bs-title="epochal year aggregate"} equation: [eya]{.tool data-bs-toggle="tooltip" data-bs-title="epochal year aggregate"} = [yoe]{.tool data-bs-toggle="tooltip" data-bs-title="year of era"} + [doy]{.tool data-bs-toggle="tooltip" data-bs-title="day of year"} &div; n, where n is the number of days in Year [yoe]{.tool data-bs-toggle="tooltip" data-bs-title="year of era"}. The current [eya]{.tool data-bs-toggle="tooltip" data-bs-title="epochal year aggregate"} equation values are \${fullfracYear} = \${decYear} + \${decDoty} &div; \${nDaysInYear}.

Dec dates do not include n, because it is not needed to specify a date, remains constant for 366, 1095, or 2920 days, has only 2 possible values: 366 if &LeftFloor;[y]{.yellow}&RightFloor;+1 is a Gregorian calendar🗓️leap [year]{.yellow} and 365 if &LeftFloor;[y]{.yellow}&RightFloor;+1 is a Gregorian calendar🗓️common [year]{.yellow}, and can be determined by applying the Gregorian calendar🗓️[leap [year]{.yellow} rule](https://en.wikipedia.org/wiki/Leap_year#:~:text=Every%20year%20that%20is%20exactly%20divisible%20by%20four%20is%20a%20leap%20year%2C%20except%20for%20years%20that%20are%20exactly%20divisible%20by%20100%2C%20but%20these%20centurial%20years%20are%20leap%20years%20if%20they%20are%20exactly%20divisible%20by%20400) to &LeftFloor;[y]{.yellow}&RightFloor;+1, as shown in the Dec [year]{.yellow} length equation:
