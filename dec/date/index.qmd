...
Unlike ISO 8601 dates, Dec dates can represent annual events such as anniversaries. Press the Play▶️button below to cycle🔄through every day of the year and its corresponding month and day of the month. You can also use the [range inputs](https://observablehq.com/documentation/inputs/overview#range) to select a special date like your birthday🎂!
