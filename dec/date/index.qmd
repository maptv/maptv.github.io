...
In Dec, a vinculum negates whatever is beneath it. Negating all of the digits of an integer flips its [sign](https://en.wikipedia.org/wiki/Sign_(mathematics)#:~:text=property%20of%20being%20either%20positive%2C%20negative%2C%20or%200). As demostrated by the [nid]{.tool data-bs-toggle="tooltip" data-bs-title="negative integer day of year"} and [nid]{.overline .tool data-bs-toggle="tooltip" data-bs-title="negative integer day of year"} columns of @tbl-vincommon, removing the [minus sign](https://en.wikipedia.org/wiki/Plus_and_minus_signs#Minus_sign:~:text=When%20it%20is%20placed%20immediately%20before%20an%20unsigned%20number%2C%20the%20combination%20names%20a%20negative%20number%2C%20the%20additive%20inverse%20of%20the%20positive%20number%20that%20the%20numeral%20would%20otherwise%20name) of a negative integer and putting a vinculum over all of its digits does not change its value. Using a vinculum, we can write Day -1, the last day of the Decalendar year, as [d]{.tool data-bs-toggle="tooltip" data-bs-title="day"}[1]{.overline} or [d]{.tool data-bs-toggle="tooltip" data-bs-title="day"}[1]{.overline}9.
...
The  [correlation](https://en.wikipedia.org/wiki/Correlation#:~:text=the%20extent%20to%20which%20a%20pair%20of%20quantities%20are%20linearly%20related) to the [absolute value](https://en.wikipedia.org/wiki/Absolute_value#:~:text=measured%20without%20regard%20to%20its%20sign) ([magnitude](https://en.wikipedia.org/wiki/Magnitude_(mathematics)#:~:text=The%20magnitude%20of,its%20absolute%20value)) of mixed integers is positive for positive digits and negative for negative digits.
The negative digit in the mid column of @tbl-vincommon pulls the magnitude of its mid towards one, meanwhile the positive digit moves the magnitude in the opposite directions along the [number line](https://en.wikipedia.org/wiki/Number_line#:~:text=spatial%20representation%20of%20numbers).
