...
First [dow]{.tool data-bs-toggle="tooltip" data-bs-title="day of week"} of the Gregorian calendar year
...
In contrast to a week, an [x]{.tool data-bs-toggle="tooltip" data-bs-title="groups of ten days"} can be split evenly into either five pairs of days or two equal halves called "pentadays of xún" ([pox]{.tool data-bs-toggle="tooltip" data-bs-title="pentadays of xún"}). Likewise, a common year can be divided evenly into 73 "pentadays of year" ([poy]{.tool data-bs-toggle="tooltip" data-bs-title="pentadays of year"}). The last [pentaday]{.tool data-bs-toggle="tooltip" data-bs-title="group of five days"} ([p](#p){#pentaday .tool data-bs-toggle="tooltip" data-bs-title="pentaday"}) of a leap year, [p]{.tool data-bs-toggle="tooltip" data-bs-title="pentaday"}73, consists of the final day of the leap year, [d]{.tool data-bs-toggle="tooltip" data-bs-title="day"}[365]{.color365by366}, and the first four days of the subsequent year: Days 0 to 3.
...
The approximate duration of a season in the Gregorian calendar is 3 months, 13 weeks, or 91 days. The connection between [pid](#pid){.tool data-bs-toggle="tooltip" data-bs-title="positive integer days of year"} and seasonal temperature changes requires [pid](#pid){.tool data-bs-toggle="tooltip" data-bs-title="positive integer days of year"} to reset after Day -1 (d[1]{.overline}), the last day of the year. If we do not need to track years or seasons, we can use a single integer called a "day of [era](https://en.wikipedia.org/wiki/Calendar_era#:~:text=the%20period%20of%20time%20elapsed%20since%20one%20epoch%20of%20a%20calendar)" ([doe]{.tool data-bs-toggle="tooltip" data-bs-title="day of era"}) instead of a Dec year+day date.
