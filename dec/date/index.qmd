...
In a tricennium, there are 180 bimesters and 11 leap days: 180 * 59 + 11 = 10631. A leap day occurs at the end of 12 or 18 bimesters according to the rules of the [Lunar Hijri Calendar](https://en.wikipedia.org/wiki/Islamic_calendar#:~:text=a%20lunar%20calendar%20consisting%20of%2012%20lunar%20months%20in%20a%20year%20of%20354%20or%20355%20days), which groups 29 days into short months, 30 days into short months, 354 days in short years, and 355 days into long months, but does not use bimesters or tricenniums.

One long month combined with one short month is one bimester: 30 + 29 = 59, one short year is six bimesters: 6 * 59 = 354, and one long year is six bimesters followed by one leap day: 6 * 59 + 1 = 355. All bimesters begin with [Dob]{.tool data-bs-toggle="tooltip" data-bs-title="day of bimester"} 0 and end with [Dob]{.tool data-bs-toggle="tooltip" data-bs-title="day of bimester"} 58. The [dob]{.tool data-bs-toggle="tooltip" data-bs-title="day of bimester"} is 58 on the day before a leap day, [0]{.grave} on a leap day, and 0 on the day after a leap day.

Within each bimester, we can expect a new moon on [Dob]{.tool data-bs-toggle="tooltip" data-bs-title="day of bimester"} 0 and 29, a first quarter moon on [Dob]{.tool data-bs-toggle="tooltip" data-bs-title="day of bimester"} 7 and 37, a full moon on [Dob]{.tool data-bs-toggle="tooltip" data-bs-title="day of bimester"} 15 and 44, and a last quarter on [Dob]{.tool data-bs-toggle="tooltip" data-bs-title="day of bimester"} 22 and 52, but these lunar phases are likely to begin about one day earlier as we approach a leap day. Use the range input beneath the moon plot below to shift the [dob]{.tool data-bs-toggle="tooltip" data-bs-title="day of bimester"} above each moon.
...
Plot.plot({
  ...
  y: {domain: d3.range(12).map(m => (m + 2) % 12)}, // month of year
  length: {type: "identity"}, // overloading meaning as lunar phase angle!
  marks: (({data, x, y, r, hemisphere, projection}) => [
    Plot.axisY({textAnchor: "start", tickFormat: (d, i) => moonNums[i], tickSize: 0, dx: -50, fontSize: 26}),
    Plot.dot(data, {x, y, r, fill: "#333"}),
    Plot.text(data, {x, y, r, text: (d) => unix2dob(d.getTime()), dy: -r - 9, fontSize: 19}),
    Plot.vector(data, {
      x,
      y,
      length(d) {
