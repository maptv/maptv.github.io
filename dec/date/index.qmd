...
flowchart LR
   ...
   style gregdate y:8px,height:592px;
   style decdate height:592px;
   click A "#doe"
   click B "#dow"
   click D "#yoe"
   click E "#doy"
...
For simplicity, the flowchart above only shows the conversion of a Dec year into a Gregorian calendar🗓️year and not the inverse. Also not shown are the conversion byproducts that are only used as stepping stones: [coes]{.under .tool data-bs-toggle="tooltip" data-bs-title="cycles-of-era"}, [yocs]{.under .tool data-bs-toggle="tooltip" data-bs-title="years-of-cycle"}, [docs]{.under .tool data-bs-toggle="tooltip" data-bs-title="days-of-cycle"}, and [moys]{.under .tool data-bs-toggle="tooltip" data-bs-title="months-of-year"}. Of these byproducts, [moys]{.under .tool data-bs-toggle="tooltip" data-bs-title="months-of-year"} are only used to split [doys]{.under .tool data-bs-toggle="tooltip" data-bs-title="days-of-year"} into months and [doms]{.under .tool data-bs-toggle="tooltip" data-bs-title="days-of-month"} or combine months and [doms]{.under .tool data-bs-toggle="tooltip" data-bs-title="days-of-month"} into [doys]{.under .tool data-bs-toggle="tooltip" data-bs-title="days-of-year"}.

Without the burden of supporting the Gregorian calendar🗓️, Decalendar can be free of weeks, [woys]{.under .tool data-bs-toggle="tooltip" data-bs-title="weeks-of-year"}, [dows]{.under .tool data-bs-toggle="tooltip" data-bs-title="days-of-week"}, months, [moys]{.under .tool data-bs-toggle="tooltip" data-bs-title="months-of-year"}, [doms]{.under .tool data-bs-toggle="tooltip" data-bs-title="days-of-month"}, finger counting, and dividend expansion. At its heart, Decalendar is a simple system that creates dates from integer years and days and calculates durations using decimal years or integer days. Dec dates are simple and easy to read. Dekly schedules are dependable and flexible.
