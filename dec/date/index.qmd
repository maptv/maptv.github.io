...
The top and bottom rows in the top table above show the [doys]{.under .tool data-bs-toggle="tooltip" data-bs-title="days-of-year"} in Pent 72 and Pent 0, respectively. [Day 365]{.underline .tool data-bs-toggle="tooltip" data-bs-title="February 29"} is the only day in Pent 73 and [Day 0]{.underline .tool data-bs-toggle="tooltip" data-bs-title="March 1"} is the first day of Pent 0. To get the current pent number, ${decoPent}, we double the current dek number, [\${decoDek}]{.cyan}, and then add 1 if the current [dod]{.under .tool data-bs-toggle="tooltip" data-bs-title="day-of-dek"} number, [\${decoDod}]{.cyan}, is greater than 4.

Apart from Pent numbers, we can also express a pent as a span🌈, like 360=365-5, which represents Pent 72. In any span, we can omit the subtrahend, 360=-5, or the difference: 360=365. It also is possible to switch the left- and right-hand sides to reverse a span: 365=360+5, 365=360, or 365=+5. Typically, the order does not matter, but a reversed span indicates that we want to start from the latest day of the span and work backwards.

Spans can also represent groups of non-consecutive days. All of the Schedule 3+2 work days in a year can be expressed as 1=4=:5. In this span, we start with Days 1, 2, and 3 and then include every day that is a multiple of 5 days away from one of the starting days. The number preceded by a colon is called a step and indicates which days we want to include.
