...
This article, along with the subsequent article on my site, are part of a series focusing on Dec time measurement. To measure time, Dec uses years and days. Even though it does not need months or weeks, Dec supports [round-trip conversion](https://en.wikipedia.org/wiki/Round-trip_format_conversion#:~:text=converting%20from%20any%20data%20representation%20and%20back%20again) of all three [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601#:~:text=an%20international%20standard%20covering%20the%20worldwide%20exchange%20and%20communication%20of%20date%20and%20time%2Drelated%20data) date formats, including ISO 8601 [month](https://en.wikipedia.org/wiki/ISO_8601#Calendar_dates) and [week](https://en.wikipedia.org/wiki/ISO_week_date#:~:text=a%20leap%20week%20calendar%20system) dates, as shown in the [Mermaid](https://mermaid.js.org) flowchart  below.
...
The [Mermaid](https://mermaid.js.org) flowchart above shows how the dote `741343` can be converted into many different formats. You can jump to the subsection in this article that focuses on a given format by clicking on its corresponding rectangle in the flowchart.
