...
Given that a bimester is slightly shorter than two lunations, we expect lunar phases and dob to slowly drift apart over 2 or 3 lunar years but then be put back into alignment by [Dob]{.tool data-bs-toggle="tooltip" data-bs-title="day of bimester"} [0]{.grave}, but we should generally observe a new🌑moon on [Dob]{.tool data-bs-toggle="tooltip" data-bs-title="day of bimester"} 0 and 29, first quarter🌓moon on [Dob]{.tool data-bs-toggle="tooltip" data-bs-title="day of bimester"} 7 and 37, full🌕moon on [Dob]{.tool data-bs-toggle="tooltip" data-bs-title="day of bimester"} 15 and 44, and last quarter🌗moon on [Dob]{.tool data-bs-toggle="tooltip" data-bs-title="day of bimester"} 22 and 52.

The [dob]{.tool data-bs-toggle="tooltip" data-bs-title="days of bimester"} in the [small multiple](https://en.wikipedia.org/wiki/Small_multiple#:~:text=a%20series%20of%20similar%20graphs%20or%20charts%20using%20the%20same%20scale%20and%20axes) grid below are aligned with the moon diagrams beneath them. The grid can be arranged according to the Gregorian calendar solar year or the Dec lunar year using the "Layout" radio input beneath the grid. When the Dec layout is selected, the rows of moon diagrams alternate between long or short months, the row labels are lunar bom, and the moon diagrams in each row are vertically stacked according to the last digit of the [dob]{.tool data-bs-toggle="tooltip" data-bs-title="day of bimester"} above each moon diagram.

When the Gregorian layout is chosen, each row of moon diagrams represents a Gregorian calendar month, the row labels are bom, the moon diagrams are vertically stacked by [dow]{.tool data-bs-toggle="tooltip" data-bs-title="day of week"}, and the "Offset" range input shifts the dob above the moon diagrams.




Use the range input beneath the plot below to shift the [dob]{.tool data-bs-toggle="tooltip" data-bs-title="days of bimester"} in relation to the moons in the plot.
but Gregorian calendar months and weeks are not. 

:::{#moonobservable}
{{< include /dec/date/_moon.qmd >}}
:::

Despite not being shown in the moon plot, [bob]{.tool data-bs-toggle="tooltip" data-bs-title="beginning of bimester"} nevertheless work behind the scenes to compensate for changes in the [dob]{.tool data-bs-toggle="tooltip" data-bs-title="day of bimester"} so that the [pid]{.tool data-bs-toggle="tooltip" data-bs-title="positive integer day of year"} to the left of each row remains unchanged as we use the associated range input. Moving days between the [bob]{.tool data-bs-toggle="tooltip" data-bs-title="beginning of bimester"} and [dob]{.tool data-bs-toggle="tooltip" data-bs-title="day of bimester"} does not alter the [pid]{.tool data-bs-toggle="tooltip" data-bs-title="positive integer day of year"}, because the sum of the [bob]{.tool data-bs-toggle="tooltip" data-bs-title="beginning of bimester"} and [dob]{.tool data-bs-toggle="tooltip" data-bs-title="day of bimester"} is always the [pid]{.tool data-bs-toggle="tooltip" data-bs-title="positive integer day of year"}: \${monthNumber} + \${dotm} = \${decDoty}.

Use the "Year" input to view how well dob match lunations across years. You can also identify which Dec years have bimester leap days by looking for the telltale [dob]{.tool data-bs-toggle="tooltip" data-bs-title="days of bimester"} sequence: 58, [0]{.grave}, and 0.

by the range input above can be applied to the current year+[bob]{.tool data-bs-toggle="tooltip" data-bs-title="beginning of bimester"}+[dob]{.tool data-bs-toggle="tooltip" data-bs-title="day of bimester"} Dec date:

The year+[bob]{.tool data-bs-toggle="tooltip" data-bs-title="beginning of bimester"} in a year+[bob]{.tool data-bs-toggle="tooltip" data-bs-title="beginning of bimester"}+[dob]{.tool data-bs-toggle="tooltip" data-bs-title="day of bimester"} Dec date can uniquely identify a bimester, but does not directly track progress through a tricennium or when a leap day will occur.


Dec does not provide any way to distinguish one bimester from another, to track progress through a tricennium, or to predict when a leap day will occur.   

Although the sole purpose of [dob]{.tool data-bs-toggle="tooltip" data-bs-title="day of bimester"} in Dec is to track lunations, expanding a [pid]{.tool data-bs-toggle="tooltip" data-bs-title="positive integer day of year"} into a [bob]{.tool data-bs-toggle="tooltip" data-bs-title="beginning of bimester"}+[dob]{.tool data-bs-toggle="tooltip" data-bs-title="day of bimester"} may facilitate comparison of dates in the Dec and Lunar Hijri calendars. 
