...
$$\text{pid} = \biggl \lfloor \text{doc} - \text{yoc} \ast 365 - \left \lfloor \frac{\text{yoc}}{4} \right \rfloor + \left \lfloor \frac{\text{yoc}}{100} \right \rfloor \biggr \rfloor$$ {#eq-doe2pid}
...
### Dec [doy]{.tool data-bs-toggle="tooltip" data-bs-title="day of year"} to POSIX month and [dom]{.tool data-bs-toggle="tooltip" data-bs-title="day of month"} {.centered}
...
$$\text{dom} = \text{doy} - \text{bom}$$
:::

### POSIX month and [dom]{.tool data-bs-toggle="tooltip" data-bs-title="day of month"} to Dec [doy]{.tool data-bs-toggle="tooltip" data-bs-title="day of year"} {.centered}

$$\text{moy} = (\text{month} + 9) \bmod 12$$ {#eq-month2moy}

$$\text{doy} = \lfloor (\text{moy} \times 153 + 2) \div 5 \rfloor + \text{dom} - 1$$
