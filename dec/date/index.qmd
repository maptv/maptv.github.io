...
We can learn that the current bimester began \${decDop} days ago on Day [\${decBopSign1}]{.mono}${decBop} by looking at the current year+[bob]{.tool data-bs-toggle="tooltip" data-bs-title="beginning of bimester"}+[dob]{.tool data-bs-toggle="tooltip" data-bs-title="day of bimester"} Dec date: \${decYear}[\${decBopSign}]{.mono}\${decBopPad}[+]{.mono}\${decDopPad}. All bimesters begin with [Dob]{.tool data-bs-toggle="tooltip" data-bs-title="day of bimester"} 0 and end with [Dob]{.tool data-bs-toggle="tooltip" data-bs-title="day of bimester"} 58. After 12 or 18 bimesters, a lunar leap day occurs. Dec designates lunar leap days as [Dob]{.tool data-bs-toggle="tooltip" data-bs-title="days of bimester"} [0]{.grave}, which is similar to how solar leap days appear when expressed as [[mi]{.overline}[d]{.grave}]{.tool data-bs-toggle="tooltip" data-bs-title="next mixed integer days of year"}.
...
In Decalunar, a leap year would be 343 [soi]{.tool data-bs-toggle="tooltip" data-bs-title="spin orbit intervals"} instead of 355 days and a common year would be 342 [soi]{.tool data-bs-toggle="tooltip" data-bs-title="spin orbit intervals"} rather than 354 days. Decalendar and Decalunar can follow the same leap year pattern because the [fractional part](https://en.wikipedia.org/wiki/Fractional_part#:~:text=the%20excess%20beyond%20that%20number%27s%20integer%20part) of 12 [synodic months](https://en.wikipedia.org/wiki/Lunar_month#Synodic_month:~:text=the%20average%20period%20of%20the%20Moon%27s%20orbit%20with%20respect%20to%20the%20line%20joining%20the%20Sun%20and%20Earth) is nearly identical for days and [soi]{.tool data-bs-toggle="tooltip" data-bs-title="spin orbit intervals"}: [29.53059](https://en.wikipedia.org/wiki/Lunar_month#Synodic_month:~:text=synodic%20month%29%20is-,29.53059%20days,-or%2029%20d) &times; 12 [mod](https://en.wikipedia.org/wiki/Modulo#:~:text=returns%20the%20remainder) 1 &asymp; 354.367 [mod](https://en.wikipedia.org/wiki/Modulo#:~:text=returns%20the%20remainder) 1 &asymp; 354.367 &div; 1.03505 [mod](https://en.wikipedia.org/wiki/Modulo#:~:text=returns%20the%20remainder) 1 &asymp; 342.367 [mod](https://en.wikipedia.org/wiki/Modulo#:~:text=returns%20the%20remainder) 1.

The Decalunar [pid]{.tool data-bs-toggle="tooltip" data-bs-title="positive integer day of year"} would be expanded into a [bob]{.tool data-bs-toggle="tooltip" data-bs-title="beginning of bimester"} and "[soi]{.tool data-bs-toggle="tooltip" data-bs-title="spin orbit interval"} of bimester" ([sob]{.tool data-bs-toggle="tooltip" data-bs-title="soi of bimester"}) as opposed to a [bob]{.tool data-bs-toggle="tooltip" data-bs-title="beginning of bimester"} and [dob]{.tool data-bs-toggle="tooltip" data-bs-title="day of bimester"}. In Decalunar, a bimester would be 57 [soi]{.tool data-bs-toggle="tooltip" data-bs-title="spin orbit intervals"} in lieu of 59 days, a short month would be 28 [soi]{.tool data-bs-toggle="tooltip" data-bs-title="spin orbit intervals"} rather than 29 days, and a long month would be 29 [soi]{.tool data-bs-toggle="tooltip" data-bs-title="spin orbit intervals"} instead of 30 days. The difference between 57 [soi]{.tool data-bs-toggle="tooltip" data-bs-title="spin orbit intervals"} and 59 days is 0.215% of a day: 57 &times; 1.03505 = 58.99785.

Both Decalendar and Decalunar rely on the [syl]{.tool data-bs-toggle="tooltip" data-bs-title="solar year length"} for precise timekeeping over long periods, and thus can adapt whenever the [lyl]{.tool data-bs-toggle="tooltip" data-bs-title="lunar year length"} diverges from observed lunations. If need be, we can move a day or two between the [bob]{.tool data-bs-toggle="tooltip" data-bs-title="beginning of bimester"} and [dob]{.tool data-bs-toggle="tooltip" data-bs-title="day of bimester"} or a [soi]{.tool data-bs-toggle="tooltip" data-bs-title="spin orbit intervals"} or two between the [bob]{.tool data-bs-toggle="tooltip" data-bs-title="beginning of bimester"} and [sob]{.tool data-bs-toggle="tooltip" data-bs-title="soi of bimester"} to better match lunar observations without affecting the [doy](#doy){.tool data-bs-toggle="tooltip" data-bs-title="day of year"} or [soy]{.tool data-bs-toggle="tooltip" data-bs-title="soi of year"} as per Equations -@eq-sob and -@eq-bobplusdob below.
...
On Venus, a solar year is 224.7 [d]{.tool data-bs-toggle="tooltip" data-bs-title="days"} and a solar day is 116.75 [d]{.tool data-bs-toggle="tooltip" data-bs-title="days"}. Decyther could match Venusian solar days exceptionally well with cycles of 4 years or 1401 days that comprise 3 short years of 350 [d]{.tool data-bs-toggle="tooltip" data-bs-title="days"} and 1 long year of 351 [d]{.tool data-bs-toggle="tooltip" data-bs-title="days"}. Each Decyther year consists of 6 bimesters. Each Decyther bimester is 58 + [*i* [mod](https://en.wikipedia.org/wiki/Modulo#:~:text=returns%20the%20remainder) 8 ∈ {0, 3, 6}] [d]{.tool data-bs-toggle="tooltip" data-bs-title="days"} long, where *i* is the zero-based bimester index. 

Each Decyther bimester represents half of a Venusian solar day and is analogous to either the antemeridian or postmeridian half of a day on Earth. We can identify a Decyther bimester using bob, measure its passage in dob, and combine it with an adjacent bimester to get a quadrimester that represents a full cycle of light and darkness on Venus. 

In other words, Decyther uses year+bob+dob dates for Venusian solar days, just like Decalendar uses year+bob+dob dates for lunations.

Venus does not have any moons, 
To  In the same way that Decalendar expands [pid]{.tool data-bs-toggle="tooltip" data-bs-title="positive integer day of year"} into [bob]{.tool data-bs-toggle="tooltip" data-bs-title="beginning of bimester"} and [dob]{.tool data-bs-toggle="tooltip" data-bs-title="day of bimester"} to represent moonlight, both Decalunar and Decyther could split [pid]{.tool data-bs-toggle="tooltip" data-bs-title="positive integer day of year"} into [bob]{.tool data-bs-toggle="tooltip" data-bs-title="beginning of bimester"} and [dob]{.tool data-bs-toggle="tooltip" data-bs-title="day of bimester"}

either the [daytime](https://en.wikipedia.org/wiki/Daytime#:~:text=the%20period%20of%20the%20day%20in%20which%20the%20Sun%20is%20above%20the%20local%20horizon) or [nighttime](https://en.wikipedia.org/wiki/Night#:~:text=the%20period%20of%20darkness%20when%20the%20Sun%20is%20below%20the%20horizon) 

for precise timekeeping and expand [pid]{.tool data-bs-toggle="tooltip" data-bs-title="positive integer day of year"} 
could rely on the Decalendar [yoe]{.tool data-bs-toggle="tooltip" data-bs-title="year of era"} and 
There are inhabited locations on Earth that experience [constant daylight](https://en.wikipedia.org/wiki/Midnight_sun#Geography:~:text=to%2022%20July%20%28-,62%20days,-%29) or [no daylight at all](https://en.wikipedia.org/wiki/Polar_night#Dates_with_no_daylight:~:text=notable%20locations%3A%20Utqiagvik) for more than a bimester every year.

are each 58.375 [d]{.tool data-bs-toggle="tooltip" data-bs-title="days"}

Venus has no moon and therefore no 
