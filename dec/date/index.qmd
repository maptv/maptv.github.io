...
In a leap year, write the final days in a way that matches a common year. The -1 identifies that the [doy]{.tool data-bs-toggle="tooltip" data-bs-title="day of year"} belongs to a leap year and makes the Dec schedule classification of work and rest days match for dox and do[x]{.overline}.
