...
Dec spans can omit the minuend and the difference to indicate that the minuend is the first day of the year: [Day 0]{.tool data-bs-toggle="tooltip" data-bs-title="March 1"}. Similarly, an empty [right](https://en.wikipedia.org/wiki/Sides_of_an_equation#:~:text=The%20expression%20on%20the%20right%20side%20of%20the%20%22%3D%22%20sign)-hand side means that the subtrahend is the last day of the year: [Day -1]{.tool data-bs-toggle="tooltip" data-bs-title="February 28 or 29"}. Anchored spans have one or two [yoes]{.tool data-bs-toggle="tooltip" data-bs-title="years of era"}, whereas floating spans do not contain a [yoe]{.tool data-bs-toggle="tooltip" data-bs-title="year of era"}. The floating version of the span above would be \${decDoty}=299.


Unlike expanded dates, spans can display a minuend. Without a minuend, visually [parsing](https://en.wikipedia.org/wiki/Parsing#:~:text=a%20process%20of%20analyzing%20a%20string%20of%20symbols) a [doy]{.tool data-bs-toggle="tooltip" data-bs-title="day of year"} into a dek and [dod]{.tool data-bs-toggle="tooltip" data-bs-title="day of dek"} may be harder. In this way, an expanded date deemphasizes its dek and [dod]{.tool data-bs-toggle="tooltip" data-bs-title="day of dek"} in favor of some other information.
