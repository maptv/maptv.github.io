...
The [doy]{.under .tool data-bs-toggle="tooltip" data-bs-title="day-of-year"} chosen by the [Observable](https://observablehq.com/) [range](https://observablehq.com/@observablehq/input-range)🎚️inputs below to be highlighted with a red🟥background in the calendar🗓️plots, [\${dotyInput}]{.cyan}, functions as a pair of coordinates in the top calendar🗓️plot by selecting a dek on the x-axis↔️via the dek equation, [\${dekInput}]{.cyan} = &LeftFloor;[\${dotyInput}]{.cyan} &times; 10&RightFloor;, and a day-of-dek ([dod]{.under .tool data-bs-toggle="tooltip" data-bs-title="day-of-dek"}) on the y-axis↕with its last digit, [\${dodInput}]{.cyan}. A dek is a group of ten days and an alternative to months and weeks.
...
The radio🔘input beneath the calendar🗓️plots picks the [dow]{.under .tool data-bs-toggle="tooltip" data-bs-title="day-of-week"} for [Day 306]{.under .tool data-bs-toggle="tooltip" data-bs-title="January 1"}, the first day of the Gregorian calendar year, and has no effect on the top calendar🗓️plot, but can shift every day in the bottom calendar🗓️plot by one to six days. The bottom calendar🗓️plot has week numbers on its x-axis↔️and day-of-week ([dow]{.under .tool data-bs-toggle="tooltip" data-bs-title="day-of-week"}) numbers on its y-axis↕.
