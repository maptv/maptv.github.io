...
The year+day Dec date format is short for [year+day/[dyl]{.tool data-bs-toggle="tooltip" data-bs-title="Decalendar year length"}]{.nowrap}. Dec truncates dates because the [dyl]{.tool data-bs-toggle="tooltip" data-bs-title="Decalendar year length"} is not needed to specify a date, remains constant for 366, 1095, or 2920 days, has only 2 possible values: [365]{.color364by365} or [366]{.color365by366}, and can be obtained by passing Year [y]{.tool data-bs-toggle="tooltip" data-bs-title="year"} to Equations -@eq-leap and -@eq-leap2dyl below. Nevertheless, we can use the [dyl]{.tool data-bs-toggle="tooltip" data-bs-title="Decalendar year lengths"} to convert between different kinds of Dec dates.
...
A tricennium can be split into 19 "unextended lunar years" ([uly]{.tool data-bs-toggle="tooltip" data-bs-title="unextended lunar years"}) and 11 "extended lunar years" ([ely]{.tool data-bs-toggle="tooltip" data-bs-title="extended lunar years"}): 19 &times; 354 + 11 &times; 355, 180 bimesters and 11 lunar leap days: 180 &times; 59 + 11, or 169 "unextended lunar months" ([ulm]{.tool data-bs-toggle="tooltip" data-bs-title="unextended lunar months"}) and 191 "extended lunar months" ([elm]{.tool data-bs-toggle="tooltip" data-bs-title="extended lunar months"}): 169 &times; 29 + 191 &times; 30. Likewise, we can divide a bimester into 1 [elm]{.tool data-bs-toggle="tooltip" data-bs-title="extended lunar month"} and 1 [ulm]{.tool data-bs-toggle="tooltip" data-bs-title="unextended lunar month"}: 30 + 29 = 59.
...
As for the remaining two lunar phases, the first quarter moon occurs around the middle of [Pob]{.tool data-bs-toggle="tooltip" data-bs-title="Pentaday of bimester"} 1 and 7, while the last quarter moon appears near the center of [Pob]{.tool data-bs-toggle="tooltip" data-bs-title="Pentaday of bimester"} 4 and 10. To produce a [pob]{.tool data-bs-toggle="tooltip" data-bs-title="pentadays of bimester"}, we can use @eq-pob, which merges Equations -@eq-xun, -@eq-dox, -@eq-pox, and -@eq-poy. Basically, we double the first digit of a two-digit [dob]{.tool data-bs-toggle="tooltip" data-bs-title="day of bimester"} and then add 1 if its last digit is greater than 4.

$$\text{pob} = \left\lfloor\dfrac{\text{dob}}{10}\right\rfloor \ast 2 + \href{https://en.wikipedia.org/wiki/Iverson_bracket#:~:text=is%20defined%20to%20take%20the%20value%201%20for%20the%20values%20of%20the%20variables%20for%20which%20the%20statement%20is%20true%2C%20and%20takes%20the%20value%200%20otherwise}{[}\text{dob} \bmod 10 > 4\href{https://en.wikipedia.org/wiki/Iverson_bracket#:~:text=is%20defined%20to%20take%20the%20value%201%20for%20the%20values%20of%20the%20variables%20for%20which%20the%20statement%20is%20true%2C%20and%20takes%20the%20value%200%20otherwise}{]}$$ {#eq-pob}

Dec lunar years and months are based on the [Lunar Hijri](https://en.wikipedia.org/wiki/Islamic_calendar#:~:text=a%20lunar%20calendar%20consisting%20of%2012%20lunar%20months%20in%20a%20year%20of%20354%20or%20355%20days) calendar. Whereas a Lunar Hijri calendar date consists of a lunar year, lunar month, and lunar [dom]{.tool data-bs-toggle="tooltip" data-bs-title="day of month"}, the analogous Dec date comprises a solar year, [bob]{.tool data-bs-toggle="tooltip" data-bs-title="beginning of bimester"}, and [dob]{.tool data-bs-toggle="tooltip" data-bs-title="day of bimester"}. Bimesters and lunar months can both be divided into pentadays, but Dec prefers bimesters, because they do not vary in length.
