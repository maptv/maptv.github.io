...
While weeks are not evenly divisible by two, a dek can be cut✂️into two equal halves called pents.
The charts below show Schedule [3]{.green}+[2]{.blue}, the recommended pently schedule of work and rest days, from two different perspectives. The top chart uses [dod]{.under .tool data-bs-toggle="tooltip" data-bs-title="day-of-dek"} numbers and the bottom chart uses a one-based numbering approach that skips [Day 0]{.underline .tool data-bs-toggle="tooltip" data-bs-title="March 1"} and refers to [Dod]{.under .tool data-bs-toggle="tooltip" data-bs-title="day-of-dek"} 0 as [Dod]{.under .tool data-bs-toggle="tooltip" data-bs-title="day-of-dek"} 10.
...
Officially, [Day 365]{.underline .tool data-bs-toggle="tooltip" data-bs-title="February 29"} is the only day in Pent 73 and [Day 0]{.underline .tool data-bs-toggle="tooltip" data-bs-title="March 1"} is the first day of Pent 0. To get the current pent number, ${decoPent}, we double the current dek number, [\${decoDek}]{.cyan}, and then add 1 if the current [dod]{.under .tool data-bs-toggle="tooltip" data-bs-title="day-of-dek"} number, [\${decoDod}]{.cyan}, is greater than 4.

which have a total 219 work days according to Schedule [3]{.green}+[2]{.blue}.

Schedule [3]{.green}+[2]{.blue} provides every year, which is about 1 dek more than the 208 to 210 work days provided annually by a 4-day workweek. In contrast, Schedule [3]{.green}+[2]{.blue}+[4]{.green}+[1]{.blue} designates [Dod]{.under .tool data-bs-toggle="tooltip" data-bs-title="day-of-dek"} 9 as a work day and thus has an annual total of 255 work days, which is about 1 pent less than the 260 to 262 work days per year that a 5-day workweek yields.
