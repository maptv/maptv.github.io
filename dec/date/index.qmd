...
The insertion of [d]{.tool data-bs-toggle="tooltip" data-bs-title="day"}[365]{.color365by366} shifts 306 dates, [d]{.tool data-bs-toggle="tooltip" data-bs-title="day"}\${march1doy} to [d]{.tool data-bs-toggle="tooltip" data-bs-title="day"}\${december31doy}, in the [Gregorian calendar](https://en.wikipedia.org/wiki/Gregorian_calendar#:~:text=the%20calendar%20used%20in%20most%20parts%20of%20the%20world) by 1 day, but does not change the order of any Dec dates, because [d]{.tool data-bs-toggle="tooltip" data-bs-title="day"}[365]{.color365by366} is always the last day of Dec leap years and is always followed by [d]{.tool data-bs-toggle="tooltip" data-bs-title="day"}[0]{.color0} of the subsequent Dec year. The "Year length" radio input also changes the value of the negative "Day of year" range input by 1 day.
...
The "Plot layout" radio input rotates the calendar plots by a quarter turn, interchanging the horizontal (↔) and vertical (↕) axes. The axis labels demonstrate that [x]{.tool data-bs-toggle="tooltip" data-bs-title="groups of ten days"} are analogous to weeks and that "days of xún" ([dox]{.tool data-bs-toggle="tooltip" data-bs-title="days of xún"}) are "day of week" ([dow]{.tool data-bs-toggle="tooltip" data-bs-title="day of week"}) analogs. If we multiply an [x]{.tool data-bs-toggle="tooltip" data-bs-title="groups of ten days"} \${layoInput ? "↕" : "↔"} axis label by ten and add it to a [dox]{.tool data-bs-toggle="tooltip" data-bs-title="days of xún"} \${layoInput ? "↔" : "↕"} axis label, we get a [pid]{.tool data-bs-toggle="tooltip" data-bs-title="positive integer day of year"} cell value: \${dotyInputDek} &times; 10 + \${dotyInputDod} = ${dotyInput}.

:::{.overflowequation}
$$\text{pid} = \text{x} \ast 10 + \text{dox}$$ {#eq-pid}
:::

Although weeks determine the shape of the Gregorian calendar plot, its cell values are "days of month" ([dom]{.tool data-bs-toggle="tooltip" data-bs-title="days of month"}). We can uniquely identify🪪a specific day in any year with a [pid]{.tool data-bs-toggle="tooltip" data-bs-title="positive integer day of year"}, instead of a month and a [dom]{.tool data-bs-toggle="tooltip" data-bs-title="day of month"}. Except for [d]{.tool data-bs-toggle="tooltip" data-bs-title="day"}[365]{.color365by366} in leap years, every year has the same [x]{.tool data-bs-toggle="tooltip" data-bs-title="groups of ten days"} and months, but not the same weeks, because the [dow]{.tool data-bs-toggle="tooltip" data-bs-title="day of week"} of the first day of the year varies.
...
Whereas it could fall on any [dow]{.tool data-bs-toggle="tooltip" data-bs-title="day of week"}, [d]{.tool data-bs-toggle="tooltip" data-bs-title="day"}[0]{.color0} is always the first day of [x]{.tool data-bs-toggle="tooltip" data-bs-title="groups of ten days"}[0]{.color0} and [h]{.tool data-bs-toggle="tooltip" data-bs-title="group of one hundred days"}[0]{.color0}, regardless of the last 4 days of [x]{.tool data-bs-toggle="tooltip" data-bs-title="groups of ten days"}[36]{.color360by365} and the last 34 days of [h]{.tool data-bs-toggle="tooltip" data-bs-title="group of one hundred days"}[3]{.color3} that extend past a common "end of year" ([eoy]{.tool data-bs-toggle="tooltip" data-bs-title="end of year"}) or the last 5 days of [x]{.tool data-bs-toggle="tooltip" data-bs-title="groups of ten days"}[36]{.color360by365} and the last 35 days of [h]{.tool data-bs-toggle="tooltip" data-bs-title="group of one hundred days"}[3]{.color3} that go beyond a leap [eoy]{.tool data-bs-toggle="tooltip" data-bs-title="end of year"}. To track days seamlessly across years, we can use a discrete count of days called the "day of [era](https://en.wikipedia.org/wiki/Calendar_era#:~:text=the%20period%20of%20time%20elapsed%20since%20one%20epoch%20of%20a%20calendar)" ([doe]{.tool data-bs-toggle="tooltip" data-bs-title="day of era"}).
...
Similarly, @eq-nih groups [doy]{.tool data-bs-toggle="tooltip" data-bs-title="days of year"} into 1 of the 4 [nih]{.tool data-bs-toggle="tooltip" data-bs-title="negative integer hectodays"}: [h]{.tool data-bs-toggle="tooltip" data-bs-title="groups of one hundred days"}[1̅]{.mono}, [h]{.tool data-bs-toggle="tooltip" data-bs-title="groups of one hundred days"}[2̅]{.mono}, [h]{.tool data-bs-toggle="tooltip" data-bs-title="groups of one hundred days"}[3̅]{.mono}, or [h]{.tool data-bs-toggle="tooltip" data-bs-title="groups of one hundred days"}[4̅]{.mono}. In either case, the [pid]{.tool data-bs-toggle="tooltip" data-bs-title="positive integer days of year"} or [nid](#nid){.tool data-bs-toggle="tooltip" data-bs-title="negative integer day of year"} of a [doy]{.tool data-bs-toggle="tooltip" data-bs-title="days of year"} is divided by 100 and then [floored](https://en.wikipedia.org/wiki/Floor_and_ceiling_functions#:~:text=takes%20a%20real%20number%20x%20as%20input%20and%20returns%20the%20greatest%20integer%20less%20than%20or%20equal%20to%20x) to discard the [fractional part](https://en.wikipedia.org/wiki/Fractional_part#:~:text=The%20fractional%20part%20or,that%20number%27s%20integer%20part) of the [quotient](https://en.wikipedia.org/wiki/Quotient#:~:text=a%20quantity%20produced%20by%20the%20division%20of%20two%20numbers).

for this purpose. starts from the "end of year" ([eoy]{.tool data-bs-toggle="tooltip" data-bs-title="end of year"}) and identifies [h]{.tool data-bs-toggle="tooltip" data-bs-title="groups of one hundred days"} with positive indexes , 

 while the other is negative Dec seasons include the first three consecutive [h]{.tool data-bs-toggle="tooltip" data-bs-title="groups of one hundred days"} in any year: [h]{.tool data-bs-toggle="tooltip" data-bs-title="groups of one hundred days"}0, [h]{.tool data-bs-toggle="tooltip" data-bs-title="groups of one hundred days"}1, and [h]{.tool data-bs-toggle="tooltip" data-bs-title="groups of one hundred days"}2, which match the rise, crest, and fall of global temperatures, respectively. The last Dec season, [h]{.tool data-bs-toggle="tooltip" data-bs-title="groups of one hundred days"}1̅, where 1̅ represents -1. To obtain the current [h]{.tool data-bs-toggle="tooltip" data-bs-title="group of one hundred days"}, we divide the current [pid]{.tool data-bs-toggle="tooltip" data-bs-title="positive integer day of year"} by 100 and then : &lfloor;\${decDoty} &div; 100&rfloor; = \${decHek}. The remainder after dividing a [pid]{.tool data-bs-toggle="tooltip" data-bs-title="positive integer day of year"} by 100 is a "day of hectoday" ([doh](#doh){#dayofhectoday .tool data-bs-toggle="tooltip" data-bs-title="day of hectoday"}): \${decDoty} [mod](https://en.wikipedia.org/wiki/Modulo#:~:text=returns%20the%20remainder) 100 = \${decDoth}. 
...
Just as [h]{.tool data-bs-toggle="tooltip" data-bs-title="groups of one hundred days"}3 overlaps with [h]{.tool data-bs-toggle="tooltip" data-bs-title="groups of one hundred days"}0 by about a third of a season, the last 100 days of the year comprises about a third of h2 and two thirds of h3. [doh](#doh){.tool data-bs-toggle="tooltip" data-bs-title="day of hectoday"} is the percent of a Dec season that has passed. The current [pid]{.tool data-bs-toggle="tooltip" data-bs-title="positive integer day of year"}, \${decDoty}, tells us that h\${decHek} is \${decDoth}% done. @tbl-hoy below shows how to interpret the Dec seasons in the [Northern](https://en.wikipedia.org/wiki/Northern_Hemisphere#:~:text=half%20of%20Earth%20that%20is%20north%20of%20the%20equator) and [Southern](https://en.wikipedia.org/wiki/Southern_Hemisphere#:~:text=Earth%20that%20is-,south%20of%20the%20equator,-.%20It%20contains%20all) [Hemispheres](https://en.wikipedia.org/wiki/Hemispheres_of_Earth#:~:text=any%20division%20of%20the%20globe%20into%20two%20equal%20halves). 
...
In contrast to a week, an [x]{.tool data-bs-toggle="tooltip" data-bs-title="groups of ten days"} can be split evenly into 5 pairs of days or 2 equal halves called "pentadays of xún" ([pox]{.tool data-bs-toggle="tooltip" data-bs-title="pentadays of xún"}). Likewise, a common year can be divided evenly into 73 "pentadays of year" ([poy]{.tool data-bs-toggle="tooltip" data-bs-title="pentadays of year"}). The last pentaday ([p](#p){#pentaday .tool data-bs-toggle="tooltip" data-bs-title="pentaday"}) of a leap year, [p]{.tool data-bs-toggle="tooltip" data-bs-title="pentaday"}73, consists of the final day of the leap year, [d]{.tool data-bs-toggle="tooltip" data-bs-title="day"}[365]{}, and the first four days of the subsequent year: Days 0 to 4.

In the context of a common year, [p]{.tool data-bs-toggle="tooltip" data-bs-title="pentaday"}73 is synonymous with [p]{.tool data-bs-toggle="tooltip" data-bs-title="pentaday"}0 of the subsequent year. To obtain the current [poy]{.tool data-bs-toggle="tooltip" data-bs-title="pentaday of year"}, we double the current [x]{.tool data-bs-toggle="tooltip" data-bs-title="groups of ten days"} and add the current [pox]{.tool data-bs-toggle="tooltip" data-bs-title="pentaday of xún"}, which is 1 if the current [dox]{.tool data-bs-toggle="tooltip" data-bs-title="days of xún"} is greater than 4 and 0 otherwise: ${decPent} = \${decDek} &times; 2 + [\${decDotd} > 4]. If we divide a [dox]{.tool data-bs-toggle="tooltip" data-bs-title="days of xún"} by 5, the remainder will be its corresponding "day of pentaday" ([dop]{.tool data-bs-toggle="tooltip" data-bs-title="days of pentaday"}): \${decDek} [mod](https://en.wikipedia.org/wiki/Modulo#:~:text=returns%20the%20remainder) 5 = \${decDotp}. 
...
With pently schedules, we can determine whether any date falls on a work or a rest day with just a glance. Counterintuitively, pently schedules can be based on months instead of [x]{.tool data-bs-toggle="tooltip" data-bs-title="groups of ten days"}. Month-based pently schedules distinguish between work and rest days based on the last digit of [dom]{.tool data-bs-toggle="tooltip" data-bs-title="days of month"}. The drawback of month-based schedules is that [dom]{.tool data-bs-toggle="tooltip" data-bs-title="day of month"} reset twelve times every year.
