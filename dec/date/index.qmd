...
The [doy]{.under .tool data-bs-toggle="tooltip" data-bs-title="day-of-year"} chosen by the [Observable](https://observablehq.com/) [range](https://observablehq.com/@observablehq/input-range)🎚️inputs below to be highlighted with a red🟥background in the calendar🗓️plots, [\${decoDotyInput}]{.cyan}, functions as a pair of coordinates in the top calendar🗓️plot by selecting a dek on the x-axis↔️with its first 2 digits, [\${decoDotyInputDek}]{.cyan}, and a day-of-dek ([dod]{.under .tool data-bs-toggle="tooltip" data-bs-title="day-of-dek"}) on the y-axis↕with its last digit, [\${decoDotyInputDod}]{.cyan}. A dek is a group of ten days and an alternative to months and weeks.
