...
We can find out that [h]{.tool data-bs-toggle="tooltip" data-bs-title="group of one hundred days"}\${decPih} is \${decDohPid}% done from the current pid: \${decDoty}, that \${decDohPidMid}% is left until [h]{.tool data-bs-toggle="tooltip" data-bs-title="group of one hundred days"}\${decPihPlus1} from the current three-digit countdown [mid]{.tool data-bs-toggle="tooltip" data-bs-title="mixed integer day of year"} which has a vinculum over its last two digits: \${decPihPlus1}[\${decDohPidMidPad}]{.overline}, that \${decDohNid}% remains until [h]{.tool data-bs-toggle="tooltip" data-bs-title="group of one hundred days"}[\${decNihPlus1}]{.overline} from the current [nid](#nid){.tool data-bs-toggle="tooltip" data-bs-title="negative integer day of year"}: \${decNid}, and that [h]{.tool data-bs-toggle="tooltip" data-bs-title="group of one hundred days"}[\${decNih}]{.overline} is \${decDohNidMidPad}% finished from the current three-digit countup [mid]{.tool data-bs-toggle="tooltip" data-bs-title="mixed integer day of year"} which has a vinculum over only its first digit: [\${decNih}]{.overline}\${decDohNidMidPad}. 

Every [doy](#doy){.tool data-bs-toggle="tooltip" data-bs-title="day of year"} belongs to one [pih]{.tool data-bs-toggle="tooltip" data-bs-title="positive integer hectoday"}, one [nih]{.tool data-bs-toggle="tooltip" data-bs-title="negative integer hectoday"}, one "positive integer xún" ([pix](#pix){.tool data-bs-toggle="tooltip" data-bs-title="positive integer xún"}), and one "negative integer xún" ([nix](#nix){.tool data-bs-toggle="tooltip" data-bs-title="negative integer xún"}). Day 0 is in [h]{.tool data-bs-toggle="tooltip" data-bs-title="group of one hundred days"}0, [x]{.tool data-bs-toggle="tooltip" data-bs-title="group of ten days"}0, [h]{.tool data-bs-toggle="tooltip" data-bs-title="group of one hundred days"}[4]{.overline}, and [x]{.tool data-bs-toggle="tooltip" data-bs-title="group of ten days"}[37]{.overline}. Days 364 and 365 are in [h]{.tool data-bs-toggle="tooltip" data-bs-title="group of one hundred days"}3, [x]{.tool data-bs-toggle="tooltip" data-bs-title="group of ten days"}36, [h]{.tool data-bs-toggle="tooltip" data-bs-title="group of one hundred days"}[1]{.overline}, and [x]{.tool data-bs-toggle="tooltip" data-bs-title="group of ten days"}[1]{.overline}. While [h]{.tool data-bs-toggle="tooltip" data-bs-title="group of one hundred days"}0 and [x]{.tool data-bs-toggle="tooltip" data-bs-title="group of ten days"}0 start at the [boy](#boy){.tool data-bs-toggle="tooltip" data-bs-title="beginning of year"}, both [h]{.tool data-bs-toggle="tooltip" data-bs-title="group of one hundred days"}3 and [x]{.tool data-bs-toggle="tooltip" data-bs-title="group of ten days"}36 extend beyond the "end of year" ([eoy](#eoy){.tool data-bs-toggle="tooltip" data-bs-title="end of year"}). In contrast, [h]{.tool data-bs-toggle="tooltip" data-bs-title="group of one hundred days"}[4]{.overline} and [x]{.tool data-bs-toggle="tooltip" data-bs-title="group of ten days"}[37]{.overline} start before the [boy](#boy){.tool data-bs-toggle="tooltip" data-bs-title="beginning of year"} but [h]{.tool data-bs-toggle="tooltip" data-bs-title="group of one hundred days"}[1]{.overline} and [x]{.tool data-bs-toggle="tooltip" data-bs-title="group of ten days"}[1]{.overline} do not go past the [eoy](#eoy){.tool data-bs-toggle="tooltip" data-bs-title="end of year"}.
...
Dec year+day dates can be expanded to display the "beginning of month" ([bom]{.tool data-bs-toggle="tooltip" data-bs-title="beginning of month"}) and [POSIX [dom]{.tool data-bs-toggle="tooltip" data-bs-title="day of month"}](https://pubs.opengroup.org/onlinepubs/007904875/utilities/date.html#:~:text=day%20of%20the%20month%20as%20a%20decimal%20number%20%5B01%2C31%5D). The [bom]{.tool data-bs-toggle="tooltip" data-bs-title="beginning of month"} is the last [doy]{.tool data-bs-toggle="tooltip" data-bs-title="day of year"} of the previous month because POSIX [dom]{.tool data-bs-toggle="tooltip" data-bs-title="days of month"} are one-based. We can think of the [bom]{.tool data-bs-toggle="tooltip" data-bs-title="beginning of month"} as [Dom]{.tool data-bs-toggle="tooltip" data-bs-title="days of month"} 0 even though no such [dom]{.tool data-bs-toggle="tooltip" data-bs-title="days of month"} exists in POSIX or the Gregorian calendar. To obtain the [bom]{.tool data-bs-toggle="tooltip" data-bs-title="beginning of month"}, we can subtract the [dom]{.tool data-bs-toggle="tooltip" data-bs-title="days of month"} from the [doy]{.tool data-bs-toggle="tooltip" data-bs-title="day of year"}: \${monthNumber} = \${decDoty} -- \${dotm}. 

:::{.column-margin .overflowequation}
$$\text{bom} = \text{doy} - \text{dom}$$ {#eq-bom}
:::

We can find every possible [bom]{.tool data-bs-toggle="tooltip" data-bs-title="beginning of month"} using only a pair of hands🤲by counting index☝️and ring💍fingers as 30 days and other fingers as 31 days, as shown in the pair of images below. We start counting from -1, which is the [doy]{.tool data-bs-toggle="tooltip" data-bs-title="days of year"} that preceeds the first "month of year" ([moy]{.tool data-bs-toggle="tooltip" data-bs-title="month of year"}): [Moy]{.tool data-bs-toggle="tooltip" data-bs-title="month of year"} [0]{.color0}. To cover twelve months with only ten fingers, the first and last finger each represent two months.
...
Like the [knuckle](https://en.wikipedia.org/wiki/Knuckle_mnemonic#:~:text=a%20mnemonic%20device%20for%20remembering%20the%20number%20of%20days%20in%20the%20months%20of%20the%20Julian%20and%20Gregorian%20calendars)👊and [musical keyboard](https://en.wikipedia.org/wiki/Month#:~:text=this%20cyclical%20pattern%20of%20month%20lengths%20matches%20the%20musical%20keyboard%20alternation%20of%20wide%20white%20keys%20(31%20days)%20and%20narrow%20black%20keys%20(30%20days))🎹[mnemonics](https://en.wikipedia.org/wiki/Mnemonic#:~:text=any%20learning%20technique%20that%20aids%20information%20retention%20or%20retrieval%20in%20the%20human%20memory), the finger🖐counting technique described above is an attempt to make sense of the irregular pattern of [month lengths](https://en.wikipedia.org/wiki/Month#:~:text=Name-,Number,of%20days) in the Gregorian calendar️. We do not need mnemonics, [rhymes](https://en.wikipedia.org/wiki/Thirty_Days_Hath_September), tables, [dactylonomy](https://en.wikipedia.org/wiki/Finger-counting#:~:text=counting%20using%20the%20fingers), or mental calculations to use [h]{.tool data-bs-toggle="tooltip" data-bs-title="groups of one hundred days"} or [x]{.tool data-bs-toggle="tooltip" data-bs-title="groups of ten days"}, because all of the required information is plainly visible in the [doy]{.tool data-bs-toggle="tooltip" data-bs-title="day of year"}.

# Month of year (moy) {#sec-moy}

To convert a [doy]{.tool data-bs-toggle="tooltip" data-bs-title="day of year"} to or from a [POSIX month](https://pubs.opengroup.org/onlinepubs/007904875/utilities/date.html#:~:text=Month%20as%20a%20decimal%20number%20%5B01%2C12%5D) and [dom]{.tool data-bs-toggle="tooltip" data-bs-title="day of month"}, we can use the [moy]{.tool data-bs-toggle="tooltip" data-bs-title="month of year"} equations from [Howard Hinnant](https://howardhinnant.github.io)'s [`civil_from_days`](https://howardhinnant.github.io/date_algorithms.html#civil_from_days){.mono .under} and [`days_from_civil`](https://howardhinnant.github.io/date_algorithms.html#days_from_civil){.mono .under} algorithms -@hinnant2021date. Unlike POSIX months, [moy]{.tool data-bs-toggle="tooltip" data-bs-title="months of year"} are zero-based and start from [Moy]{.tool data-bs-toggle="tooltip" data-bs-title="month of year"} [0]{.color0} instead of [Moy]{.tool data-bs-toggle="tooltip" data-bs-title="month of year"} [10]{.color5by6}. We can obtain a [moy]{.tool data-bs-toggle="tooltip" data-bs-title="month of year"} from a [doy]{.tool data-bs-toggle="tooltip" data-bs-title="day of year"} using @eq-doy2moy or from a POSIX month number using @eq-month2moy.

:::{.overflowequation}
$$\text{moy} = \lfloor(\text{doy} \ast 5 + 2) \div 153\rfloor$$ {#eq-doy2moy}

$$\text{bom} = \lfloor (\text{moy} \times 153 + 2) \div 5 \rfloor - 1$$

$$\text{\text{moy}} = (\text{month} + 9) \bmod 12$$ {#eq-month2moy}

$$\text{\text{month} = (\text{moy} + 3) \bmod  12}$$
:::

$$\text{month} = \begin{cases}\text{moy}+3&{\text{if }\text{moy}\lt 10;}\\\text{moy}-9&{\text{otherwise.}}\end{cases}$$ {#eq-moy2month}
