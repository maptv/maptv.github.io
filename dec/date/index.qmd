...
Christmas🎄is a fixed⚓️holiday because it occurs on the same [doy]{.under .tool data-bs-toggle="tooltip" data-bs-title="day-of-year"}, [Day 299]{.underline .tool data-bs-toggle="tooltip" data-bs-title="December 25"}, every year. Unlike fixed⚓️holidays, Gregorian calendar floating🛟holidays happen on a different [doy]{.under .tool data-bs-toggle="tooltip" data-bs-title="day-of-year"} every year so that their [dow]{.under .tool data-bs-toggle="tooltip" data-bs-title="day-of-week"} can remain constant. Dec uses the [dow]{.under .tool data-bs-toggle="tooltip" data-bs-title="day-of-week"} [delta](https://en.wikipedia.org/wiki/Delta_(letter)#:~:text=the%20difference%20operator) equation, [w~Δ~]{.wine} = ([w~M~]{.wine} - [w~S~]{.wine} + 7) [mod](https://en.wikipedia.org/wiki/Modulo#:~:text=returns%20the%20remainder) 7, to determine which of the seven possible floating🛟holiday dates corresponds to the given year.
...
In the example above, the minuend [\${decoDoty}]{.cyan} has been expanded into the subtrahend [299]{.cyan} and the difference [\${xmasDiff}]{.denim} according to the minuend equation: minuend = subtrahend + difference. If we were preparing for a rocket🚀launch, the minuend would be the current time, the subtrahend would be the planned launch time, and the difference would be the ["T-minus" countdown](https://en.wikipedia.org/wiki/Countdown#:~:text=backward%20counting%20to%20indicate%20the%20time%20remaining%20before%20an%20event).
...
Following the Dec week date pattern described above, we can base Dec dates on any fixed-length calendar unit, including the 20-day [dudek](https://en.wiktionary.org/wiki/dudek#Esperanto:~:text=dudek-,twenty,-Polish%5Bedit), 30-day [tridek](https://en.wiktionary.org/wiki/tridek#Esperanto:~:text=tridek-,thirty,-Categories%3A), 40-day [kvardek](https://en.wiktionary.org/wiki/kvardek#Esperanto:~:text=kvardek-,forty,-Categories%3A), 73-day [sepdektri](https://en.wiktionary.org/wiki/sepdek_tri#Esperanto:~:text=sepdek%20tri-,seventy%2Dthree,-Categories%3A), or 90-day [naŭdek](https://en.wiktionary.org/wiki/na%C5%ADdek). The 10-day [dek](https://en.wiktionary.org/wiki/dek#Esperanto:~:text=dek-,ten%20(10),-Derived%20terms%5B) is the best possible choice, because our [decimal numeral system](https://en.wikipedia.org/wiki/Decimal#:~:text=system%20for%20denoting%20integer%20and%20non%2Dinteger%20numbers) allows us to naturally combine a dek, [\${decoDoty.slice(0, 2)}]{.cyan}, and a [dod]{.under .tool data-bs-toggle="tooltip" data-bs-title="day-of-dek"}, [\${decoDoty[2]}]{.cyan}, into a [doy]{.under .tool data-bs-toggle="tooltip" data-bs-title="day-of-year"}: [\${decoDoty}]{.cyan}.

While weeks are not evenly divisible by two, a dek can be cut✂️into two equal halves called pents. The flowcharts below show Schedule [3]{.green}+[2]{.blue}, the recommended pently schedule of [work]{.green} and [rest]{.blue} days, from two different perspectives. Both flowcharts use [dod]{.under .tool data-bs-toggle="tooltip" data-bs-title="day-of-dek"} numbers, but the bottom one starts from [Dod]{.under .tool data-bs-toggle="tooltip" data-bs-title="day-of-dek"} 1 instead of [Dod]{.under .tool data-bs-toggle="tooltip" data-bs-title="day-of-dek"} 0 and refers to [Dod]{.under .tool data-bs-toggle="tooltip" data-bs-title="day-of-dek"} 0 as [Dod]{.under .tool data-bs-toggle="tooltip" data-bs-title="day-of-dek"} 10.
...
The idea of having two ways to view a dek was inspired by POSIX [dow]{.under .tool data-bs-toggle="tooltip" data-bs-title="day-of-week"} numbers, which can range from [0]{.under .tool data-bs-toggle="tooltip" data-bs-title="Sunday"} to [6]{.under .tool data-bs-toggle="tooltip" data-bs-title="Saturday"} or from [1]{.under .tool data-bs-toggle="tooltip" data-bs-title="Monday"} to [7]{.under .tool data-bs-toggle="tooltip" data-bs-title="Sunday"}. The tables below show the [doys]{.under .tool data-bs-toggle="tooltip" data-bs-title="days-of-year"} of the last pent of a common year and the first pent of the subsequent year. The top table is zero-based and the bottom table is one-based, but both tables show a seamless transition between years.
...
After 4 or 8 years of consecutive pents, the pattern shown in the tables above is interrupted by [Day 365]{.underline .tool data-bs-toggle="tooltip" data-bs-title="February 29"}. This interruption is visualized by the two tables below, which are identical to the tables above except for an extra row in the middle that contains a day, [Day 365]{.underline .tool data-bs-toggle="tooltip" data-bs-title="February 29"} in the top table and [Day 0]{.underline .tool data-bs-toggle="tooltip" data-bs-title="March 1"} in the bottom table, that does not appear to belong to any pent.
...
Officially, [Day 365]{.underline .tool data-bs-toggle="tooltip" data-bs-title="February 29"} is the only day in Pent 73 and [Day 0]{.underline .tool data-bs-toggle="tooltip" data-bs-title="March 1"} is the first day of Pent 0, the bottom row in top table above. Pent 72 is shown in the top row in the top table above and is the last pent of common years. To get the current pent number, ${decoPent}, we double the current dek number, [\${decoDek}]{.cyan}, and then add 1 if the current [dod]{.under .tool data-bs-toggle="tooltip" data-bs-title="day-of-dek"} number, [\${decoDod}]{.cyan}, is greater than 4.

Pent numbers can also be expressed as spans🌈, such as 360=365-5, 360=365, or 360=-5, which represent

Schedule [3]{.green}+[2]{.blue} is part of a group of schedules that allows us to neatly organize [work]{.green} and [rest]{.blue} days into 5 homogeneous columns like in the tables and flowcharts above. In the interest of brevity, we can refer to the different schedules just by their number of work days per pent. Schedule 5 would mean that we are working every day. If we keep each type work days and rest can modify this pattern to change the number of work days in the dek. This may be useful for professional that have a busy season during which the intensity of work is higher than at other times during the year. People can switch between different schedules throughout the year as needed.

312 to 314.
This is equivalent to a  result in too many intensify the work designate [Dod]{.under .tool data-bs-toggle="tooltip" data-bs-title="day-of-dek"} 9 as a work day without changing the transition between years shown in the tables above.
The number of [work]{.green} days per year we obtain from , 219, is about 1 dek more than the 208 to 210 work days provided annually by a 4-day workweek. 

we will have an annual total of 255 work days, which is about 1 pent less than the 260 to 262 work days that we get annually from a 5-day workweek.

Unlike a 4- or 5-day workweek, Schedules [1]{.blue}+[3]{.green}+[1]{.blue} and [1]{.blue}+[3]{.green}+[2]{.blue}+[4]{.green} automatically include rest days at the start and end of every year and thus do not require any holidays to smooth the transition between years. While [Day 365]{.underline .tool data-bs-toggle="tooltip" data-bs-title="February 29"} varies between a work and a rest day in the Gregorian calendar, it is always a rest day in Dec according to both Schedule [1]{.blue}+[3]{.green}+[1]{.blue} and Schedule [1]{.blue}+[3]{.green}+[2]{.blue}+[4]{.green}.

There are 11 United States [Federal holidays](https://www.opm.gov/policy-data-oversight/pay-leave/federal-holidays/). Federal holidays that fall on a Gregorian calendar rest day, [Dow 0]{.under .tool data-bs-toggle="tooltip" data-bs-title="Sunday"} or [Dow 6]{.under .tool data-bs-toggle="tooltip" data-bs-title="Saturday"}, are observed on the nearest Gregorian calendar work day: [Dow 1]{.under .tool data-bs-toggle="tooltip" data-bs-title="Monday"} or [Dow 5]{.under .tool data-bs-toggle="tooltip" data-bs-title="Friday"}. To apply this rule to Schedule [1]{.blue}+[3]{.green}+[1]{.blue}, we would observe the Day [110]{.underline .tool data-bs-toggle="tooltip" data-bs-title="June 19"}⛓️‍💥, [125]{.underline .tool data-bs-toggle="tooltip" data-bs-title="July 4"}🎆, [255]{.underline .tool data-bs-toggle="tooltip" data-bs-title="November 11"}🫡, and [299]{.underline .tool data-bs-toggle="tooltip" data-bs-title="December 25"}🎄holidays on Days [111]{.underline .tool data-bs-toggle="tooltip" data-bs-title="June 20"}⛓️‍💥, [126]{.underline .tool data-bs-toggle="tooltip" data-bs-title="July 5"}🎆, [256]{.underline .tool data-bs-toggle="tooltip" data-bs-title="November 12"}🫡, and [298]{.underline .tool data-bs-toggle="tooltip" data-bs-title="December 26"}🎄, respectively.

# Day of month (dom){#dom}

Dec dates can also be modified to display Dec month and [POSIX [dom]{.under .tool data-bs-toggle="tooltip" data-bs-title="day-of-month"}](https://pubs.opengroup.org/onlinepubs/007904875/utilities/date.html#:~:text=day%20of%20the%20month%20as%20a%20decimal%20number%20%5B01%2C31%5D) numbers. The current Dec [dom]{.under .tool data-bs-toggle="tooltip" data-bs-title="day-of-month"} date is [\${decoYear}]{.yellow}+[\${monthNumber}]{.cyan}+[\${dotm}]{.magenta}. Dec [dom]{.under .tool data-bs-toggle="tooltip" data-bs-title="day-of-month"} dates represent each month with the last [doy]{.under .tool data-bs-toggle="tooltip" data-bs-title="day-of-year"} of the previous month because POSIX [doms]{.under .tool data-bs-toggle="tooltip" data-bs-title="days-of-month"} start from one instead of zero. For zero-based [doms]{.under .tool data-bs-toggle="tooltip" data-bs-title="days-of-month"}, we represent each month with its first [doy]{.under .tool data-bs-toggle="tooltip" data-bs-title="day-of-year"}: [\${decoYear}]{.yellow}+[\${monthNumber0}]{.cyan}+[\${dotm0}]{.magenta}.
