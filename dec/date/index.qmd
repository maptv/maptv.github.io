...
To create a Dec week date, we need two types of Dec date expansion. We use minuend expansion to turn the minuend [d]{.cyan} into subtrahend [d]{.cyan}-[w]{.wine} and the difference [w]{.wine} and then use dividend expansion to convert the dividend [d]{.cyan}-[w]{.wine}+[w~0~]{.wine} into the divisor [W]{.wheat} and the quotient 7.
