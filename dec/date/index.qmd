...
The number of forms that the Gregorian calendar can take, 14, is the product of 7 [dow]{.tool data-bs-toggle="tooltip" data-bs-title="days of week"} and 2 year lengths. If we set aside an extra copy of a printed🖨️Gregorian calendar on [d]{.tool data-bs-toggle="tooltip" data-bs-title="day"}\${january1doy}, we would have to wait 6, 11, 12, 17, 23, 28, or 40 years to use it. To make a printout of a Decalendar leap year apply to any year, we could replace the label for [d]{.tool data-bs-toggle="tooltip" data-bs-title="day"}[365]{.color365by366} with 365 &times; leap.

The lefthand side of @eq-leap, leap, can either be one or zero. If leap is one, Year [y]{.tool data-bs-toggle="tooltip" data-bs-title="year"} is a leap year and 365 &times; leap represents [d]{.tool data-bs-toggle="tooltip" data-bs-title="day"}[365]{.color365by366}, the last day of Year [y]{.tool data-bs-toggle="tooltip" data-bs-title="year"}, but in the case that leap is zero, 365 &times; leap will represent [d]{.tool data-bs-toggle="tooltip" data-bs-title="day"}[0]{.color0} of Year [y]{.tool data-bs-toggle="tooltip" data-bs-title="year"}+1. 


the leap year, [d]{.tool data-bs-toggle="tooltip" data-bs-title="day"}[365]{.color365by366}, and the first 4 days of the subsequent year: [d]{.tool data-bs-toggle="tooltip" data-bs-title="day"}[0]{.color0} to [d]{.tool data-bs-toggle="tooltip" data-bs-title="day"}[3]{.color3by365}..

where leap is . the same numbering  three sets of pid for the last 5 days of [x]{.tool data-bs-toggle="tooltip" data-bs-title="groups of ten days"}36, the final [x]{.tool data-bs-toggle="tooltip" data-bs-title="groups of ten days"} of the year. 

[d]{.tool data-bs-toggle="tooltip" data-bs-title="day"}[365]{.color365by366} and cross it out in common years or leave it out and provide a sticker labelled  that we would add every 4 or 8 years.


[perennial](https://en.wikipedia.org/wiki/Perennial_calendar#:~:text=a%20calendar%20that%20applies%20to%20any%20year%2C%20keeping%20the%20same%20dates) and If we add a note to , 
