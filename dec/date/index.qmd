...
The approximate duration of a season in the Gregorian calendar is 3 months, 13 weeks, or 91 days. The connection between [pid](#pid){.tool data-bs-toggle="tooltip" data-bs-title="positive integer days of year"} and seasonal temperature changes requires [pid](#pid){.tool data-bs-toggle="tooltip" data-bs-title="positive integer days of year"} to reset after Day -1 (d[1]{.overline}), the last day of the Decalendar year. If we do not need to track years or seasons, we can use a single integer called a "day of [era](https://en.wikipedia.org/wiki/Calendar_era#:~:text=the%20period%20of%20time%20elapsed%20since%20one%20epoch%20of%20a%20calendar)" ([doe]{.tool data-bs-toggle="tooltip" data-bs-title="day of era"}) instead of a Dec year+day date.
