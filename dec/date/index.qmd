...
A [mid]{.tool data-bs-toggle="tooltip" data-bs-title="mixed integer day of year"} can show the modular radix complement of a [doh](#doh){.tool data-bs-toggle="tooltip" data-bs-title="days of hectoday"} with its last two digits or that of a [dox](#dox){.tool data-bs-toggle="tooltip" data-bs-title="days of xún"} with its last digit. The four types of [mid]{.tool data-bs-toggle="tooltip" data-bs-title="mixed integer day of year"} are named after the two types of [h]{.tool data-bs-toggle="tooltip" data-bs-title="group of one hundred days"} and the two types of [x]{.tool data-bs-toggle="tooltip" data-bs-title="group of ten days"} and accordingly show the days remaining in the [pih]{.tool data-bs-toggle="tooltip" data-bs-title="positive integer hectoday"}, [nih]{.tool data-bs-toggle="tooltip" data-bs-title="negative integer hectoday"}, "positive integer xún" ([pix](#pix){.tool data-bs-toggle="tooltip" data-bs-title="positive integer xún"}), and "negative integer xún" ([nix](#nix){.tool data-bs-toggle="tooltip" data-bs-title="negative integer xún"}): \${decPihPlus1}[\${decDohPidMidPad}]{.overline}, [\${decNih}]{.overline}\${decDohNidMidPad}, \${decDek}[\${decDotdComp}]{.overline}, and [\${decNix}]{.overline}0 respectively.
