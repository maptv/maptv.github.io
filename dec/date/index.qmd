...
Whereas a pid gives us information on the current [pix](#pix){.tool data-bs-toggle="tooltip" data-bs-title="positive integer xún"} and [pih]{.tool data-bs-toggle="tooltip" data-bs-title="positive integer hectoday"}, an [nid](#nid){.tool data-bs-toggle="tooltip" data-bs-title="negative integer day of year"} tells us about the [nix](#nix){.tool data-bs-toggle="tooltip" data-bs-title="negative integer xún"} and [nih](#nih){.tool data-bs-toggle="tooltip" data-bs-title="negative integer hectoday"} that either are coming up next or began today. The three-digit [nid](#nid){.tool data-bs-toggle="tooltip" data-bs-title="negative integer day of year"} in a year+day Dec date, [\${TminusColor3}]{.overline}, presents an [nih](#nih){.tool data-bs-toggle="tooltip" data-bs-title="negative integer hectoday"} with its first digit: [\${decNihAbsColor}]{.overline}, 
the days until that [nih](#nih){.tool data-bs-toggle="tooltip" data-bs-title="negative integer hectoday"} with its last two digits: \${decDohNidColor1}, an [nix](#nix){.tool data-bs-toggle="tooltip" data-bs-title="negative integer xún"} with its first two digits: [\${decNixAbsColor}]{.overline}, and the days until that [nix](#nix){.tool data-bs-toggle="tooltip" data-bs-title="negative integer xún"} with its final digit: [\${decDoxNidColor}]{.overline}.

An [nih](#nih){.tool data-bs-toggle="tooltip" data-bs-title="negative integer hectoday"} [mid]{.tool data-bs-toggle="tooltip" data-bs-title="mixed integer day of year"}, [\${decNihAbsColor1}]{.overline}\${decDohNidMidPadColor}, shows the current [nih](#nih){.tool data-bs-toggle="tooltip" data-bs-title="negative integer hectoday"} with its first digit: [\${decNihAbsColor2}]{.overline}, a [doh](#doh){.tool data-bs-toggle="tooltip" data-bs-title="days of hectoday"} with its final two digits: \${decDohNidMidPadColor1}, an [nih](#nih){.tool data-bs-toggle="tooltip" data-bs-title="negative integer hectoday"} "mixed integer xún" ([mix](#mix){.tool data-bs-toggle="tooltip" data-bs-title="mixed integer xún"}) with its first two digits: [\${decNihAbsColor3}]{.overline}\${decDohNidMidPad0}, and a [dox](#dox){.tool data-bs-toggle="tooltip" data-bs-title="days of xún"} with its last digit: \${decDoxNidMid}. During [h]{.tool data-bs-toggle="tooltip" data-bs-title="group of one hundred days"}[[1]{.overline}]{.color265by365}, Dec recommends using [nih](#nih){.tool data-bs-toggle="tooltip" data-bs-title="negative integer hectoday"} [mid]{.tool data-bs-toggle="tooltip" data-bs-title="mixed integer day of year"} in lieu of [pid]{.tool data-bs-toggle="tooltip" data-bs-title="positive integer day of year"} for personal timekeeping because [nih](#nih){.tool data-bs-toggle="tooltip" data-bs-title="negative integer hectodays"} [mid]{.tool data-bs-toggle="tooltip" data-bs-title="mixed integer day of year"} take into account the [syl]{.tool data-bs-toggle="tooltip" data-bs-title="solar year length"} and thus avoid any uncertainty regarding the [eoy](#eoy){.tool data-bs-toggle="tooltip" data-bs-title="end of year"}.

Conversion of a [nih](#nih){.tool data-bs-toggle="tooltip" data-bs-title="negative integer hectoday"} [mix](#mix){.tool data-bs-toggle="tooltip" data-bs-title="mixed integer xún"} to a [nix](#nix){.tool data-bs-toggle="tooltip" data-bs-title="negative integer xún"} only requires simple arithmetic: [\${decNihAbsColor4}]{.overline}\${decDohNidMidPad0} = -\${decNihAbsColor5}0 + \${decDohNidMidPad0} = [\${decNix}]{.overline}. If we then append a [dox](#dox){.tool data-bs-toggle="tooltip" data-bs-title="days of xún"}, we get a [nix](#nix){.tool data-bs-toggle="tooltip" data-bs-title="negative integer xún"} [mid]{.tool data-bs-toggle="tooltip" data-bs-title="mixed integer day of year"} like those in @tbl-vincommon: [\${decNix}]{.overline}\${decDoxNidMid}. During a leap year, we should put a grave accent above the [dox](#dox){.tool data-bs-toggle="tooltip" data-bs-title="days of xún"} in [nih](#nih){.tool data-bs-toggle="tooltip" data-bs-title="negative integer hectoday"} and [nix](#nix){.tool data-bs-toggle="tooltip" data-bs-title="negative integer xún"} [mid]{.tool data-bs-toggle="tooltip" data-bs-title="mixed integer days of year"} as in @tbl-vinculeap to facilitate identification of work and rest days according to a Dec schedule like Schedule [L]{.color14by32 .tool data-bs-toggle="tooltip" data-bs-title="duotrigesimal L is decimal 14 or binary 01110"}: [\${decNihGrave}]{.overline}\${decDohGrave0}[\${decDohGrave1}]{.grave} = [\${decNixGrave}]{.overline}[\${decDoxGrave}]{.grave} = [\${decNih}]{.overline}\${decDohNidMidPadColor2} = [\${decNix}]{.overline}\${decDoxNidMid}.

We can see that [h]{.tool data-bs-toggle="tooltip" data-bs-title="group of one hundred days"}\${decPih} is \${decDohPidColor3}% done from the current [pid]{.tool data-bs-toggle="tooltip" data-bs-title="positive integer day of year"}: \${decDotyColor4}, [h]{.tool data-bs-toggle="tooltip" data-bs-title="group of one hundred days"}\${decPihPlus1} will begin after the remaining \${decDohPidMidColor1}% of [h]{.tool data-bs-toggle="tooltip" data-bs-title="group of one hundred days"}\${decPih} expires from the current [pih]{.tool data-bs-toggle="tooltip" data-bs-title="positive integer hectoday"} [mid]{.tool data-bs-toggle="tooltip" data-bs-title="mixed integer day of year"}: \${decPihPlus1}[\${decDohPidMidPad}]{.overline}, [h]{.tool data-bs-toggle="tooltip" data-bs-title="group of one hundred days"}[\${decNixAbsPlus1}]{.overline} will start once the residual \${decDohNidColor2}% of [h]{.tool data-bs-toggle="tooltip" data-bs-title="group of one hundred days"}[\${decNih}]{.overline} elapses from the current [nid](#nid){.tool data-bs-toggle="tooltip" data-bs-title="negative integer day of year"}: [\${TminusColor2}]{.overline}, and [h]{.tool data-bs-toggle="tooltip" data-bs-title="group of one hundred days"}[\${decNih}]{.overline} is \${decDohNidMidPadColor3}% finished from the current [nih](#nih){.tool data-bs-toggle="tooltip" data-bs-title="negative integer hectoday"} [mid]{.tool data-bs-toggle="tooltip" data-bs-title="mixed integer day of year"}: [\${decNih}]{.overline}\${decDohNidMidPadColor4}. The last digit of the [doh](#doh){.tool data-bs-toggle="tooltip" data-bs-title="days of hectoday"} is the [dox](#dox){.tool data-bs-toggle="tooltip" data-bs-title="days of xún"} and the final digit of the 100--[doh](#doh){.tool data-bs-toggle="tooltip" data-bs-title="days of hectoday"} is the (10 -- [dox](#dox){.tool data-bs-toggle="tooltip" data-bs-title="days of xún"}) [mod](https://en.wikipedia.org/wiki/Modulo#:~:text=returns%20the%20remainder) 10.
...
We can learn that the current bimester began \${decDop} days ago on Day [\${decBopSign1}]{.mono}${decBop} by looking at the current year+[bob]{.tool data-bs-toggle="tooltip" data-bs-title="beginning of bimester"}+[dob]{.tool data-bs-toggle="tooltip" data-bs-title="day of bimester"} Dec date: \${decYear}[\${decBopSign}]{.mono}\${decBopPad}[+]{.mono}\${decDopPad}. All bimesters begin with [Dob]{.tool data-bs-toggle="tooltip" data-bs-title="day of bimester"} [0]{.color0} and end with [Dob]{.tool data-bs-toggle="tooltip" data-bs-title="day of bimester"} 58. After 12 or 18 bimesters, a lunar leap day occurs. Dec designates lunar leap days as [Dob]{.tool data-bs-toggle="tooltip" data-bs-title="days of bimester"} [0]{.grave}, which is similar to how solar leap days appear when expressed as [[mi]{.overline}[d]{.grave}]{.tool data-bs-toggle="tooltip" data-bs-title="next mixed integer days of year"}.

Given that a bimester is slightly shorter than two lunations, we expect lunar phases and [dob]{.tool data-bs-toggle="tooltip" data-bs-title="day of bimester"} to slowly drift apart over 2 or 3 lunar years before being put back into alignment by [Dob]{.tool data-bs-toggle="tooltip" data-bs-title="day of bimester"} [0]{.grave}, but we should generally observe a new🌑moon on [Dob]{.tool data-bs-toggle="tooltip" data-bs-title="day of bimester"} 0 and 29, first quarter🌓moon on [Dob]{.tool data-bs-toggle="tooltip" data-bs-title="day of bimester"} 7 and 37, full🌕moon on [Dob]{.tool data-bs-toggle="tooltip" data-bs-title="day of bimester"} 14 and 44, and last quarter🌗moon on [Dob]{.tool data-bs-toggle="tooltip" data-bs-title="day of bimester"} 22 and 52.
...
Dec dates in the year+[bob]{.tool data-bs-toggle="tooltip" data-bs-title="beginning of bimester"}+[dob]{.tool data-bs-toggle="tooltip" data-bs-title="day of bimester"} format allow us to track the lunar phases and then sum the [bob]{.tool data-bs-toggle="tooltip" data-bs-title="beginning of bimester"} and [dob]{.tool data-bs-toggle="tooltip" data-bs-title="day of bimester"} to identify dates using pid, identify seasons using h, gauge progress through the seasons using doh, or classify days as work or rest days using dox. Just as we can split a solar year in 73 p, we can also divide a bimester into 12 "pentadays of bimester" ([pob]{.tool data-bs-toggle="tooltip" data-bs-title="pentadays of bimester"}).

$$\text{pob} = \left\lfloor\dfrac{\text{dob}}{5}\right\rfloor$$ {#eq-pob}

In general, the moon goes from new moon to waxing crescent in [Pob]{.tool data-bs-toggle="tooltip" data-bs-title="Pentaday of bimester"} 0 and 6, from waxing crescent to waxing gibbous in [Pob]{.tool data-bs-toggle="tooltip" data-bs-title="Pentaday of bimester"} 1 and 7, from waxing gibbous to full moon in [Pob]{.tool data-bs-toggle="tooltip" data-bs-title="Pentaday of bimester"} 2 and 8, from full moon to waning gibbous in [Pob]{.tool data-bs-toggle="tooltip" data-bs-title="Pentaday of bimester"} 3 and 9, from waning gibbous to waning crescent in [Pob]{.tool data-bs-toggle="tooltip" data-bs-title="Pentaday of bimester"} 4 and 10, and finally from waning crescent to new moon in [Pob]{.tool data-bs-toggle="tooltip" data-bs-title="Pentaday of bimester"} 5 and 11.

The first quarter moon occurs around the middle of [Pob]{.tool data-bs-toggle="tooltip" data-bs-title="Pentaday of bimester"} 1 and 7, while the last quarter moon appears near the center of [Pob]{.tool data-bs-toggle="tooltip" data-bs-title="Pentaday of bimester"} 4 and 10. Solar common years, lunar leap years, lunar long months, and [x]{.tool data-bs-toggle="tooltip" data-bs-title="groups of ten days"} can be divided evenly into [p](#p){.tool data-bs-toggle="tooltip" data-bs-title="pentadays"}. Solar leap years, lunar common years, lunar short months, and bimesters are all only 1 day off from being evenly divisible by 5.
