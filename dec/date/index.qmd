...
The Darean epoch is 1953+084.41516515, matches the currently used system for [numbering Martian years](https://en.wikipedia.org/wiki/Timekeeping_on_Mars#Year_numbering:~:text=beginning%20May%2024%2C%201953), has the same fractional part as the [Mars Sol Date epoch](https://en.wikipedia.org/wiki/Timekeeping_on_Mars#Mars_Sol_Date:~:text=a%20running%20count%20of%20sols%20since%2029%20December%201873), and coincides with the Martian [northward equinox](https://en.wikipedia.org/wiki/Timekeeping_on_Mars#Definition_of_year_and_seasons:~:text=0-,northward%20equinox,-1%2C%202%2C%203), but is otherwise [arbitrary](https://en.wikipedia.org/wiki/Timekeeping_on_Mars#Year_numbering:~:text=the%20choice%20as-,%22arbitrary%22,-%2C%20the%20great%20dust). I first designed Darean with Martian colonization in mind, but I now believe that we should never send people to Mars.

As our technology improves, the cost of sending robots into space will decrease and the return on investments into robotic missions will increase. In contrast, manned missions will remain expensive and limited by human anatomy and physiology. More importantly, robotic missions are much less likely to contaminate Mars with biological material from Earth.

We need to avoid contamination so as not to complicate the search for extraterrestrial life or traces thereof on Mars. Natural resources should only be collected from Martian sites that can be confirmed to be sterile and never have harbored life. We should first focus exclusively on exploration, then can begin exploitation, but should forever forgo colonization of Mars.

If we explore the entirety of Mars without finding any hints of extraterrestrial life, we should nevertheless reserve Mars for scientific purposes. Assuming that Mars is and has always been devoid of extraterrestrial life, I propose combining Mars with other celestial bodies to create a new planet to better understand how Earth formed and evolved into the world we know today.


(⚶) 

Named after the Ancient Roman goddess of family, hearth, and home,


The combined mass of the Earth and Moon is very close to that of **V**enus, M**e**rcury, Mar**s**, Callis**t**o, and Tit**a**n:
5.972&times;10^24^ + 7.348&times;10^22^ = 6.045588&times;10^24^ &asymp; 6.081434&times;10^24^ = 4.867&times;10^24^ + 3.301&times;10^23^ + 6.417&times;10^23^ + 1.076&times;10^23^ + 1.345&times;10^23^
]
