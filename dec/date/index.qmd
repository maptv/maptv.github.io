...
For simplicity, the flowchart above only shows the conversion of a Dec year into a Gregorian calendar🗓️year and not the inverse. Also not shown are conversion byproducts, such as [coes]{.under .tool data-bs-toggle="tooltip" data-bs-title="cycles-of-era"}, [yocs]{.under .tool data-bs-toggle="tooltip" data-bs-title="years-of-cycle"}, and [docs]{.under .tool data-bs-toggle="tooltip" data-bs-title="days-of-cycle"}, which are only used to convert between Dec dates and [does]{.under .tool data-bs-toggle="tooltip" data-bs-title="days-of-era"}, and [moys]{.under .tool data-bs-toggle="tooltip" data-bs-title="months-of-year"}, which are only used to split [doys]{.under .tool data-bs-toggle="tooltip" data-bs-title="days-of-year"} into months and [doms]{.under .tool data-bs-toggle="tooltip" data-bs-title="days-of-month"} or combine months and [doms]{.under .tool data-bs-toggle="tooltip" data-bs-title="days-of-month"} into [doys]{.under .tool data-bs-toggle="tooltip" data-bs-title="days-of-year"}.

At its heart❤️, Decalendar is a simple system of dates that consist of integer years and days. With minuend expansion, we can easily switch between Dec dates that show [dods]{.under .tool data-bs-toggle="tooltip" data-bs-title="days-of-dek"}, [doms]{.under .tool data-bs-toggle="tooltip" data-bs-title="days-of-month"}, or [dows]{.under .tool data-bs-toggle="tooltip" data-bs-title="days-of-week"}. In this way, minuend expansion enables support for both dekly and weekly schedules, and thus promotes the peaceful coexistence of the Dec and Gregorian calendars🗓️.
