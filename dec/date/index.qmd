...
While weeks are not evenly divisible by two, a dek can be cut✂️into two equal halves called pents. If we follow Schedule [1]{.blue}+[3]{.green}+[1]{.blue},
every pent would start and end with a rest day and have 3 consecutive work days in the middle. The chart below shows the rest days ([Dods]{.under .tool data-bs-toggle="tooltip" data-bs-title="days-of-dek"} 0, 4, 5, and 9) and work days ([Dods]{.under .tool data-bs-toggle="tooltip" data-bs-title="days-of-dek"} 1, 2, 3, 6, 7, and 8) in 1 dek according to Schedule [1]{.blue}+[3]{.green}+[1]{.blue}.
...
Schedule [1]{.blue}+[3]{.green}+[1]{.blue} provides 219 work days every year, which is about 1 dek more than the 208 to 210 work days provided annually by a 4-day workweek. In contrast, Schedule [1]{.blue}+[3]{.green}+[2]{.blue}+[4]{.green} designates [Dod]{.under .tool data-bs-toggle="tooltip" data-bs-title="day-of-dek"} 9 as a work day and has an annual total of 255 work days, which is about 1 pent less than the 260 to 262 work days per year that a 5-day workweek yields.

The table below shows how the transition from a common year to the subsequent year preserves the pattern of consecutive pents. This pattern is interrupted every 4 or 8 years by [Day 365]{.underline .tool data-bs-toggle="tooltip" data-bs-title="February 29"}. While [Day 365]{.underline .tool data-bs-toggle="tooltip" data-bs-title="February 29"} varies between a work and a rest day in the Gregorian calendar, it is always a rest day in Dec according to both Schedule [1]{.blue}+[3]{.green}+[1]{.blue} and Schedule [1]{.blue}+[3]{.green}+[2]{.blue}+[4]{.green}.
