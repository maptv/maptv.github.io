...
The [left-hand side](https://en.wikipedia.org/wiki/Sides_of_an_equation#:~:text=the%20expression%20on%20the%20left%20of%20the%20%22%3D%22%20is%20the%20left%20side%20of%20the%20equation) of @eq-leap, `leap`, can either be one or zero. If `leap` is one, Year [y]{.tool data-bs-toggle="tooltip" data-bs-title="year"} is a leap year and 365 &times; `leap` is [d]{.tool data-bs-toggle="tooltip" data-bs-title="day"}[365]{.color365by366}, the last day of Year [y]{.tool data-bs-toggle="tooltip" data-bs-title="year"}, but in the case that `leap` is zero, Year [y]{.tool data-bs-toggle="tooltip" data-bs-title="year"} is a common year and 365 &times; `leap` is [d]{.tool data-bs-toggle="tooltip" data-bs-title="day"}[0]{.color0} of Year [y]{.tool data-bs-toggle="tooltip" data-bs-title="year"}+1. With 365 &times; `leap`, Decalendar functions like a 
[perennial calendar](https://en.wikipedia.org/wiki/Perennial_calendar#:~:text=a%20calendar%20that%20applies%20to%20any%20year%2C%20keeping%20the%20same%20dates) that can be reused♻️in the same form every year.

In contrast to almost all previous attempts at [calendar reform](https://en.wikipedia.org/wiki/Calendar_reform#cite_ref-15:~:text=a%20proposal%20to%20switch%20to%20a%20different%20calendar%20design), Decalendar does not seek to redefine months and weeks. Instead, Decalendar offers [x]{.tool data-bs-toggle="tooltip" data-bs-title="group of ten days"} as an objectively superior alternative to both months and weeks, but then goes to great lengths to accomodate anyone who wants to continue to use months, weeks, or both. despite the incontrovertible obsolescence of months and weeks.
