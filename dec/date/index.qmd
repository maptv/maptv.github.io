...
In the context of a common year, [p]{.tool data-bs-toggle="tooltip" data-bs-title="pentaday"}[73]{.color73by74} is synonymous with [p]{.tool data-bs-toggle="tooltip" data-bs-title="pentaday"}0 of the succeeding year. To obtain the current [p]{.tool data-bs-toggle="tooltip" data-bs-title="pentaday"}, we double the current [x]{.tool data-bs-toggle="tooltip" data-bs-title="groups of ten days"} and add the current [pox]{.tool data-bs-toggle="tooltip" data-bs-title="pentaday of xún"}, which is 1 if the current [dox]{.tool data-bs-toggle="tooltip" data-bs-title="days of xún"} is greater than 4 and 0 otherwise: ${decPent} = \${decDek} &times; 2 + [\${decDotd} > 4]. If we divide a [pid]{.tool data-bs-toggle="tooltip" data-bs-title="positive integer days of year"} or a [dox]{.tool data-bs-toggle="tooltip" data-bs-title="days of xún"} by 5, the remainder will be its corresponding "day of pentaday" ([dop]{.tool data-bs-toggle="tooltip" data-bs-title="days of pentaday"}): \${decDoty} [mod](https://en.wikipedia.org/wiki/Modulo#:~:text=returns%20the%20remainder) 5 = \${decDotp}. 
...
We can transform an [nid](#nid){.tool data-bs-toggle="tooltip" data-bs-title="negative integer day of year"} into a [mid]{.tool data-bs-toggle="tooltip" data-bs-title="mixed integer day of year"} that shows either the [nih](#nih){.tool data-bs-toggle="tooltip" data-bs-title="negative integer hectoday"} and its [doh](#doh){.tool data-bs-toggle="tooltip" data-bs-title="days of hectoday"} or the "negative integer xún" ([nix](#nix){.tool data-bs-toggle="tooltip" data-bs-title="negative integer xún"}) and its [dox](#dox){.tool data-bs-toggle="tooltip" data-bs-title="days of xún"}: [\${Tminus}]{.overline} = [\${decNih}]{.overline}\${decDohNidMidPad} = [\${decNix}]{.overline}\${decDoxNidMid}. In contrast, an [nid](#nid){.tool data-bs-toggle="tooltip" data-bs-title="negative integer day of year"} displays the [nih](#nih){.tool data-bs-toggle="tooltip" data-bs-title="negative integer hectoday"}+1: [\${decNihPlus1Abs}]{.overline}, [nix](#nix){.tool data-bs-toggle="tooltip" data-bs-title="negative integer xún"}+1: [\${decNixPlus1Abs}]{.overline}, (100--[doh](#doh){.tool data-bs-toggle="tooltip" data-bs-title="days of hectoday"}) [mod](https://en.wikipedia.org/wiki/Modulo#:~:text=returns%20the%20remainder) 100: \${decDohNid}, and (10--[dox](#dox){.tool data-bs-toggle="tooltip" data-bs-title="days of xún"}) [mod](https://en.wikipedia.org/wiki/Modulo#:~:text=returns%20the%20remainder) 10: \${decDoxNid}. Likewise, a [pid]{.tool data-bs-toggle="tooltip" data-bs-title="positive integer day of year"} can be turned into a [mid]{.tool data-bs-toggle="tooltip" data-bs-title="mixed integer day of year"} that shows either the [pih]{.tool data-bs-toggle="tooltip" data-bs-title="positive integer hectoday"}+1 and its 100--[doh](#doh){.tool data-bs-toggle="tooltip" data-bs-title="days of hectoday"} or the [pix](#pix){.tool data-bs-toggle="tooltip" data-bs-title="positive integer xún"}+1 and its 10--[doh](#doh){.tool data-bs-toggle="tooltip" data-bs-title="days of hectoday"}: \${decDoty} = \${decPihPlus1}[\${decDohPidMidPad}]{.overline} = \${decDekPlus1}[\${decDotdModComp}]{.overline}.
