...
When the current pid is the minuend and 299 is the subtrahend, the difference is the number of days *until* [d]{.tool data-bs-toggle="tooltip" data-bs-title="day"}299 if it is negative or the days *since* [d]{.tool data-bs-toggle="tooltip" data-bs-title="day"}299 if it is positive. The current difference tells us that \${Math.abs(xmasDiff)} days \${xmasDiffSince} [d]{.tool data-bs-toggle="tooltip" data-bs-title="day"}299 of this year: \${decYear}+299[\${xmasDiffSign}]{.mono}\${Math.abs(xmasDiff)}. We can then subtract the [dyl]{.tool data-bs-toggle="tooltip" data-bs-title="Decalendar year length"} to get the number of days until [d]{.tool data-bs-toggle="tooltip" data-bs-title="day"}299 of next year: \${nextYear}+299[-]{.mono}\${Math.abs(xmasNext)}.
...
```{r}
doe <- function(year = 1969, doy = 306) {
  coe <- year %/% 400
  yoe <- year - coe * 400
  coe * 146097 +
    yoe * 365 +
...
At its heart❤️, Decalendar is a simple system that measures time solely in integer years and days. A Dec [yoe]{.tool data-bs-toggle="tooltip" data-bs-title="year of era"}+[pid]{.tool data-bs-toggle="tooltip" data-bs-title="positive integer day of year"} date is essentially an abbreviation of [yoe]{.tool data-bs-toggle="tooltip" data-bs-title="year of era"}+[pid]{.tool data-bs-toggle="tooltip" data-bs-title="positive integer day of year"}/[dyl]{.tool data-bs-toggle="tooltip" data-bs-title="Decalendar year length"}, whihc is a math expression that sums the [yoe]{.tool data-bs-toggle="tooltip" data-bs-title="year of era"} with the fraction of the year that has elapsed. The difference between the denominator and the numerator of this fraction is the number of days left in the year.
