...
To convert the current Dec date, ${decoYear}+${decoDoty}, into the
current Dec day of the week (dotw) date,
${decoYear}${dotw0sign}${dotw0doty}+${dotw}, we split the current doty,
${decoDoty}, into the doty of the first day of the current week,
${dotw0doty}, and the current POSIX weekday number: ${dotw}.
...
current doty <span class="cyan">d</span>, ${styledDecoDoty6}, by
...
length <span class="orange">n</span>:
${styledDecoDoty7}=${styledFracYear2}×${styledNdays1}.
