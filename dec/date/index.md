...
the Dec dote equation above, are based on the [`days_from_civil`
algorithm](https://howardhinnant.github.io/date_algorithms.html#days_from_civil)
...
In addition to the cote and yotc, the Dec date equations use the day of
...
To find <span class="orange">n</span>, we plug the subsequent year
(⌊<span class="yellow">y</span>⌋+1) into the Dec year length equation:
...
addition, so we can see <span class="magenta">m</span>. We can combine
the dotm and dotw patterns above to create hybrid Dec dates:
