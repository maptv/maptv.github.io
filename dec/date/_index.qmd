...
div.cell-output-display:has(.doxdiagram) {
  margin-top: -45px;
  margin-top: -45px;
}
...
div.cell-output-display:has(svg#fig-zero-mermaid.flowchart.mermaid-js) {
  margin-top: -15px;
}
div.cell-output-display:has(svg#fig-one-mermaid.flowchart.mermaid-js) {
  margin-top: -5px;
  margin-bottom: -5px;
}
div.cell-output-display:has(svg#fig-conv-mermaid.flowchart.mermaid-js) {
  margin-top: -15px;
  margin-bottom: -15px;
}
