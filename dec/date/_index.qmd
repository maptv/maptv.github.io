...
function leftRanin() {
  const [top, btm] = rotatePair(ranintop, raninbtm, multiplier, true, shiftOrRotateRadio)
  set(viewof ranintop, top)
  set(viewof raninbtm, btm)
}
function rightRanin() {
  const [top, btm] = rotatePair(ranintop, raninbtm, multiplier, false, shiftOrRotateRadio)
  set(viewof ranintop, top)
  set(viewof raninbtm, btm)
}
