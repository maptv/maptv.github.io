...
dotwColor5 = textcolor(dowDice[dotw], dotwPiece)
dotwColor6 = textcolor(dotw, dotwPiece)
...
weekColor2 = textcolor(woyCards[week], dotw0dotyPiece)
...
dotyInputDekColor1 = textcolor(dotyInputDek.toString().padStart(2, "0"), dotyInputDekPiece)
dotyInputDekColor2 = textcolor(Math.round(d3.hsl(dotyInputDekPiece).h).toString().padStart(3, "0"), dotyInputDekPiece)
dotyInputDekColor3 = textcolor(dotyInputDekD3rgb.formatHex(), dotyInputDekPiece)
dotyInputDekColor4 = textcolor(dotyInputDekD3rgb.r.toString().padStart(3, "0"), dotyInputDekPiece)
dotyInputDekColor5 = textcolor(dotyInputDekD3rgb.b.toString().padStart(3, "0"), dotyInputDekPiece)
dotyInputDekColor6 = textcolor(dotyInputDekD3rgb.g.toString().padStart(3, "0"), dotyInputDekPiece)
...
dotyInputDodColor1 = textcolor(dotyInputDod, dotyInputDodPiece)
dotyInputDodColor2 = textcolor(Math.round(d3.hsl(dotyInputDodPiece).h).toString().padStart(3, "0"), dotyInputDodPiece)
dotyInputDodColor3 = textcolor(dotyInputDodD3rgb.formatHex(), dotyInputDodPiece)
dotyInputDodColor4 = textcolor(dotyInputDodD3rgb.r.toString().padStart(3, "0"), dotyInputDodPiece)
dotyInputDodColor5 = textcolor(dotyInputDodD3rgb.b.toString().padStart(3, "0"), dotyInputDodPiece)
dotyInputDodColor6 = textcolor(dotyInputDodD3rgb.g.toString().padStart(3, "0"), dotyInputDodPiece)
...
dotyInputColor1 = textcolor(dotyInput.toString().padStart(3, "0"), dotyInputPiece)
dotyInputColor2 = textcolor(Math.round(d3.hsl(dotyInputPiece).h).toString().padStart(3, "0"), dotyInputPiece)
dotyInputColor3 = textcolor(dotyInputD3rgb.formatHex(), dotyInputPiece)
dotyInputColor4 = textcolor(dotyInputD3rgb.r.toString().padStart(3, "0"), dotyInputPiece)
dotyInputColor5 = textcolor(dotyInputD3rgb.b.toString().padStart(3, "0"), dotyInputPiece)
dotyInputColor6 = textcolor(dotyInputD3rgb.g.toString().padStart(3, "0"), dotyInputPiece)
