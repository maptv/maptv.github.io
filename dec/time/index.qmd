...
need to  input to be in turns instead of radians. The code below shows how sintau() and costau(), we do not have to multiply [toy]{.tool data-bs-toggle="tooltip" data-bs-title="time of year"}  make it clear below shows Programming languages that have a  the [eot]{.tool data-bs-toggle="tooltip" data-bs-title="equation of time"}, we may need to multiply the [toy]{.tool data-bs-toggle="tooltip" data-bs-title="time of year"} by 2, 360, or &tau;. expect their input to be turns, we
All of the equations that above assume that the tod is .  To obtain the  we need to plug into the [eot]{.tool data-bs-toggle="tooltip" data-bs-title="equation of time"}
In Dec, solar time is shifted by 0.5 [d&lambda;]{.tool data-bs-toggle="tooltip" data-bs-title="deciparallels"} to the West with respect to our [d&lambda;]{.tool data-bs-toggle="tooltip" data-bs-title="deciparallel"} longitude so that our [tod]{.tool data-bs-toggle="tooltip" data-bs-title="solar time offset"} will match our [mst]{.tool data-bs-toggle="tooltip" data-bs-title="time zone offset"} when we are at the center of a Dec time zone and so that our [tzo]{.tool data-bs-toggle="tooltip" data-bs-title="time zone offset"} is always the first digit of our longitude.

 is based on the [National Oceanic and Atmospheric Administration](https://www.noaa.gov) ([NOAA]{.tool data-bs-toggle="tooltip" data-bs-title="National Oceanic and Atmospheric Administration"}) [General Solar Position Calculations](https://gml.noaa.gov/grad/solcalc/solareqns.PDF) document.
...
The sum of our zonal [tzo]{.tool data-bs-toggle="tooltip" data-bs-title="time zone offset"} and the current Zone [0]{.color0} [tod]{.tool data-bs-toggle="tooltip" data-bs-title="time of day"} is our zonal time. The difference between a zonal [tzo]{.tool data-bs-toggle="tooltip" data-bs-title="time zone offset"} and a solar [tzo]{.tool data-bs-toggle="tooltip" data-bs-title="time zone offset"} is a "solar time offset" ([sto]{.tool data-bs-toggle="tooltip" data-bs-title="solar time offset"}).
