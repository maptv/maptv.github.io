...
The line📈chart above uses [md]{.tool data-bs-toggle="tooltip" data-bs-title="millidays"} to display [eot]{.tool data-bs-toggle="tooltip" data-bs-title="equation of time"}([toy]{.tool data-bs-toggle="tooltip" data-bs-title="time of year"}) values as integers. If we want the equation below to yield [md]{.tool data-bs-toggle="tooltip" data-bs-title="millidays"}, we set [n](https://en.wikipedia.org/wiki/Power_of_10#:~:text=1'%20followed%20by-,n%20zeroes,-.%20It%20can%20also) to three. To calculate the [tod]{.tool data-bs-toggle="tooltip" data-bs-title="time of day"} of [solar noon](https://en.wikipedia.org/wiki/Noon#:~:text=reaching%20its%20highest%20position%20above%20the%20horizon%20on%20that%20day%20and%20casting%20the%20shortest%20shadow), the equation adds 9.55 to a longitude measured in &lambda;, subtracts two values measured in days, [tzo]{.tool data-bs-toggle="tooltip" data-bs-title="time zone offset"} and a eot([toy]{.tool data-bs-toggle="tooltip" data-bs-title="time of year"}, discards the integer part, and multiplies by the [nth power of ten](https://en.wikipedia.org/wiki/Power_of_10#:~:text=decimal%20notation%20the-,nth%20power%20of%20ten,-is%20written%20as).

$$\text{noon} = (9.55 + \text{tzo} - \lambda - \text{eot(toy)) mod 1} \times 10^\text{n}$$

To compare the solar noon [tod]{.tool data-bs-toggle="tooltip" data-bs-title="time of day"} in two cities, we can plug in the longitude of each city into the equation above. If all the variables in the equation other than longitude are set to zero, solar noon is almost five decidays for [Cambridge, England]() in the [United Kingdom]() and nearly seven decidays for [Cambridge, Massachusetts]() in the [United States](). Essentially, the tzo determines the frame of reference. From the perspective of Zone 8 

$$4.99635 = (9.55 - 0.050365) \text{ mod 1} \times 10$$

$$6.97516 = (9.55 - 0.852484) \text{ mod 1} \times 10$$

If we change the [tzo]{.tool data-bs-toggle="tooltip" data-bs-title="time zone offset"} from zero to eight decidays, solar noon is near three decidays for [Cambridge, England]() and almost five decidays for [Cambridge, Massachusetts](). 

$$2.99635 = (9.55 + 0.8 - 0.050365) \text{ mod 1} \times 10$$

$$4.97516 = (9.55 + 0.8 - 0.852484) \text{ mod 1} \times 10$$

Each cities is near the middle of its time zone. The English city is near the middle of Zone 0 () and the American city is near the middle of Zone 8 (0.852484 &lambda;). Cambridge, Massachusetts is Given that midnight is zero and midday is five decidays, the result will make sense from the perspective of . For Cambridge, England, we get (9.55 - 0.050365) mod 1 = 0.499635, which is very close to 500 [md]{.tool data-bs-toggle="tooltip" data-bs-title="millidays"}. For Cambridge, Massachusetts, the result is (9.55 - 0.852484) mod 1 = 0.697516, which is nearly 700 [md]{.tool data-bs-toggle="tooltip" data-bs-title="millidays"}. 

## Solar declination angle {.hiddenheading #sda}

Once we have [eot]{.tool data-bs-toggle="tooltip" data-bs-title="equation of time"}([toy]{.tool data-bs-toggle="tooltip" data-bs-title="time of year"}), we can find the Zone [0]{.color0} [tod]{.tool data-bs-toggle="tooltip" data-bs-title="time of day"} of [solar noon](https://en.wikipedia.org/wiki/Noon#:~:text=reaching%20its%20highest%20position%20above%20the%20horizon%20on%20that%20day%20and%20casting%20the%20shortest%20shadow) by subtracting a longitude measured in &lambda; and [eot]{.tool data-bs-toggle="tooltip" data-bs-title="equation of time"}(toy) from 9.55, a constant which shifts . Before we can find the sunrise and sunset [tod]{.tool data-bs-toggle="tooltip" data-bs-title="time of day"}, we first need to calculate the solar declination angle ([sda]{.tool data-bs-toggle="tooltip" data-bs-title="solar declination angle"}). For simplicity, we can use the same math for the [eot]{.tool data-bs-toggle="tooltip" data-bs-title="equation of time"} and [sda]{.tool data-bs-toggle="tooltip" data-bs-title="solar declination angle"}, even though the [NOAA]{.tool data-bs-toggle="tooltip" data-bs-title="National Oceanic and Atmospheric Administration"} [General Solar Position Calculations](https://gml.noaa.gov/grad/solcalc/solareqns.PDF) propose the more complex model shown below.
