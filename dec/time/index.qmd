...
Together, a [doy]{.tool data-bs-toggle="tooltip" data-bs-title="day of year"} and [tod]{.tool data-bs-toggle="tooltip" data-bs-title="time of day"} can form a "annual day aggregate" ([ada]{.tool data-bs-toggle="tooltip" data-bs-title="annual day aggregate"}): \${selAdaDay}.
...
As their names suggest, [doys]{.tool data-bs-toggle="tooltip" data-bs-title="days of year"} and [adas]{.tool data-bs-toggle="tooltip" data-bs-title="annual day aggregates"} are measured in days. The [measurement unit](https://en.wikipedia.org/wiki/Unit_of_measurement#:~:text=a%20definite%20magnitude%20of%20a%20quantity) of a [tod]{.tool data-bs-toggle="tooltip" data-bs-title="time of day"} can be a day or a [submultiple](https://en.wikipedia.org/wiki/Multiple_%28mathematics%29#Submultiple:~:text=of%20%22a%20being-,a%20unit%20fraction,-of%20b%22%20) of a day. By changing how a decimal [tod]{.tool data-bs-toggle="tooltip" data-bs-title="time of day"} is measured, we can shift its [decimal separator](https://en.wikipedia.org/wiki/Decimal_separator#:~:text=a%20symbol%20that%20separates%20the%20integer%20part%20from%20the%20fractional%20part%20of%20a%20number) or turn it into an integer. The [tods]{.tool data-bs-toggle="tooltip" data-bs-title="times of day"} along the y-axis of the area chart are integers because they have three digits and are measured in [millidays]{.tool data-bs-toggle="tooltip" data-bs-title="thousandths of a day"}.

## Epochal day aggregate (eda) {#eda .hiddenheading}

To obtain a [tod]{.tool data-bs-toggle="tooltip" data-bs-title="time of day"} from a [ada]{.tool data-bs-toggle="tooltip" data-bs-title="annual day aggregate"}, we can [keep the remainder after dividing](https://en.wikipedia.org/wiki/Modulo#:~:text=returns%20the%20remainder) by one to isolate the [decimal part](https://en.wikipedia.org/wiki/Fractional_part#:~:text=the%20excess%20beyond%20that%20number%27s%20integer%20part) of the [quotient](https://en.wikipedia.org/wiki/Quotient#:~:text=a%20quantity%20produced%20by%20the%20division%20of%20two%20numbers): \${zeroAdaHsl} [mod](https://en.wikipedia.org/wiki/Modulo#:~:text=returns%20the%20remainder) 1 = \${zeroTimeHsl0}. We can use this same approach to separate a [tod]{.tool data-bs-toggle="tooltip" data-bs-title="time of day"} from an "epochal day aggregate" ([eda]{.tool data-bs-toggle="tooltip" data-bs-title="epochal day aggregate"}): \${zeroDoteHsl} mod 1 = \${zeroTimeHsl1}. The current [eda]{.tool data-bs-toggle="tooltip" data-bs-title="epochal day aggregate"} tells us how many days have passed since the Dec [epoch](https://en.wikipedia.org/wiki/Epoch#:~:text=an%20instant%20in%20time%20chosen%20as%20the%20origin%20of%20a%20particular%20calendar%20era).
...
The Dec doe equations We can describe an "epochal year aggregate" ([eya]{.tool data-bs-toggle="tooltip" data-bs-title="epochal year aggregate"}) instead of a [yoe]{.tool data-bs-toggle="tooltip" data-bs-title="year of era"}, 

When provided with an "epochal day aggregate" ([eda]{.tool data-bs-toggle="tooltip" data-bs-title="epochal day aggregate"}) instead of a [doe]{.tool data-bs-toggle="tooltip" data-bs-title="day of era"}, the Dec date equations return a "annual day aggregate" ([ada]{.tool data-bs-toggle="tooltip" data-bs-title="annual day aggregate"}) instead of a [doy]{.tool data-bs-toggle="tooltip" data-bs-title="day of year"}. While [does]{.tool data-bs-toggle="tooltip" data-bs-title="days of era"} and [doys]{.tool data-bs-toggle="tooltip" data-bs-title="days of year"} are integers, [edas]{.tool data-bs-toggle="tooltip" data-bs-title="epochal day aggregate"} and [adas]{.tool data-bs-toggle="tooltip" data-bs-title="annual day aggregates"} each have a decimal part called a "time of day" ([tod]{.tool data-bs-toggle="tooltip" data-bs-title="time of day"}). We can obtain an [eda]{.tool data-bs-toggle="tooltip" data-bs-title="epochal day aggregate"} by passing a [yoe]{.tool data-bs-toggle="tooltip" data-bs-title="year of era"} and [ada]{.tool data-bs-toggle="tooltip" data-bs-title="annual day aggregate"} to the Dec eda equations or by summing a [doe]{.tool data-bs-toggle="tooltip" data-bs-title="day of era"} and a [tod]{.tool data-bs-toggle="tooltip" data-bs-title="time of day"}. isolate a [tod]{.tool data-bs-toggle="tooltip" data-bs-title="time of day"} from an [eda]{.tool data-bs-toggle="tooltip" data-bs-title="epochal day aggregate"} or [ada]{.tool data-bs-toggle="tooltip" data-bs-title="annual day aggregate"}, and convert between a doe and [eda]{.tool data-bs-toggle="tooltip" data-bs-title="epochal day aggregate"} or a [doy]{.tool data-bs-toggle="tooltip" data-bs-title="day of year"} and [ada]{.tool data-bs-toggle="tooltip" data-bs-title="annual day aggregate"}.
...
The Equator is approximately ([~]{.tool data-bs-toggle="tooltip" data-bs-title="approximately"}) [10^3^]{.tool data-bs-toggle="tooltip" data-bs-title="one thousand"} [millitaurs]{.tool data-bs-toggle="tooltip" data-bs-title="thousandths of a taur"} ([mc]{.tool data-bs-toggle="tooltip" data-bs-title="millitaurs"}), [~]{.tool data-bs-toggle="tooltip" data-bs-title="approximately"}4 &times; [10^4^]{.tool data-bs-toggle="tooltip" data-bs-title="ten thousand"} [kilometers]{.tool data-bs-toggle="tooltip" data-bs-title="thousands of meters"} ([km]{.tool data-bs-toggle="tooltip" data-bs-title="kilometers"}), or [~]{.tool data-bs-toggle="tooltip" data-bs-title="approximately"}[10^5^]{.tool data-bs-toggle="tooltip" data-bs-title="a hundred thousand"} [kilozems]{.tool data-bs-toggle="tooltip" data-bs-title="thousands of zone equatorial meters"} ([kz]{.tool data-bs-toggle="tooltip" data-bs-title="kilozems"}) long. If we move 1 [mc]{.tool data-bs-toggle="tooltip" data-bs-title="millitaurs"}, 40 [km]{.tool data-bs-toggle="tooltip" data-bs-title="kilometers"}, or 100 [kz]{.tool data-bs-toggle="tooltip" data-bs-title="kilozems"} to the East or West on or near the Equator, our [sto]{.tool data-bs-toggle="tooltip" data-bs-title="solar time offset"} will change by [~]{.tool data-bs-toggle="tooltip" data-bs-title="approximately"}1 [md]{.tool data-bs-toggle="tooltip" data-bs-title="millidays"}, [~]{.tool data-bs-toggle="tooltip" data-bs-title="approximately"}1.44 minutes, or [~]{.tool data-bs-toggle="tooltip" data-bs-title="approximately"}100 [b]{.tool data-bs-toggle="tooltip" data-bs-title="beat"} and our longitude will shift by [~]{.tool data-bs-toggle="tooltip" data-bs-title="approximately"}0.36 degrees, [~]{.tool data-bs-toggle="tooltip" data-bs-title="approximately"}1 milliparallel ([m&lambda;]{.tool data-bs-toggle="tooltip" data-bs-title="milliparallel"}), [~]{.tool data-bs-toggle="tooltip" data-bs-title="approximately"}21.6 [arcminutes](https://en.wikipedia.org/wiki/Minute_and_second_of_arc){.tool data-bs-toggle="tooltip" data-bs-title="a sixtieth of a degree"}, or [~]{.tool data-bs-toggle="tooltip" data-bs-title="approximately"}100 arcbeats ([ab]{.tool data-bs-toggle="tooltip" data-bs-title="arcbeats"}).
...
## Full day arc {.hiddenheading #fda}

The path in the sky that the Sun appears to follow from a sunrise to a sunset is a "[day arc](https://en.wikipedia.org/wiki/Sun_path#:~:text=arc%2Dlike%20path%20that%20the%20Sun%20appears%20to%20follow%20across%20the%20sky)" ([da]{.tool data-bs-toggle="tooltip" data-bs-title="full day arc"}). Solar noon, the midpoint of a [da]{.tool data-bs-toggle="tooltip" data-bs-title="day arc"}, is halfway between sunrise and sunset. On each side of solar noon is a "half day arc" ([da/2]{.tool data-bs-toggle="tooltip" data-bs-title="half day arc"}). The sum of a solar noon [tod]{.tool data-bs-toggle="tooltip" data-bs-title="time of day"} and a [da/2]{.tool data-bs-toggle="tooltip" data-bs-title="half day arc"} is a sunset [tod]{.tool data-bs-toggle="tooltip" data-bs-title="time of day"} and the difference between a solar noon [tod]{.tool data-bs-toggle="tooltip" data-bs-title="time of day"} and a [da/2]{.tool data-bs-toggle="tooltip" data-bs-title="half day arc"} is a sunrise [tod]{.tool data-bs-toggle="tooltip" data-bs-title="time of day"}.
...
## Full night arc {.hiddenheading #fna}

The Sun continues its path after it disappears below the horizon, moving from sunset to sunrise along a "night arc" ([na]{.tool data-bs-toggle="tooltip" data-bs-title="night arc"}). Like [conjugate angles](https://en.wikipedia.org/wiki/Angle#:~:text=conjugate%20angles%20sum%20to%20a%20full%20angle), a [da]{.tool data-bs-toggle="tooltip" data-bs-title="day arc"} and a [na]{.tool data-bs-toggle="tooltip" data-bs-title="night arc"} form a full circle that represents one day. Likewise, a [da/2]{.tool data-bs-toggle="tooltip" data-bs-title="half day arc"} and a "half night arc" ([na/2]{.tool data-bs-toggle="tooltip" data-bs-title="half night arc"}) are like two [supplementary angles](https://en.wikipedia.org/wiki/Angle#:~:text=sum%20to%20a%20straight%20angle) that form a semicircle from solar noon to the [na]{.tool data-bs-toggle="tooltip" data-bs-title="night arc"} midpoint: [solar midnight](https://en.wikipedia.org/wiki/Midnight#:~:text=the%20time%20opposite%20to%20solar%20noon%2C%20when%20the%20Sun%20is%20closest%20to%20the%20nadir%2C%20and%20the%20night%20is%20equidistant%20from%20dusk%20and%20dawn).

:::{.overflowequation style="overflow-x:auto;overflow-y:hidden;"}
$$\text{solarmidnight} = \text{solarnoon} + \frac{\text{da}}{2} + \frac{\text{na}}{2} = \text{sunset} + \frac{\text{na}}{2}$$
:::

The range input below controls the yellow [da]{.tool data-bs-toggle="tooltip" data-bs-title="day arc"} and the blue [na]{.tool data-bs-toggle="tooltip" data-bs-title="night arc"} in the diagram beneath it. At the Equator, the sunrise always rises about a quarter turn from North and sets around three quarter turns from North, resulting in a [da]{.tool data-bs-toggle="tooltip" data-bs-title="day arc"} of approximately half a day: 75% -- 25% = 50%. If [da]{.tool data-bs-toggle="tooltip" data-bs-title="day arc"} is zero, a [polar night](https://en.wikipedia.org/wiki/Polar_night#:~:text=the%20Sun%20remains%20below%20the%20horizon%20for%20more%20than%2024%C2%A0hours) occurs. A day without a [na]{.tool data-bs-toggle="tooltip" data-bs-title="night arc"} is called a [polar day](https://en.wikipedia.org/wiki/Midnight_sun#:~:text=the%20Sun%20remains%20visible%20at%20the%20local%20midnight).
...
Anyone can measure the [saa]{.tool data-bs-toggle="tooltip" data-bs-title="solar azimuth angle"} during the daytime by pointing a compass at the point on the horizon below the Sun. In the Northern Hemisphere, we can use this method to approximate solar time. In the Southern Hemisphere, we can obtain solar time by measuring the [saa]{.tool data-bs-toggle="tooltip" data-bs-title="solar azimuth angle"} in turns and then subtracting our measurement from one and a half turns:
...
If we only want to know how long the Sun will shine on a given day, we can use the top equation below to obtain a [da]{.tool data-bs-toggle="tooltip" data-bs-title="day arc"}. Alternatively, if we are interested in finding out when the Sun will rise or set on a given day, we will need to calculate a [da/2]{.tool data-bs-toggle="tooltip" data-bs-title="half day arc"} using the bottom equation below and then combine it with a solar noon [tod]{.tool data-bs-toggle="tooltip" data-bs-title="time of day"} to get a sunrise or sunset [tod]{.tool data-bs-toggle="tooltip" data-bs-title="time of day"}.
...
The [da]{.tool data-bs-toggle="tooltip" data-bs-title="day arc"} and [da/2]{.tool data-bs-toggle="tooltip" data-bs-title="half day arc"} equations above require a latitude and a "solar [declination](https://en.wikipedia.org/wiki/Declination#:~:text=one%20of%20the%20two%20angles%20that%20locate%20a%20point%20on%20the%20celestial%20sphere%20in%20the%20equatorial%20coordinate%20system) angle" ([sda]{.tool data-bs-toggle="tooltip" data-bs-title="solar declination angle"}). Dec measures latitude in turns called meridians ([&phi;]{.tool data-bs-toggle="tooltip" data-bs-title="meridians"}) or turn submultiples such as millimeridians ([m&phi;]{.tool data-bs-toggle="tooltip" data-bs-title="millimeridians"}). For simplicity, we can fit our [eot]{.tool data-bs-toggle="tooltip" data-bs-title="equation of time"} model to [sda]{.tool data-bs-toggle="tooltip" data-bs-title="solar declination angle"} data instead of fitting the needlessly complex [sda]{.tool data-bs-toggle="tooltip" data-bs-title="solar declination angle"} model provided by the NOAA General Solar Position Calculations:
...
The top range input below picks the [doy]{.tool data-bs-toggle="tooltip" data-bs-title="day of year"} that will become the [toy]{.tool data-bs-toggle="tooltip" data-bs-title="time of year"} in our fitted [sda]{.tool data-bs-toggle="tooltip" data-bs-title="solar declination angle"} model. The other two range inputs below chose the geographic coordinates that we need to find the sunrise and sunset [tods]{.tool data-bs-toggle="tooltip" data-bs-title="times of day"}. While the sunrise and sunset [tods]{.tool data-bs-toggle="tooltip" data-bs-title="times of day"} depend on both geographic coordinates, the [da]{.tool data-bs-toggle="tooltip" data-bs-title="day arc"} varies only by latitude and not by longitude: ${selectedSunset.toFixed(3)} -- ${selectedSunrise.toFixed(3)} = \${parseFloat(daytimeDuration.toFixed(3))}.
...
The equation controlled by range inputs above can be summarized as sunset -- sunrise = [da]{.tool data-bs-toggle="tooltip" data-bs-title="day arc"} and can be rearranged into the sunrise equation: sunrise = sunset -- [da]{.tool data-bs-toggle="tooltip" data-bs-title="day arc"}. If we plug the current [tod]{.tool data-bs-toggle="tooltip" data-bs-title="time of day"} in place of the sunrise [tod]{.tool data-bs-toggle="tooltip" data-bs-title="time of day"} in the sunrise equation without changing the sunset [tod]{.tool data-bs-toggle="tooltip" data-bs-title="time of day"}, the [da]{.tool data-bs-toggle="tooltip" data-bs-title="day arc"} will be replaced with the time until or since sunset: ${selectedCurrent.toFixed(3)} = ${selectedSunset.toFixed(3)} ${selectedDifference < 0 ? "--" : "+"} ${parseFloat(Math.abs(selectedDifference).toFixed(3))}.
...
When the minuend is the current time and the subtrahend is the [timestamp](https://en.wikipedia.org/wiki/Timestamp#:~:text=a%20sequence%20of%20characters%20or%20encoded%20information%20identifying%20when%20a%20certain%20event%20occurred) of an event which occurred in the past, the difference is the time elapsed since that event. A Dec timestamp consists of a year, a day, . can be an [eda]{.tool data-bs-toggle="tooltip" data-bs-title="epochal day aggregate"}, a "epochal year aggregate" ([eya]{.tool data-bs-toggle="tooltip" data-bs-title="epochal year aggregate"}), or a snap🫰. Edas and eyas are  the time The typical snap format is year[+]{.mono}[ada]{.tool data-bs-toggle="tooltip" data-bs-title="annual day aggregate"}[-]{.mono}[tzo]{.tool data-bs-toggle="tooltip" data-bs-title="time zone offset"}. The snap \${loadYearHsl}[+]{.mono}\${loadAdaHsl}[-]{.mono}[0]{.color0} represents the [b]{.tool data-bs-toggle="tooltip" data-bs-title="beat"} when this webpage loaded ${elaTimeHsl} [b]{.tool data-bs-toggle="tooltip" data-bs-title="beats"} ago.

# Epochal year aggregate (eya){#eya}

A [doe]{.tool data-bs-toggle="tooltip" data-bs-title="day of era"} is essentially a Dec date with a [yoe]{.tool data-bs-toggle="tooltip" data-bs-title="year of era"} that is always equal to 0 and a [doy]{.tool data-bs-toggle="tooltip" data-bs-title="day of year"} that is [not restricted](https://en.wikipedia.org/wiki/Bounded_set#:~:text=a%20set%20which%20is%20not%20bounded) to 0 &le; [doy]{.tool data-bs-toggle="tooltip" data-bs-title="day of year"} &le; 365. Similarly, a Dec "epochal year aggregate" ([eya]{.tool data-bs-toggle="tooltip" data-bs-title="epochal year aggregate"}) is basically a Dec date with a non-integer year and a day permanently set to [0]{.color0}. We can obtain a Dec date by passing a doe Both [does]{.tool data-bs-toggle="tooltip" data-bs-title="days of era"} and [eyas]{.tool data-bs-toggle="tooltip" data-bs-title="epochal year aggregates"} allow us to represent a date as a single number and obtain the difference between two dates.
...
Compared to a [doe]{.tool data-bs-toggle="tooltip" data-bs-title="day of era"}, it is much easier to convert between an [eya]{.tool data-bs-toggle="tooltip" data-bs-title="epochal year aggregate"} and a to turn into Dec dates. The decimal part of an [eya]{.tool data-bs-toggle="tooltip" data-bs-title="epochal year aggregate"} is a called a [toy]{.tool data-bs-toggle="tooltip" data-bs-title="epochal year aggregate"}. We can convert between dates to [eyas]{.tool data-bs-toggle="tooltip" data-bs-title="epochal year aggregates"} with the equations below. We can obtain a [yoe]{.tool data-bs-toggle="tooltip" data-bs-title="year of era"} by flooring an [eya]{.tool data-bs-toggle="tooltip" data-bs-title="epochal year aggregate"}. Likewise, we can obtain a [doy]{.cyan .under .tool data-bs-toggle="tooltip" data-bs-title="day of year"} by flooring the product of [n]{.tool data-bs-toggle="tooltip" data-bs-title="number of days in the year"} and the decimal part of an [eya]{.tool data-bs-toggle="tooltip" data-bs-title="epochal year aggregate"}, which is called a [toy]{.tool data-bs-toggle="tooltip" data-bs-title="epochal year aggregate"}. The current [eya]{.tool data-bs-toggle="tooltip" data-bs-title="epochal year aggregate"} equation values are \${fullfracYear} = \${decYear} + \${decDoty} &div; \${nDaysInYear}. We can floor an [eya]{.tool data-bs-toggle="tooltip" data-bs-title="epochal year aggregate"} to get a yoe or divide its , we can obtain a 
...
[eya]{.tool data-bs-toggle="tooltip" data-bs-title="epochal year aggregate"} = [yoe]{.tool data-bs-toggle="tooltip" data-bs-title="year of era"} + [doy]{.tool data-bs-toggle="tooltip" data-bs-title="day of year"} &div; [n]{.tool data-bs-toggle="tooltip" data-bs-title="number of days in the year"}. 

We can omit the year from a snap if we replace the [ada]{.tool data-bs-toggle="tooltip" data-bs-title="annual day aggregate"} with a subtrahend and a difference or just a difference. If needed, we can obtain a snap from a difference using the equations below. First, we subtract the difference from the current [eda]{.tool data-bs-toggle="tooltip" data-bs-title="epochal day aggregate"} to obtain the "[eda]{.tool data-bs-toggle="tooltip" data-bs-title="epochal day aggregate"} difference difference" ([edd]{.tool data-bs-toggle="tooltip" data-bs-title="eda difference difference"}). Then, we use the [edd]{.tool data-bs-toggle="tooltip" data-bs-title="eda difference difference"} to get the "cycle of era" ([coe]{.tool data-bs-toggle="tooltip" data-bs-title="cycle of era"}), "day of cycle" ([doc]{.tool data-bs-toggle="tooltip" data-bs-title="day of cycle"}), "year of cycle" ([yoc]{.tool data-bs-toggle="tooltip" data-bs-title="year of cycle"}), and then finally the year and [ada]{.tool data-bs-toggle="tooltip" data-bs-title="annual day aggregate"}.
...
In the equations above, [eda]{.tool data-bs-toggle="tooltip" data-bs-title="epochal day aggregate"} is "epochal day aggregate", [coe]{.tool data-bs-toggle="tooltip" data-bs-title="cycle of era"} is "cycle of era", [doc]{.tool data-bs-toggle="tooltip" data-bs-title="day of cycle"} is "day of cycle", and [yoc]{.tool data-bs-toggle="tooltip" data-bs-title="year of cycle"} is "year of cycle".

is "epochal day aggregate" ([eda]{.tool data-bs-toggle="tooltip" data-bs-title="epochal day aggregate"}), If a subtrahend does not include a and a difference We do not need to include a  with , because  can also omit the .
The current Zone [0]{.color0} [yoe]{.tool data-bs-toggle="tooltip" data-bs-title="year of era"}+[ada]{.tool data-bs-toggle="tooltip" data-bs-title="annual day aggregate"} timestamp is \${zeroYearHsl}+\${zeroAdaHsl1}.


omit the [yoe]{.tool data-bs-toggle="tooltip" data-bs-title="year of era"}  by passing the subtrahend, difference, and current "epochal day aggregate" ([eda]{.tool data-bs-toggle="tooltip" data-bs-title="epochal day aggregate"}) to the 

We can omit the [tzo]{.tool data-bs-toggle="tooltip" data-bs-title="time zone offset"} if the timestamp is based on Zone [0]{.color0}. 
 The time since this webpage was loaded is current - load = diff.
If needed, calculate the year by subtracting the [ada]{.tool data-bs-toggle="tooltip" data-bs-title="annual day aggregate"} and &Delta; from the current eda and passing the result to the equations below.


To make it easier to compare timestamps, we should agree to always set the [tzo]{.tool data-bs-toggle="tooltip" data-bs-title="time zone offset"} to zero. If we use a non-zero [tzo]{.tool data-bs-toggle="tooltip" data-bs-title="time zone offset"}, we should include it in between the event time and the elapsed time.

Let’s say that you live in Zone [0]{.color0} and there are four tods that are vital to your typical daily rhythm: you start work at [375]{.color375} md, take a lunch break from [525]{.color525} to [575]{.color575} md, and finish work at [725]{.color725} md. After one event passes, you can begin tracking the time until the next one and thus cycle through all four over the course of each day: current = [375]{.color375} diff = [525]{.color525} diff = [575]{.color575} diff = [725]{.color725} diff.

Tzo range input (include tzo only if not zero)

Another use case for minuend expansion is travel. If the current [tod]{.tool data-bs-toggle="tooltip" data-bs-title="time of day"} is the minuend and your estimated arrival time is the subtrahend, then travel time remaining will be the difference. When traveling, we can replace time with distance so that distance traveled so far is the minuend, the total distance is the subtrahend, and the distance remaining is the difference. Apart from travel, measuring distance in addition to time can be useful for tracking exercise such as running, bicycling, or swimming.

To measure distances, Dec uses taurs ([c]{.tool data-bs-toggle="tooltip" data-bs-title="time of day"}) or zems ([z]{.tool data-bs-toggle="tooltip" data-bs-title="time of day"}), with or without metric prefixes, depending on the order of magnitude of the distance being measured. One [c]{.tool data-bs-toggle="tooltip" data-bs-title="time of day"} is close to the circumference of the earth and is equal to 10^5^ kilozem ([kz]{.tool data-bs-toggle="tooltip" data-bs-title="time of day"}) or 4 &times 10^5^ kilometers ([km]{.tool data-bs-toggle="tooltip" data-bs-title="time of day"}). The distance between the Earth and the Moon ranges from 9.065 to 10.135 c. For larger distances, we can use astronomical units (au), light years (ly), or multiples of [c]{.tool data-bs-toggle="tooltip" data-bs-title="time of day"} such as kilotaurs ([kc]{.tool data-bs-toggle="tooltip" data-bs-title="time of day"}) and gigataurs ([gc]{.tool data-bs-toggle="tooltip" data-bs-title="time of day"}).

au = 3740 c = 3.74 kc
ly ‎ =  236525000 c = 236525 kc = 2.36525 gc

Speed is distance over time. Dec measures speed in omegar ([v]{}).
The speed of the rotation of the Earth is close to one v and is equal to one c per day or one kz per b. The average speed of the orbit of the Moon around the Earth is about 2.2 v and the mean speed of the  Earth orbit around the Sun is approximately 64 v. For higher speeds, we can use percent (%) or permille (‰) light speed (ls) and multiples of v like kv.
...
At sunrise, the [da]{.tool data-bs-toggle="tooltip" data-bs-title="day arc"} is the amount of time until sunset. At solar noon, the time remaining before sunset will be [da/2]{.tool data-bs-toggle="tooltip" data-bs-title="half day arc"}. Throughout the day, the current [tod]{.tool data-bs-toggle="tooltip" data-bs-title="time of day"} is equal to the sum of sunset [tod]{.tool data-bs-toggle="tooltip" data-bs-title="time of day"} and the difference between the current and sunset tods: ${selectedSunset.toFixed(3)} -- ${selectedSunrise.toFixed(3)} = \${parseFloat(daytimeDuration.toFixed(3))}.


Like a countdown sequence, we can keep track of the time relative to sunset throughout the day. Instead of the current [tod]{.tool data-bs-toggle="tooltip" data-bs-title="time of day"}, we can display the , the  and the current [tod]{.tool data-bs-toggle="tooltip" data-bs-title="time of day"} is equal to the difference between the sunset [tod]{.tool data-bs-toggle="tooltip" data-bs-title="time of day"} and the [da]{.tool data-bs-toggle="tooltip" data-bs-title="day arc"} and the current [tod]{.tool data-bs-toggle="tooltip" data-bs-title="time of day"} is equal to the difference between the sunset [tod]{.tool data-bs-toggle="tooltip" data-bs-title="time of day"} and the [da/2]{.tool data-bs-toggle="tooltip" data-bs-title="half day arc"}. The Given a sunset [tod]{.tool data-bs-toggle="tooltip" data-bs-title="time of day"} of We can replace the current [tod]{.tool data-bs-toggle="tooltip" data-bs-title="time of day"} with an expression that provides the time relative to a given tod.

can keep track of the remaining time until sunset by minuend The [tod]{.tool data-bs-toggle="tooltip" data-bs-title="time of day"} of sunrise is found by subtracting half the [da]{.tool data-bs-toggle="tooltip" data-bs-title="day arc"} from solar noon [tod]{.tool data-bs-toggle="tooltip" data-bs-title="time of day"}. The [tod]{.tool data-bs-toggle="tooltip" data-bs-title="time of day"} of sunset is found by adding half the [da]{.tool data-bs-toggle="tooltip" data-bs-title="day arc"} to solar noon [tod]{.tool data-bs-toggle="tooltip" data-bs-title="time of day"}.
