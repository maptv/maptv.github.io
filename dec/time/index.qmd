...
Repeating decimals are by far the most common result of converting [hms]{.tool data-bs-toggle="tooltip" data-bs-title="hour minute second"} triplets to days or submultiples of days. If we converted all of the [hms]{.tool data-bs-toggle="tooltip" data-bs-title="hour minute second"} triplets that can be selected by the range🎚️inputs below, we would have 10 integers, 3190 terminating decimals, and 83200 repeating decimals. When a tzo is an integer, the ref is zero.
