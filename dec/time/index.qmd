...
The day-of-year ([doy]{.under .tool data-bs-toggle="tooltip" data-bs-title="day-of-year"}) indicated by the red<font color=red>—</font>line is \${selDateHsl} and the time-of-day ([tod]{.under .tool data-bs-toggle="tooltip" data-bs-title="time-of-day"}) denoted by the red🔴dot is \${selTimeDay} days or \${selTimeHsl0} [decidays](https://en.wikipedia.org/wiki/Decimal_time#:~:text=dividing%20the%20day%20into%2010%20decidays){.under .tool data-bs-toggle="tooltip" data-bs-title="tenths of a day"}. Dec times consist of a [tod]{.under .tool data-bs-toggle="tooltip" data-bs-title="time-of-day"} and a time zone: \${selTimeHsl1}[--]{style="font-family:monospace;"}\${selZoneHsl}. Together, a [doy]{.under .tool data-bs-toggle="tooltip" data-bs-title="day-of-year"} and [tod]{.under .tool data-bs-toggle="tooltip" data-bs-title="time-of-day"} form a floating🛟snap🫰. Like [tods]{.under .tool data-bs-toggle="tooltip" data-bs-title="times-of-day"}, floating🛟snaps🫰can be expressed in days, \${selSnapDay}, or [decidays](https://en.wikipedia.org/wiki/Decimal_time#:~:text=dividing%20the%20day%20into%2010%20decidays){.under .tool data-bs-toggle="tooltip" data-bs-title="tenths of a day"}: \${selSnapDec}.

## Day of era (doe) {.hiddenheading #doe}

To turn a floating🛟snap🫰into a [tod]{.under .tool data-bs-toggle="tooltip" data-bs-title="time-of-day"}, we divide days by one or [decidays](https://en.wikipedia.org/wiki/Decimal_time#:~:text=dividing%20the%20day%20into%2010%20decidays){.under .tool data-bs-toggle="tooltip" data-bs-title="tenths of a day"} by ten and keep the remainder. We can use this same approach to obtain a [tod]{.under .tool data-bs-toggle="tooltip" data-bs-title="time-of-day"} from a day-of-[era](https://en.wikipedia.org/wiki/Calendar_era#:~:text=the%20period%20of%20time%20elapsed%20since%20one%20epoch%20of%20a%20calendar) ([doe]{.under .tool data-bs-toggle="tooltip" data-bs-title="times-of-day"}) or deciday-of-[era](https://en.wikipedia.org/wiki/Calendar_era#:~:text=the%20period%20of%20time%20elapsed%20since%20one%20epoch%20of%20a%20calendar) ([ddoe]{.under .tool data-bs-toggle="tooltip" data-bs-title="times-of-day"}): [tod]{.under .tool data-bs-toggle="tooltip" data-bs-title="time-of-day"} = [doe]{.under .tool data-bs-toggle="tooltip" data-bs-title="times-of-day"} [mod](https://en.wikipedia.org/wiki/Modulo#:~:text=returns%20the%20remainder) 1 = [ddoe]{.under .tool data-bs-toggle="tooltip" data-bs-title="times-of-day"} [mod](https://en.wikipedia.org/wiki/Modulo#:~:text=returns%20the%20remainder) 10. The current time in the Zone [0]{.color0} Dec time zone is the [decimal part](https://en.wikipedia.org/wiki/Fractional_part#:~:text=the%20excess%20beyond%20that%20number%27s%20integer%20part) of the current [doe]{.under .tool data-bs-toggle="tooltip" data-bs-title="times-of-day"}: \${zeroDote.toFixed(5)} [mod](https://en.wikipedia.org/wiki/Modulo#:~:text=returns%20the%20remainder) 1 = \${zeroTimeHsl0}.

The current [doe]{.under .tool data-bs-toggle="tooltip" data-bs-title="times-of-day"} tells us how many days have passed since the Dec [epoch](https://en.wikipedia.org/wiki/Epoch#:~:text=an%20instant%20in%20time%20chosen%20as%20the%20origin%20of%20a%20particular%20calendar%20era). In the anchored⚓️snap🫰format, the Dec epoch is [0000]{.color0}[+]{style="font-family:monospace;"}[000]{.color0}[.]{style="font-family:monospace;"}[00000]{.color0}[-]{style="font-family:monospace;"}[0]{.color0}. The anchored⚓️snap🫰equivalent of the current [doe]{.under .tool data-bs-toggle="tooltip" data-bs-title="times-of-day"} is \${zeroYearHsl}[+]{style="font-family:monospace;"}\${zeroDotyHsl}[.]{style="font-family:monospace;"}\${zeroTimeHsl1}[-]{style="font-family:monospace;"}[0]{.color0}. The table below lists the four Dec snap🫰formats. Regardless of the format, all snaps🫰contain a [doy]{.under .tool data-bs-toggle="tooltip" data-bs-title="day-of-year"} and a [tod]{.under .tool data-bs-toggle="tooltip" data-bs-title="time-of-day"}.

|  Type                                      |  Format                                                                             |
|--------------------------------------------|-------------------------------------------------------------------------------------|
| [anchored]{style="font-family:monospace;"} | [year+doytod-z]{style="font-family:monospace;"}                                    |
| [zoneless]{style="font-family:monospace;"} | [year+doytod&nbsp;&nbsp;]{style="font-family:monospace;"}                          |
| [yearless]{style="font-family:monospace;"} | [&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;doytod-z]{style="font-family:monospace;"}           |
| [floating]{style="font-family:monospace;"} | [&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;doytod&nbsp;&nbsp;]{style="font-family:monospace;"} |

In the table above, [z]{style="font-family:monospace;"} is the time zone and [doytod]{style="font-family:monospace;"} is a three-digit integer [doy]{.under .tool data-bs-toggle="tooltip" data-bs-title="day-of-year"} followed by a [tod]{.under .tool data-bs-toggle="tooltip" data-bs-title="time-of-day"} that typically has three or five digits.

can have any number of digits . is a concatenated [doy]{.under .tool data-bs-toggle="tooltip" data-bs-title="day-of-year"} and a [tod]{.under .tool data-bs-toggle="tooltip" data-bs-title="time-of-day"}.  [tod]{.under .tool data-bs-toggle="tooltip" data-bs-title="time-of-day"} in a snap🫰can  
We can truncate the [year+doy.tod-z]{style="font-family:monospace;"} format of fixed⚓️snaps🫰, to create a yearless: [doy.tod-z]{style="font-family:monospace;"}, zoneless: [year+doy.tod]{style="font-family:monospace;"}, or floating🛟.
In 
Changing the [doy]{.under .tool data-bs-toggle="tooltip" data-bs-title="day-of-year"} moves the globe🌐beneath the map🗺️along the ellipsis of the Earth🌏orbit diagram. Likewise, modifying the [tod]{.under .tool data-bs-toggle="tooltip" data-bs-title="time-of-day"} rotates the globe🌐on its axis.



absence ([Night]{.colorNight}) and presence ([Day]{.colorDay}) 
, and thus the daylight area chart beneath the map🗺️
, and that visualizes the throughout the year


You can drag the red🔴dot to rotate the the Earth orbit diagram globe. Likewise, the y-axis tick labels on the plot are  time-of-day ([tod]{.under .tool data-bs-toggle="tooltip" data-bs-title="time-of-day"}).

Dec times consist of a time-of-day ([tod]{.under .tool data-bs-toggle="tooltip" data-bs-title="time-of-day"}) and a time zone. The [tod]{.under .tool data-bs-toggle="tooltip" data-bs-title="time-of-day"} can be obtained from either a day-of-year ([doy]{.under .tool data-bs-toggle="tooltip" data-bs-title="day-of-year"}) or a day-of-era ([doe]{.under .tool data-bs-toggle="tooltip" data-bs-title="day-of-era"}). To get the [tod]{.under .tool data-bs-toggle="tooltip" data-bs-title="time-of-day"} in [fractional days](https://en.wikipedia.org/wiki/Decimal_time#Fractional_days:~:text=a%20decimal%20fraction%20of%20a%20day), we divide by one and keep remainder: [d]{.cyan} [mod](https://en.wikipedia.org/wiki/Modulo#:~:text=returns%20the%20remainder) 1 = [t]{.cyan}. In the times below clocks and on the bar charts, the tod and time zone are both in [decidays](https://en.wikipedia.org/wiki/Decimal_time#:~:text=dividing%20the%20day%20into%2010%20decidays){.under .tool data-bs-toggle="tooltip" data-bs-title="tenths of a day"}: [d]{.cyan} &times; 10 [mod](https://en.wikipedia.org/wiki/Modulo#:~:text=returns%20the%20remainder) 10 = [t]{.cyan}.

# Zone

Drag the red⭕️circle across the [meridians](https://en.wikipedia.org/wiki/Meridian_%28geography%29#:~:text=words%2C%20it%20is-,a%20line%20of%20longitude,-.%20The%20position%20of) (vertical↕gray lines) on the map🗺️to see how changing time zones affects the time. Only the first digit of the Dec times shown above, the [deciday]{.under .tool data-bs-toggle="tooltip" data-bs-title="a tenth of a day"}, varies across time zones, because the 10 Dec time zones, numbered 0 through 9 on the map🗺️, are each 1 [deci[turn](https://en.wikipedia.org/wiki/Turn_%28angle%29#:~:text=a%20unit%20of%20plane%20angle%20measurement%20equal%20to%202%CF%80%C2%A0radians%2C%20360%C2%A0degrees)]{.under .tool data-bs-toggle="tooltip" data-bs-title="a tenth of a turn"} ([dt](https://en.wikipedia.org/wiki/Turn_%28angle%29#:~:text=the%20Greek%20letter,to%20one%20turn)) wide. Simply put, a [deciturn]{.under .tool data-bs-toggle="tooltip" data-bs-title="a tenth of a turn"} of longitude translates into a [deciday]{.under .tool data-bs-toggle="tooltip" data-bs-title="a tenth of a day"} of time.
...
There are [37 UTC offsets](https://en.wikipedia.org/wiki/List_of_UTC_offsets), but only 10 Dec time zones. Conversion between Dec time zones and UTC offsets is inexact, because UTC offsets depend on geographic and political boundaries, whereas Dec time zones are determined solely by longitude. If you know your longitude in degrees (°) or [centi[turns](https://en.wikipedia.org/wiki/Turn_%28angle%29#:~:text=a%20unit%20of%20plane%20angle%20measurement%20equal%20to%202%CF%80%C2%A0radians%2C%20360%C2%A0degrees)]{.under .tool data-bs-toggle="tooltip" data-bs-title="hundredths of a turn"}  ([ct](https://en.wikipedia.org/wiki/Turn_%28angle%29#:~:text=the%20Greek%20letter,to%20one%20turn)), you can look up your Dec time zone (TZ) in the table below.
...
Dec times in Zone 0 and 5 can be directly converted to and from UTC times with an offset of 0 and 12 [hours]{.teal}, respectively. The other Dec time zones will differ from the closest UTC time by 8.[3]{.over}, 16.[6]{.over}, 25, 33.[3]{.over}, 41.[6]{.over} or 50 [millidays]{.under .tool data-bs-toggle="tooltip" data-bs-title="thousands of a day"}. To find the difference &delta;, convert the UTC offset [hours]{.teal} [o~H~]{.teal} and [minutes]{.olive} [o~M~]{.olive} into [deci[turns](https://en.wikipedia.org/wiki/Turn_%28angle%29#:~:text=a%20unit%20of%20plane%20angle%20measurement%20equal%20to%202%CF%80%C2%A0radians%2C%20360%C2%A0degrees)]{.under .tool data-bs-toggle="tooltip" data-bs-title="tenths of a turn"} of the longitude &lambda; and then subtract the Dec zone number [z]{.lime}:
...
To convert the [hour]{.teal} [h]{.teal}, [minute]{.olive} [m]{.olive}, and [second]{.purple} [s]{.purple} into the [deciday](https://en.wikipedia.org/wiki/Decimal_time#:~:text=dividing%20the%20day%20into%2010%20decidays){.under .tool data-bs-toggle="tooltip" data-bs-title="a tenth of a day"} [d]{.cyan}, Dec uses the following equation: [d]{.cyan} = [h]{.teal} &div; 2.4 + [m]{.olive} &div; 144 + [s]{.purple} &div; 8640. The current equation values in Zone [\${browserZone}]{.lime} are: [\${browserTime.toFixed(4)}]{.cyan} = [\${Math.floor(hours).toString().padStart(2, "0")}]{.teal} &div; 2.4 + [\${Math.floor(minutes).toString().padStart(2, "0")}]{.olive} &div; 144 + [\${Math.floor(seconds).toString().padStart(2, "0")}]{.purple} &div; 8640. Inversely, we can convert [decidays](https://en.wikipedia.org/wiki/Decimal_time#:~:text=dividing%20the%20day%20into%2010%20decidays){.under .tool data-bs-toggle="tooltip" data-bs-title="tenths of a day"} into [hours]{.teal}: [h]{.teal} = [d]{.cyan} &times; 2.4, [minutes]{.olive}: [m]{.olive} = [h]{.teal} [mod](https://en.wikipedia.org/wiki/Modulo#:~:text=returns%20the%20remainder) 1 &times; 60, and [seconds]{.purple}: [s]{.purple} = [m]{.olive} [mod](https://en.wikipedia.org/wiki/Modulo#:~:text=returns%20the%20remainder) 1 &times; 60.
...
Please spread the good word about Dec using the citation information at the bottom of this article. You may also want to cite the Observable notebooks that I adapted into the clock🕓, bar📊chart, map🗺️, and daylight☀️plot visualizations in this article or the 2014 blog post which proposed a system of 20 decimal time zones, each 5 [centidays]{.under .tool data-bs-toggle="tooltip" data-bs-title="hundredths of a day"} wide, based on the [Greenwich Meridian](https://en.wikipedia.org/wiki/Prime_meridian_(Greenwich)#:~:text=a%20geographical%20reference%20line%20that%20passes%20through%20the%20Royal%20Observatory%2C%20Greenwich%2C%20in%20London%2C%20England):
