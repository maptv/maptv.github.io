...
The [National Oceanic and Atmospheric Administration](https://www.noaa.gov) ([NOAA]{.tool data-bs-toggle="tooltip" data-bs-title="National Oceanic and Atmospheric Administration"}) provides [yearly and daily [eot]{.tool data-bs-toggle="tooltip" data-bs-title="equation of time"} values](https://gml.noaa.gov/grad/solcalc/calcdetails.html). To create a Dec version of the [eot]{.tool data-bs-toggle="tooltip" data-bs-title="equation of time"}, we can convert the yearly [NOAA]{.tool data-bs-toggle="tooltip" data-bs-title="National Oceanic and Atmospheric Administration"} [eot]{.tool data-bs-toggle="tooltip" data-bs-title="equation of time"} values from minutes to [centidays]{.tool data-bs-toggle="tooltip" data-bs-title="hundredths of a day"}, combine dates and times into [ydas]{.tool data-bs-toggle="tooltip" data-bs-title="yearly day aggregates"}, sort by [yda]{.tool data-bs-toggle="tooltip" data-bs-title="yearly day aggregate"},  [fit a curve](https://docs.scipy.org/doc/scipy/reference/generated/scipy.optimize.curve_fit.html) to the sorted values, and then use the fitted model coefficients in the [NOAA]{.tool data-bs-toggle="tooltip" data-bs-title="National Oceanic and Atmospheric Administration"} [General Solar Position Calculations](https://gml.noaa.gov/grad/solcalc/solareqns.PDF):
...
The line📈chart above uses [centiday]{.tool data-bs-toggle="tooltip" data-bs-title="a hundredth of a day"} [eot]{.tool data-bs-toggle="tooltip" data-bs-title="equation of time"}([toy]{.tool data-bs-toggle="tooltip" data-bs-title="time of year"}) values to show fewer digits on its y-axis. For time calculations, Dec always uses units that do not have metric prefixes. To calculate the [tod]{.tool data-bs-toggle="tooltip" data-bs-title="time of day"} of [solar noon](https://en.wikipedia.org/wiki/Noon#:~:text=reaching%20its%20highest%20position%20above%20the%20horizon%20on%20that%20day%20and%20casting%20the%20shortest%20shadow), the moment when the sun reaches its highest point in the sky, we keep only the decimal part after subtracting a longitude measured in &lambda; and an eot([toy]{.tool data-bs-toggle="tooltip" data-bs-title="time of year"}) value from the sum of 9.55 and a [tzo]{.tool data-bs-toggle="tooltip" data-bs-title="time zone offset"}.
