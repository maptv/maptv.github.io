...
The path in the sky that the Sun appears to follow between a sunrise and a sunset is a full [day arc](https://en.wikipedia.org/wiki/Sun_path#:~:text=arc%2Dlike%20path%20that%20the%20Sun%20appears%20to%20follow%20across%20the%20sky) ([fda]{.tool data-bs-toggle="tooltip" data-bs-title="full day arc"}) and the path from a sunrise to a solar noon or from a solar noon to a sunset is a half day arc ([hda]{.tool data-bs-toggle="tooltip" data-bs-title="half day arc"}). Therefore, the difference between a solar noon [tod]{.tool data-bs-toggle="tooltip" data-bs-title="time of day"} and a [hda]{.tool data-bs-toggle="tooltip" data-bs-title="half day arc"} is a sunrise [tod]{.tool data-bs-toggle="tooltip" data-bs-title="time of day"} and the sum of a solar noon [tod]{.tool data-bs-toggle="tooltip" data-bs-title="time of day"} and a [hda]{.tool data-bs-toggle="tooltip" data-bs-title="half day arc"} is a sunset [tod]{.tool data-bs-toggle="tooltip" data-bs-title="time of day"}.
...
The Sun continues its path after it disappears below the horizon, moving from sunset to sunrise in a full night arc ([fna]{.tool data-bs-toggle="tooltip" data-bs-title="full night arc"}). Just like a [fda]{.tool data-bs-toggle="tooltip" data-bs-title="full day arc"} can be split into two [hdas]{.tool data-bs-toggle="tooltip" data-bs-title="half day arcs"}, the first from sunrise to solar noon and the second from solar noon to sunset, every [fna]{.tool data-bs-toggle="tooltip" data-bs-title="full night arc"} consists of the half night arc ([hna]{.tool data-bs-toggle="tooltip" data-bs-title="half night arc"}) from sunset to [solar midnight](https://en.wikipedia.org/wiki/Midnight#:~:text=the%20time%20opposite%20to%20solar%20noon%2C%20when%20the%20Sun%20is%20closest%20to%20the%20nadir%2C%20and%20the%20night%20is%20equidistant%20from%20dusk%20and%20dawn) and the [hna]{.tool data-bs-toggle="tooltip" data-bs-title="half night arc"} from solar midnight to sunset.

$$\text{fna} = 1 - \text{fda} = \text{hna} \times 2$$

$$\text{solarmidnight} = (\text{sunset} + \text{hna}) \text{ mod } 1 = (1 + \text{sunrise} - \text{hna}) \text{ mod } 1$$

If we only want to know how long the Sun will shine on a given day, we can use the top equation below to obtain a [fda]{.tool data-bs-toggle="tooltip" data-bs-title="full day arc"}, but if we are interested in finding the a sunrise or sunset [tod]{.tool data-bs-toggle="tooltip" data-bs-title="time of day"}, we will need to calculate a [hda]{.tool data-bs-toggle="tooltip" data-bs-title="half day arc"} using the bottom equation and combine it with a solar noon [tod]{.tool data-bs-toggle="tooltip" data-bs-title="time of day"}.
