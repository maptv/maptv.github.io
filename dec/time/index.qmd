...
When the minuend is the current time and the subtrahend is the timestamp of an event that occurred in the past, the difference is the time elapsed since that event. Dec timestamps are called snaps and typically consist of a "year of era" ([yoe]{.tool data-bs-toggle="tooltip" data-bs-title="year of era"}), a [yda]{.tool data-bs-toggle="tooltip" data-bs-title="yearly day aggregate"}, and a [tzo]{.tool data-bs-toggle="tooltip" data-bs-title="time zone offset"}, but we can omit the [tzo]{.tool data-bs-toggle="tooltip" data-bs-title="time zone offset"} if it is zero. The snap created when this webpage loaded is and the associated difference is.

We can omit the yoe from a snap if we replace the [yda]{.tool data-bs-toggle="tooltip" data-bs-title="yearly day aggregate"} with a subtrahend and a difference or just a difference. If needed, we can obtain a snap from a difference using the equations below. First, we subtract the difference from the current [eda]{.tool data-bs-toggle="tooltip" data-bs-title="epochal day aggregate"} to obtain the "[eda]{.tool data-bs-toggle="tooltip" data-bs-title="epochal day aggregate"} difference difference" ([edd]{.tool data-bs-toggle="tooltip" data-bs-title="eda difference difference"}). Then, we use the [edd]{.tool data-bs-toggle="tooltip" data-bs-title="eda difference difference"} to get the "cycle of era" ([coe]{.tool data-bs-toggle="tooltip" data-bs-title="cycle of era"}), "day of cycle" ([doc]{.tool data-bs-toggle="tooltip" data-bs-title="day of cycle"}), "year of cycle" ([yoc]{.tool data-bs-toggle="tooltip" data-bs-title="year of cycle"}), and then finally the [yoe]{.tool data-bs-toggle="tooltip" data-bs-title="year of era"} and [yda]{.tool data-bs-toggle="tooltip" data-bs-title="yearly day aggregate"}.
...
The current Zone [0]{.color0} [yoe]{.tool data-bs-toggle="tooltip" data-bs-title="year of era"}+[yda]{.tool data-bs-toggle="tooltip" data-bs-title="yearly day aggregate"} timestamp is \${zeroYearHsl}+\${zeroYdaHsl1}.
...
If needed, calculate the year by subtracting the [yda]{.tool data-bs-toggle="tooltip" data-bs-title="yearly day aggregate"} and &Delta; from the current eda and passing the result to the equations below.
