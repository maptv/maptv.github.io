...
UNIX time is synchronized with the Zone [0]{.color0} Dec time zone. We can obtain a Zone [0]{.color0} [tod]{.tool data-bs-toggle="tooltip" data-bs-title="time-of-day"} from an [hms]{.tool data-bs-toggle="tooltip" data-bs-title="hour-minute-second"} triplet by removing its [leap seconds](https://en.wikipedia.org/wiki/Leap_second#:~:text=one%2Dsecond%20adjustment) and [UTC]{.tool data-bs-toggle="tooltip" data-bs-title="Coordinated Universal Time"} [time zone](https://en.wikipedia.org/wiki/Time_zone#:~:text=an%20area%20which%20observes%20a%20uniform%20standard%20time) [offset](https://en.wikipedia.org/wiki/UTC_offset#:~:text=the%20difference%20in%20hours%20and%20minutes%20between%20Coordinated%20Universal%20Time%20(UTC)%20and%20the%20standard%20time%20at%20a%20particular%20place), converting its components to either days or [decidays]{.tool data-bs-toggle="tooltip" data-bs-title="tenths of a day"}, and then summing the converted components.
