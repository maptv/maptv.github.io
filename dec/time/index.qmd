...
The two types of [solar time](https://en.wikipedia.org/wiki/Solar_time#:~:text=a%20calculation%20of%20the%20passage%20of%20time%20based%20on%20the%20position%20of%20the%20Sun%20in%20the%20sky) are ["mean solar time"](https://en.wikipedia.org/wiki/Solar_time#Mean_solar_time:~:text=it%20follows%20an%20imaginary%20%22mean%20Sun%22%20that%20moves%20along%20the%20celestial%20equator%20at%20a%20constant%20rate%20that%20matches%20the%20real%20Sun%27s%20average%20rate%20over%20the%20year) ([mst]{.tool data-bs-toggle="tooltip" data-bs-title="mean solar time"}) and ["apparent solar time"](https://en.wikipedia.org/wiki/Solar_time#Mean_solar_time:~:text=it%20follows%20an%20imaginary%20%22mean%20Sun%22%20that%20moves%20along%20the%20celestial%20equator%20at%20a%20constant%20rate%20that%20matches%20the%20real%20Sun%27s%20average%20rate%20over%20the%20year) ([ast]{.tool data-bs-toggle="tooltip" data-bs-title="apparent solar time"}). If we shift our [$\text d\lambda$]{.tool data-bs-toggle="tooltip" data-bs-title="deciparallel"} longitude to the West by 0.5 [$\text d\lambda$]{.tool data-bs-toggle="tooltip" data-bs-title="deciparallel"}, we will obtain the solar [tzo]{.tool data-bs-toggle="tooltip" data-bs-title="time zone offset"} of our [mst]{.tool data-bs-toggle="tooltip" data-bs-title="mean solar time"}. In Dec, [mst]{.tool data-bs-toggle="tooltip" data-bs-title="mean solar time"} is shifted by 0.5 [deciday]{.tool data-bs-toggle="tooltip" data-bs-title="a tenth of a day"} so that we can floor any [$\text d\lambda$]{.tool data-bs-toggle="tooltip" data-bs-title="deciparallel"} longitude to get its corresponding zonal [tzo]{.tool data-bs-toggle="tooltip" data-bs-title="time zone offset"}. Without this shift, we would have to round instead of flooring.
...
In Dec, the zonal [tzo]{.tool data-bs-toggle="tooltip" data-bs-title="time zone offset"} of any [$\text d\lambda$]{.tool data-bs-toggle="tooltip" data-bs-title="deciparallel"} longitude is evident at glance without the need for APIs, databases, or even any calculations. Flooring only requires that we look at the first digit of a [$\text d\lambda$]{.tool data-bs-toggle="tooltip" data-bs-title="deciparallel"} longitude, whereas rounding may force us to consider all of the digits when deciding whether to increment the first digit.

Flooring is certainly faster than the complex logic needed for UTC tzos, but the superiority of Dec is most clear in situations when calculations are unnessecary its [integer part](https://en.wikipedia.org/wiki/Floor_and_ceiling_functions#:~:text=The%20floor%20of%20x%20is%20also%20called%20the%20integral%20part%2C%20integer%20part%2C%20greatest%20integer%2C%20or%20entier%20of%20x). Instead of doing calculations, you can zero if there is no digit to the left of the decimal separator. When confronted with a  contrast, it is difficult to differentiate between highest [tzo]{.tool data-bs-toggle="tooltip" data-bs-title="time zone offset"} that rounds to 4 and lowest [tzo]{.tool data-bs-toggle="tooltip" data-bs-title="time zone offset"} that rounds to 5. 4.4994 that rounds to 4 and this  immediately know which time zone the
...
$$\lfloor\text{x}\rfloor = \text{x} - \text{x} \text{ mod } 1$$
