...
Plot.plot({
  width: width,
  marginBottom: 50,
  style: `overflow: visible;font-size:25px;`,
  color: {scheme: "RdBu", className: "barPlotLegend"},
  marginLeft: 100,
  y: { label: null },
  x: { grid: true, label: "Population (billions)", labelOffset: 50, transform: d => d / 1e9 },
  marks: [
...
Solar noon is the midpoint between sunrise and sunset. The path between a sunrise and a sunset is a [full day arc](https://en.wikipedia.org/wiki/Sun_path#:~:text=arc%2Dlike%20path%20that%20the%20Sun%20appears%20to%20follow%20across%20the%20sky) ([fda]{.tool data-bs-toggle="tooltip" data-bs-title="day arc"}). Dec refers to the path from a sunrise to a solar noon or from a solar noon to a sunset as a half day arc ([hda]{.tool data-bs-toggle="tooltip" data-bs-title="half day arc"}). The difference between a solar noon [tod]{.tool data-bs-toggle="tooltip" data-bs-title="time of day"} and a [hda]{.tool data-bs-toggle="tooltip" data-bs-title="half day arc"} is a sunrise [tod]{.tool data-bs-toggle="tooltip" data-bs-title="time of day"}. The sum of a solar noon [tod]{.tool data-bs-toggle="tooltip" data-bs-title="time of day"} and a [hda]{.tool data-bs-toggle="tooltip" data-bs-title="half day arc"} is a sunset [tod]{.tool data-bs-toggle="tooltip" data-bs-title="time of day"}.

$$\text{fda} = \text{sunset} - \text{sunrise} = \text{hda} \times 2$$

$$\begin{split}
\text{sunrise} & = \text{noon} - \text{hda}\\
\text{sunset} & = \text{noon} + \text{hda}\\
\end{split}$$

Of course, the path of the Sun keeps going after it disappears over the horizon To obtain a [fda]{.tool data-bs-toggle="tooltip" data-bs-title="full day arc"}

$$\text{midnight} = \text{sunset} + \text{hna}$$
$$\text{sunrise} = \text{midnight} + \text{hna}$$
