...
The mismatch between positive and negative [tzos]{.tool data-bs-toggle="tooltip" data-bs-title="time zone offsets"} may actually make Dec [dow]{.tool data-bs-toggle="tooltip" data-bs-title="day of week"} numbers more intuitive than [POSIX](https://pubs.opengroup.org/onlinepubs/007904875/utilities/date.html#:~:text=weekday%20as%20a%20decimal%20number%20%5B0%2C6%5D%20(0%3Dsunday)) [dow]{.tool data-bs-toggle="tooltip" data-bs-title="day of week"} numbers for speakers of languages that consider [Sunday to be the first [dow]{.tool data-bs-toggle="tooltip" data-bs-title="day of week"}](https://en.wikipedia.org/wiki/Names_of_the_days_of_the_week#:~:text=Sunday%20comes%20first,-in%20order%20in). Notably, connecting the ordinal prefixes in the dow names in Portuguese with the Dec dow would come naturally to Brazilians. Brazil is the second most populous country in the Americas and accounts for over a fifth of the total population of the Americas. The names of Monday through Friday in Portuguese have that indicate their distance from Saturday.
