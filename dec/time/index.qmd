...
The full potential of Dec is revealed in my Dec [snap](/dec/span) article, which shows how a Dec [year]{.yellow}+[day]{.cyan} date and a Dec [.day]{.cyan}-[z]{.lime} time can be combined to make a [year]{.yellow}+[day.day]{.cyan}-[z]{.lime} [timestamp](https://en.wikipedia.org/wiki/Timestamp#:~:text=a%20sequence%20of%20characters%20or%20encoded%20information%20identifying%20when%20a%20certain%20event%20occurred), and my Dec [span](/dec/span) article, which demonstrates how two snaps can be combined to represent a time interval. For more on Dec dates and times, you read about they can be converted to and from their ISO 8601 equivalents in my ISO [date](/iso/date) and [time](/iso/time) articles.
