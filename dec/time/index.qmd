...
The two types of [solar time](https://en.wikipedia.org/wiki/Solar_time#:~:text=a%20calculation%20of%20the%20passage%20of%20time%20based%20on%20the%20position%20of%20the%20Sun%20in%20the%20sky) are ["mean solar time"](https://en.wikipedia.org/wiki/Solar_time#Mean_solar_time:~:text=it%20follows%20an%20imaginary%20%22mean%20Sun%22%20that%20moves%20along%20the%20celestial%20equator%20at%20a%20constant%20rate%20that%20matches%20the%20real%20Sun%27s%20average%20rate%20over%20the%20year) ([mst]{.tool data-bs-toggle="tooltip" data-bs-title="mean solar time"}) and ["apparent solar time"](https://en.wikipedia.org/wiki/Solar_time#Mean_solar_time:~:text=it%20follows%20an%20imaginary%20%22mean%20Sun%22%20that%20moves%20along%20the%20celestial%20equator%20at%20a%20constant%20rate%20that%20matches%20the%20real%20Sun%27s%20average%20rate%20over%20the%20year) ([ast]{.tool data-bs-toggle="tooltip" data-bs-title="apparent solar time"}). If we shift our [d&lambda;]{.tool data-bs-toggle="tooltip" data-bs-title="deciparallel"} longitude to the West by 0.5 [d&lambda;]{.tool data-bs-toggle="tooltip" data-bs-title="deciparallel"}, we will obtain the solar [tzo]{.tool data-bs-toggle="tooltip" data-bs-title="time zone offset"} of our [mst]{.tool data-bs-toggle="tooltip" data-bs-title="mean solar time"}. In Dec, [mst]{.tool data-bs-toggle="tooltip" data-bs-title="mean solar time"} is shifted by 0.5 [deciday]{.tool data-bs-toggle="tooltip" data-bs-title="a tenth of a day"} so that we can floor any [d&lambda;]{.tool data-bs-toggle="tooltip" data-bs-title="deciparallel"} longitude to get its corresponding zonal [tzo]{.tool data-bs-toggle="tooltip" data-bs-title="time zone offset"}. Without this shift, we would have to round instead of flooring.
...
In contrast, the zonal [tzo]{.tool data-bs-toggle="tooltip" data-bs-title="time zone offset"} of any [d&lambda;]{.tool data-bs-toggle="tooltip" data-bs-title="deciparallel"} longitude is evident at a glance without the need for APIs, databases, or even any calculations. The result of flooring a [d&lambda;]{.tool data-bs-toggle="tooltip" data-bs-title="deciparallel"} longitude is always its first digit, because Dec adds ten [d&lambda;]{.tool data-bs-toggle="tooltip" data-bs-title="deciparallel"} to make all longitudes positive and then ensures that all longitudes are less than ten [d&lambda;]{.tool data-bs-toggle="tooltip" data-bs-title="deciparallels"} by keeping the remainder after dividing by ten.
...
zones have no such shift not  and mst matches the time in the middle of  a zonal [tzo]{.tool data-bs-toggle="tooltip" data-bs-title="time zone offset"} to the Zone [0]{.color0} [tod]{.tool data-bs-toggle="tooltip" data-bs-title="time of day"} gives us the mst in the middle of the time zone associated with that zonal [tzo]{.tool data-bs-toggle="tooltip" data-bs-title="time zone offset"}.
