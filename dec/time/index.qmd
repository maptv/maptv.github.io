...
Before being plugged into the [sha]{.tool data-bs-toggle="tooltip" data-bs-title="solar hour angle"} equation above, the "solar zenith angle" ([sza]{.tool data-bs-toggle="tooltip" data-bs-title="solar zenith angle"}) is set to 0.252314 turns, the [doy]{.tool data-bs-toggle="tooltip" data-bs-title="day of year"} chosen by the top range input below is first turned into a [toy]{.tool data-bs-toggle="tooltip" data-bs-title="time of year"} and then into an [sda]{.tool data-bs-toggle="tooltip" data-bs-title="solar declination angle"}, and the [m&phi;]{.tool data-bs-toggle="tooltip" data-bs-title="millimeridians"} latitude selected by the middle range input below is divided by 1000 to convert it to [&phi;]{.tool data-bs-toggle="tooltip" data-bs-title="meridians"}. If we divide the result of the [sha]{.tool data-bs-toggle="tooltip" data-bs-title="solar hour angle"} equation by $\pi$, we get the daytime duration: ${parseFloat(shaDoyInput.toFixed(5))} &div; $\pi$ = \${parseFloat(daytimeDuration.toFixed(5))}.
If 
...
The in the [sha]{.tool data-bs-toggle="tooltip" data-bs-title="solar hour angle"} equation returns radians. To convert radians to turns, we divide by $\tau$. We then either sum the [sha]{.tool data-bs-toggle="tooltip" data-bs-title="solar hour angle"} with the solar noon [tod]{.tool data-bs-toggle="tooltip" data-bs-title="time of day"} to get the sunset [tod]{.tool data-bs-toggle="tooltip" data-bs-title="time of day"} or subtract it from the solar noon [tod]{.tool data-bs-toggle="tooltip" data-bs-title="time of day"} to obtain the sunrise [tod]{.tool data-bs-toggle="tooltip" data-bs-title="time of day"}. The difference between the sunset and sunrise [tods]{.tool data-bs-toggle="tooltip" data-bs-title="times of day"} is the daytime duration: ${selectedSunset} - ${selectedSunrise} = ${selectedDuration}.
