...
The path in the sky that the Sun appears to follow from a sunrise to a sunset is a "full [day arc](https://en.wikipedia.org/wiki/Sun_path#:~:text=arc%2Dlike%20path%20that%20the%20Sun%20appears%20to%20follow%20across%20the%20sky)" ([fda]{.tool data-bs-toggle="tooltip" data-bs-title="full day arc"}). Solar noon, the midpoint of a [fda]{.tool data-bs-toggle="tooltip" data-bs-title="full day arc"}, is halfway between sunrise and sunset. On each side of solar noon is a "half day arc" ([hda]{.tool data-bs-toggle="tooltip" data-bs-title="half day arc"}). The difference between a solar noon [tod]{.tool data-bs-toggle="tooltip" data-bs-title="time of day"} and a [hda]{.tool data-bs-toggle="tooltip" data-bs-title="half day arc"} is a sunrise [tod]{.tool data-bs-toggle="tooltip" data-bs-title="time of day"} and the sum of a solar noon [tod]{.tool data-bs-toggle="tooltip" data-bs-title="time of day"} and a [hda]{.tool data-bs-toggle="tooltip" data-bs-title="half day arc"} is a sunset [tod]{.tool data-bs-toggle="tooltip" data-bs-title="time of day"}.

$$\text{fda} = \text{sunset} - \text{sunrise} = \text{hda} \times 2$$

$$\begin{split}
\text{sunrise} & = \text{solarnoon} - \text{hda} && = \text{sunset} - \text{fda} \\
\text{sunset} & = \text{solarnoon} + \text{hda} && = \text{sunrise} + \text{fda}
\end{split}$$

## Full night arc {.hiddenheading #fna}

The Sun continues its path after it disappears below the horizon, moving from sunset to sunrise to complete a "full night arc" ([fna]{.tool data-bs-toggle="tooltip" data-bs-title="full night arc"}). Like [conjugate angles](https://en.wikipedia.org/wiki/Angle#:~:text=conjugate%20angles%20sum%20to%20a%20full%20angle), a [fda]{.tool data-bs-toggle="tooltip" data-bs-title="full day arc"} and a [fna]{.tool data-bs-toggle="tooltip" data-bs-title="full night arc"} sum to a "full [diurnal circle](https://en.wikipedia.org/wiki/Diurnal_motion#:~:text=caused%20by%20Earth%27s%20rotation%20around%20its%20axis)" ([fdc]{.tool data-bs-toggle="tooltip" data-bs-title="full diurnal circle"}). A "half diurnal circle" ([hdc]{.tool data-bs-toggle="tooltip" data-bs-title="half diurnal circle"}) consists of a [hda]{.tool data-bs-toggle="tooltip" data-bs-title="half day arc"} and a half night arc ([hna]{.tool data-bs-toggle="tooltip" data-bs-title="half night arc"}) and spans from solar noon to [solar midnight](https://en.wikipedia.org/wiki/Midnight#:~:text=the%20time%20opposite%20to%20solar%20noon%2C%20when%20the%20Sun%20is%20closest%20to%20the%20nadir%2C%20and%20the%20night%20is%20equidistant%20from%20dusk%20and%20dawn).

$$\text{fna} = \text{fdc} - \text{fda} = \text{hna} \times 2$$

:::{.overflowequation style="overflow-x:auto;overflow-y:hidden;"}
$$\text{solarmidnight} = (\text{solarnoon} + \text{hdc}) \text{ mod } 1 = (\text{sunset} + \text{hna}) \text{ mod } 1 $$
:::
