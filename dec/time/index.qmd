...
If we obtain [decidays]{.tool data-bs-toggle="tooltip" data-bs-title="tenths of a day"} from all of the [hms]{.tool data-bs-toggle="tooltip" data-bs-title="hour minute second"} triplets that can be selected with the range🎚️inputs above, we will have 10 integers, 3190 terminating decimals, and 83200 repeating decimals. Dec refers to integer offsets as "time zone offsets" ([tzos]{.tool data-bs-toggle="tooltip" data-bs-title="time zone offsets"}), terminating decimal offsets as "solar time offsets" ([stos]{.tool data-bs-toggle="tooltip" data-bs-title="solar time offsets"}), and repeating decimals offsets as [rod]{.tool data-bs-toggle="tooltip" data-bs-title="rounded offset decimal"} and [ref]{.tool data-bs-toggle="tooltip" data-bs-title="roundoff error fraction"} pairs.

When we do the same to the [38](https://en.wikipedia.org/wiki/List_of_UTC_offsets) [UTC]{.tool data-bs-toggle="tooltip" data-bs-title="Coordinated Universal Time"} "time zone offsets" ([tzos]{.tool data-bs-toggle="tooltip" data-bs-title="time zone offsets"}), the number of integers, terminating decimals, and repeating decimals we get depends on how many leap seconds are included.
...
The two types of [solar time](https://en.wikipedia.org/wiki/Solar_time#:~:text=a%20calculation%20of%20the%20passage%20of%20time%20based%20on%20the%20position%20of%20the%20Sun%20in%20the%20sky) are ["mean solar time"](https://en.wikipedia.org/wiki/Solar_time#Mean_solar_time:~:text=it%20follows%20an%20imaginary%20%22mean%20Sun%22%20that%20moves%20along%20the%20celestial%20equator%20at%20a%20constant%20rate%20that%20matches%20the%20real%20Sun%27s%20average%20rate%20over%20the%20year) ([mst]{.tool data-bs-toggle="tooltip" data-bs-title="mean solar time"}) and ["apparent solar time"](https://en.wikipedia.org/wiki/Solar_time#Mean_solar_time:~:text=it%20follows%20an%20imaginary%20%22mean%20Sun%22%20that%20moves%20along%20the%20celestial%20equator%20at%20a%20constant%20rate%20that%20matches%20the%20real%20Sun%27s%20average%20rate%20over%20the%20year) ([ast]{.tool data-bs-toggle="tooltip" data-bs-title="apparent solar time"}). Shifting our [d&lambda;]{.tool data-bs-toggle="tooltip" data-bs-title="deciparallel"} longitude to the West by 0.5 [d&lambda;]{.tool data-bs-toggle="tooltip" data-bs-title="deciparallels"} gives us a solar [tzo]{.tool data-bs-toggle="tooltip" data-bs-title="time zone offset"} that we can add to the Zone [0]{.color0} [tod]{.tool data-bs-toggle="tooltip" data-bs-title="time of day"} to get our [mst]{.tool data-bs-toggle="tooltip" data-bs-title="mean solar time"}. This solar [tzo]{.tool data-bs-toggle="tooltip" data-bs-title="time zone offset"} will match our zonal [tzo]{.tool data-bs-toggle="tooltip" data-bs-title="time zone offset"} when we are at the center of a Dec time zone. In Dec, our zonal [tzo]{.tool data-bs-toggle="tooltip" data-bs-title="time zone offset"} is always the first digit of our longitude.

The sum of our zonal [tzo]{.tool data-bs-toggle="tooltip" data-bs-title="time zone offset"} and the current Zone [0]{.color0} [tod]{.tool data-bs-toggle="tooltip" data-bs-title="time of day"} is our zonal time. The difference between a zonal [tzo]{.tool data-bs-toggle="tooltip" data-bs-title="time zone offset"} and a solar [tzo]{.tool data-bs-toggle="tooltip" data-bs-title="time zone offset"} is a "solar time offset" ([sto]{.tool data-bs-toggle="tooltip" data-bs-title="solar time offset"}). To calculate our offset from [mst]{.tool data-bs-toggle="tooltip" data-bs-title="mean solar time"}, we subtract the [fractional part](https://en.wikipedia.org/wiki/Fractional_part#:~:text=the%20excess%20beyond%20that%20number%27s%20integer%20part) of our [d&lambda;]{.tool data-bs-toggle="tooltip" data-bs-title="deciparallel"} longitude from 0.5. We can then add this difference to the result of the [equation of time](https://en.wikipedia.org/wiki/Equation_of_time#:~:text=the%20discrepancy%20between%20two%20kinds%20of%20solar%20time) ([eot]{.tool data-bs-toggle="tooltip" data-bs-title="equation of time"}) to obtain our offset from [ast]{.tool data-bs-toggle="tooltip" data-bs-title="apparent solar time"}.

The difference between our [sto]{.tool data-bs-toggle="tooltip" data-bs-title="solar time offset"} from will be highest at the border between two adjacent time zones.


Once we have The sum of our [mst]{.tool data-bs-toggle="tooltip" data-bs-title="mean solar time"}, the difference between our solar time and our [mst]{.tool data-bs-toggle="tooltip" data-bs-title="mean solar time"}, and our solar [tzo]{.tool data-bs-toggle="tooltip" data-bs-title="time zone offset"}, is current Zone [0]{.color0} [tod]{.tool data-bs-toggle="tooltip" data-bs-title="time of day"}.

to give us a better idea  To display [mst]{.tool data-bs-toggle="tooltip" data-bs-title="mean solar time"}, Dec  display our [mst]{.tool data-bs-toggle="tooltip" data-bs-title="mean solar time"} along the associated [tzos]{.tool data-bs-toggle="tooltip" data-bs-title="time zone offsets"} as part of a math expressions that evaluate to the

[decidays]{.tool data-bs-toggle="tooltip" data-bs-title="tenths of a day"}.

To obtain our zonal [tzo]{.tool data-bs-toggle="tooltip" data-bs-title="time zone offset"}, we floor our [d&lambda;]{.tool data-bs-toggle="tooltip" data-bs-title="deciparallel"} longitude. When calculcating [tods]{.tool data-bs-toggle="tooltip" data-bs-title="times of day"} and [tzos]{.tool data-bs-toggle="tooltip" data-bs-title="time zone offsets"}, Dec ensures that the result is positive and less than ten [decidays]{.tool data-bs-toggle="tooltip" data-bs-title="tenths of a day"}. When provided with a longitude measured in degrees, Dec first converts to [d&lambda;]{.tool data-bs-toggle="tooltip" data-bs-title="deciparallels"}. The degree2lambda() function below accepts degrees and returns First, Dec performs the [modulo](https://en.wikipedia.org/wiki/Modulo#:~:text=returns%20the%20remainder%20or%20signed%20remainder%20of%20a%20division) operation according to the [truncated division definition](https://en.wikipedia.org/wiki/Modulo#Variants_of_the_definition:~:text=Many%20implementations%20use-,truncated%20division,-%2C%20for%20which%20the) to bring a longitude . between If we in negative degrees, Dec converts degrees to [d&lambda;]{.tool data-bs-toggle="tooltip" data-bs-title="deciparallels"}, sums  the current Zone [0]{.color0} [tod]{.tool data-bs-toggle="tooltip" data-bs-title="time of day"} along with ten [decidays]{.tool data-bs-toggle="tooltip" data-bs-title="tenths of a day"} to ensure a positive result, adds the current and keeps the remainder after dividing by ten [d&lambda;]{.tool data-bs-toggle="tooltip" data-bs-title="deciparallels"} so that the result is less than ten [d&lambda;]{.tool data-bs-toggle="tooltip" data-bs-title="deciparallels"}.
We can obtain our zonal [tzo]{.tool data-bs-toggle="tooltip" data-bs-title="time zone offset"} by flooring our [d&lambda;]{.tool data-bs-toggle="tooltip" data-bs-title="deciparallel"} longitude to  remove its
facilitate
 the difference between our [mst]{.tool data-bs-toggle="tooltip" data-bs-title="mean solar time"} and our zonal time will go from 0 to 0.5 [decidays]{.tool data-bs-toggle="tooltip" data-bs-title="tenths of a day"}. In Dec, [mst]{.tool data-bs-toggle="tooltip" data-bs-title="mean solar time"} is shifted by 0.5 [deciday]{.tool data-bs-toggle="tooltip" data-bs-title="a tenth of a day"} so that the
Without this shift, we would have to round instead of flooring.
...
In contrast, the first digit of any longitude shown by Dec tells us its the zonal [tzo]{.tool data-bs-toggle="tooltip" data-bs-title="time zone offset"} of any longitude shown by Dec is evident at a glance without the need for APIs, databases, or even any calculations, because Dec processes longitudes such that the first digit of a longitude is always its first digit. First, Dec

$$(\text d\lambda + 10) \text{ mod } 10$$

We can incorporate a 0.5 [deciday]{.tool data-bs-toggle="tooltip" data-bs-title="a tenth of a day"} shift into the expression above to turn a [d&lambda;]{.tool data-bs-toggle="tooltip" data-bs-title="deciparallels"} longitude into the difference between the [mst]{.tool data-bs-toggle="tooltip" data-bs-title="mean solar time"} at that longitude and the current Zone [0]{.color0} [tod]{.tool data-bs-toggle="tooltip" data-bs-title="time of day"}. [tzo]{.tool data-bs-toggle="tooltip" data-bs-title="time zone offset"}
This requirement also unifies the truncated, floored, and Euclidean definitions of modulo.

[tod]{.tool data-bs-toggle="tooltip" data-bs-title="time of day"} + tzo = mst - tzo
Unlike rounding, flooring does never changes the first digit of a positive number regardless of the remaining digits.

We could achieve the same effect with all numbers greater than negative ten and less than ten, -10 &lt; d&lambda; &lt; 10, by truncating instead of flooring.

We could Dec has no need for the In mathematics, flooring can be explained as $\text{trunc(x)} = \text{x} - \text{x} \text{ mod } 1$ and rounding is expressed as $\text{round(x)} = \lfloor\text{x} + 0.5\rfloor$. We can explain flooring as

Flooring is certainly faster than the complex logic needed for UTC [tzos]{.tool data-bs-toggle="tooltip" data-bs-title="time zone offsets"}, but the superiority of Dec is most clear in situations when calculations are unnessecary its [integer part](https://en.wikipedia.org/wiki/Floor_and_ceiling_functions#:~:text=The%20floor%20of%20x%20is%20also%20called%20the%20integral%20part%2C%20integer%20part%2C%20greatest%20integer%2C%20or%20entier%20of%20x). Instead of doing calculations, you can zero if there is no digit to the left of the decimal separator. When confronted with a  contrast, it is difficult to differentiate between highest [tzo]{.tool data-bs-toggle="tooltip" data-bs-title="time zone offset"} that rounds to 4 and lowest [tzo]{.tool data-bs-toggle="tooltip" data-bs-title="time zone offset"} that rounds to 5. 4.4994 that rounds to 4 and this  immediately know which time zone the
zones have no such shift not  and [mst]{.tool data-bs-toggle="tooltip" data-bs-title="mean solar time"} matches the time in the middle of  a zonal [tzo]{.tool data-bs-toggle="tooltip" data-bs-title="time zone offset"} to the Zone [0]{.color0} [tod]{.tool data-bs-toggle="tooltip" data-bs-title="time of day"} gives us the [mst]{.tool data-bs-toggle="tooltip" data-bs-title="mean solar time"} in the middle of the time zone associated with that zonal [tzo]{.tool data-bs-toggle="tooltip" data-bs-title="time zone offset"}.




$$\text{round(x)} = \lfloor\text{x} + 0.5\rfloor$$
...
that we can find the time zone that corresponds to a given mst by flooring its the Zone [0]{.color0} [tod]{.tool data-bs-toggle="tooltip" data-bs-title="time of day"} and the zonal [tzo]{.tool data-bs-toggle="tooltip" data-bs-title="time zone offset"} we get from
we can add to the Zone [0]{.color0} [tod]{.tool data-bs-toggle="tooltip" data-bs-title="time of day"} to obtain our
...
A longitude a [d&lambda;]{.tool data-bs-toggle="tooltip" data-bs-title="deciparallels"} longitude with 5 digits will be accurate to within about one [kilozem]{.tool data-bs-toggle="tooltip" data-bs-title="a thousand zone equatorial meters"} (kz). As a reference point, a perfectly cubic house with a side length of surface area of 1000 square zems (z^2^) would have a is a reasonable surface area for a house. With 6 digits, we  after the As we move from the Equator toward the North or South Pole, a longitude will eventually need fewer digits for the same level of accuracy. If we round a solar [tzo]{.tool data-bs-toggle="tooltip" data-bs-title="time zone offset"}to one digit afterrange for [tzos]{.tool data-bs-toggle="tooltip" data-bs-title="time zone offsets"} and [d&lambda;]{.tool data-bs-toggle="tooltip" data-bs-title="deciparallel"} longitudes is 0 &lt; x &lt; 10. a single-digit positive integer that
...
the result of flooring a [d&lambda;]{.tool data-bs-toggle="tooltip" data-bs-title="deciparallel"} longitude. to obtain an integer [tzo]{.tool data-bs-toggle="tooltip" data-bs-title="time zone offset"}. If we shift a [d&lambda;]{.tool data-bs-toggle="tooltip" data-bs-title="deciparallels"} longitude westward by half a [d&lambda;]{.tool data-bs-toggle="tooltip" data-bs-title="deciparallels"}, we get the [tzo]{.tool data-bs-toggle="tooltip" data-bs-title="time zone offset"} of the ["mean solar time"](https://en.wikipedia.org/wiki/Solar_time#Mean_solar_time:~:text=it%20follows%20an%20imaginary%20%22mean%20Sun%22%20that%20moves%20along%20the%20celestial%20equator%20at%20a%20constant%20rate%20that%20matches%20the%20real%20Sun%27s%20average%20rate%20over%20the%20year) that corresponds to that longitude.

[d&lambda;]{.tool data-bs-toggle="tooltip" data-bs-title="deciparallels"} longitude by shifting westward by half a [d&lambda;]{.tool data-bs-toggle="tooltip" data-bs-title="deciparallels"} to produce the [tzo]{.tool data-bs-toggle="tooltip" data-bs-title="time zone offset"} of its corresponding

half a [d&lambda;]{.tool data-bs-toggle="tooltip" data-bs-title="deciparallels"} to produce a [tzo]{.tool data-bs-toggle="tooltip" data-bs-title="time zone offset"} that we can add to Zone 0 .
...
measured in [d&lambda;]{.tool data-bs-toggle="tooltip" data-bs-title="deciparallels"},to make it positive. When we floor a [d&lambda;]{.tool data-bs-toggle="tooltip" data-bs-title="deciparallels"} longitude, we get the [tzo]{.tool data-bs-toggle="tooltip" data-bs-title="time zone offset"} of its corresponding Dec time zone. If we subtract half a [d&lambda;]{.tool data-bs-toggle="tooltip" data-bs-title="deciparallels"} to the longitude instead of flooring it, we will have the difference between the Zone [0]{.color0} [tod]{.tool data-bs-toggle="tooltip" data-bs-title="time of day"} and the ["mean solar time"](https://en.wikipedia.org/wiki/Solar_time#Mean_solar_time:~:text=it%20follows%20an%20imaginary%20%22mean%20Sun%22%20that%20moves%20along%20the%20celestial%20equator%20at%20a%20constant%20rate%20that%20matches%20the%20real%20Sun%27s%20average%20rate%20over%20the%20year) ([mst]{.tool data-bs-toggle="tooltip" data-bs-title="mean solar time"}).
...
In Dec, [tods]{.tool data-bs-toggle="tooltip" data-bs-title="times of day"}, [msts]{.tool data-bs-toggle="tooltip" data-bs-title="mean solar times"}, [&lambda;]{.tool data-bs-toggle="tooltip" data-bs-title="deciparallels"}, and [asts]{.tool data-bs-toggle="tooltip" data-bs-title="apparent solar times"} are bound between -1 and 1. equations above make sure that the The equation above works for any [tod] in days and longitude in [&lambda;]{.tool data-bs-toggle="tooltip" data-bs-title="parallels"}, even those that are outside the typical bounds. In Dec, less than zero or greater than one (0 &le; x &lt; 1). If we ever need to deal with an negative values, we can always add one and then keep the remainder after dividing by one. Zone [0]{.color0} starts at a longitude of 0 [d&lambda;]{.tool data-bs-toggle="tooltip" data-bs-title="deciparallels"} and is 1 [d&lambda;]{.tool data-bs-toggle="tooltip" data-bs-title="deciparallels"} wide. In contrast,  0.5 [d&lambda;]{.tool data-bs-toggle="tooltip" data-bs-title="deciparallels"} it is midnight in , the [mst] in  Unlike [UT]{.tool data-bs-toggle="tooltip" data-bs-title="Universal Time"}, [ast]{.tool data-bs-toggle="tooltip" data-bs-title="apparent solar time"} also varies by longitude and is cyclical on a yearly basis. To approximate [ast]{.tool data-bs-toggle="tooltip" data-bs-title="apparent solar time"} for a given [deci[parallel](https://en.wikipedia.org/wiki/Circle_of_latitude#:~:text=an%20abstract%20east%E2%80%93west%20small%20circle%20connecting%20all%20locations%20around%20Earth%20(ignoring%20elevation)%20at%20a%20given%20latitude%20coordinate%20line)]{.tool data-bs-toggle="tooltip" data-bs-title="a tenth of a parallel"} [longitude](https://en.wikipedia.org/wiki/Longitude#:~:text=denoted%20by%20the%20Greek%20letter%20lambda) ([d&lambda;]{.tool data-bs-toggle="tooltip" data-bs-title="deciparallels"}) and [doy]{.tool data-bs-toggle="tooltip" data-bs-title="day of year"}, we sum the Zone [0]{.color0} [tod]{.tool data-bs-toggle="tooltip" data-bs-title="time of day"}, [d&lambda;]{.tool data-bs-toggle="tooltip" data-bs-title="deciparallels"}, and the result obtained from plugging the [doy]{.tool data-bs-toggle="tooltip" data-bs-title="day of year"} into the [equation of time](https://en.wikipedia.org/wiki/Equation_of_time#:~:text=the%20discrepancy%20between%20two%20kinds%20of%20solar%20time) ([eot]{.tool data-bs-toggle="tooltip" data-bs-title="equation of time"}): \${zeroTimeHsl2} + \${longInputHsl} + \${eotHsl} = \${eotSumHsl}.
...
In the equations above, $\tau$ is two times $\pi$, n is the number of days in a year, the "time of year" ([toy]{.tool data-bs-toggle="tooltip" data-bs-title="time of year"}) is the [doy]{.tool data-bs-toggle="tooltip" data-bs-title="day of year"} divided by n, $\gamma$ is the [toy]{.tool data-bs-toggle="tooltip" data-bs-title="time of year"} multiplied by $\tau$, "mean solar time" ([mst]{.tool data-bs-toggle="tooltip" data-bs-title="mean solar time"}) is the Zone [0]{.color0} [tod]{.tool data-bs-toggle="tooltip" data-bs-title="time of day"} plus [d&lambda;]{.tool data-bs-toggle="tooltip" data-bs-title="deciparallels"}. We can refer to [d&lambda;]{.tool data-bs-toggle="tooltip" data-bs-title="deciparallels"} as the [mst]{.tool data-bs-toggle="tooltip" data-bs-title="mean solar time"} [tzo]{.tool data-bs-toggle="tooltip" data-bs-title="time zone offset"} and the sum of [d&lambda;]{.tool data-bs-toggle="tooltip" data-bs-title="deciparallels"} and [eot]{.tool data-bs-toggle="tooltip" data-bs-title="equation of time"}($\gamma$) as the [ast]{.tool data-bs-toggle="tooltip" data-bs-title="apparent solar time"} [tzo]{.tool data-bs-toggle="tooltip" data-bs-title="time zone offset"}. Using the coefficients shown below, we can plot [eot]{.tool data-bs-toggle="tooltip" data-bs-title="equation of time"}($\gamma$) against [doy]{.tool data-bs-toggle="tooltip" data-bs-title="day of year"}:
