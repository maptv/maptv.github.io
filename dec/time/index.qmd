...
app = {
  ...
  const renderSolarSystem = () => {
    ...
    svg.selectAll("#solar-system").call(solarSystem,
                                        majwid * (width < 527 ? .9 : width < 700 ? .95 : width < 769 ? .96 : width < 1000 ? .9 : width < 1100 ? .91 : width < 1200 ? .92 : width < 1300 ? .92 : width < 1400 ? .92 : width < 1500 ? .93 : width < 1600 ? .94 : .96),
                                        location,
                                        selection.date,
                                        selection.hour,
                                        window.darkmode);
  ...
  /* Draw orbit */
    ...
    d3.range(12).map((m) => {
      ...
      solarSystem
        ...
        .attr(
          "y",
          (solarSystemRadius + 2 - majwid / 2.8) * 7 * stretch * Math.cos(startMonthAngle) + Math.sign(Math.cos(startMonthAngle)) * (width < 300 ? 4 : width < 400 ? 5 : width < 500 ? 6 : width < 600 ? 7 : width < 700 ? 8 : width < 769 ? 5 : width < 800 ? 13.5 : width < 850 ? 13.75 : width < 900 ? 14 : width < 950 ? 15 : width < 1000 ? 16 : width < 1100 ? 20 : width < 1200 ? 20 : width < 1300 ? 20 : width < 1400 ? 20 : 12)
        )
