...
For [everyday life](https://en.wikipedia.org/wiki/Everyday_life), we should limit the length of [tods]{.tool data-bs-toggle="tooltip" data-bs-title="times of day"} to the three digits needed to show [millidays]{.tool data-bs-toggle="tooltip" data-bs-title="thousandths of a day"} or the five digits required to display [beats]{.tool data-bs-toggle="tooltip" data-bs-title="hundred thousandths of a day"} ([b]{.tool data-bs-toggle="tooltip" data-bs-title="beats"}).

When the current [tod]{.tool data-bs-toggle="tooltip" data-bs-title="time of day"} is shown with seven digits, the sixth digit changes too quickly to be read out loud and seventh changes so fast that it appears as a blur. At the Equator, a longitude that has seven digits is accurate to within about ten [zems]{.tool data-bs-toggle="tooltip" data-bs-title="zone equatorial meters"} (z) or four [meters](https://en.wikipedia.org/wiki/Metre#:~:text=the%20base%20unit%20of%20length%20in%20the%20International%20System%20of%20Units), which is roughly the length of a [subcompact car](https://www.dimensions.com/collection/subcompact-cars-b-segment) or the width of a [U-shaped living room layout](https://www.dimensions.com/collection/living-room-layouts).

The Equator is exactly one [&lambda;]{.tool data-bs-toggle="tooltip" data-bs-title="parallel"} or approximately [10^5^]{.tool data-bs-toggle="tooltip" data-bs-title="a hundred thousand"} [kilozems]{.tool data-bs-toggle="tooltip" data-bs-title="a thousand zone equatorial meters"} ([kz]{.tool data-bs-toggle="tooltip" data-bs-title="kilozem"}) long and there are [10^5^]{.tool data-bs-toggle="tooltip" data-bs-title="a hundred thousand"} [b]{.tool data-bs-toggle="tooltip" data-bs-title="beats"} in a day. Therefore, if we move one [kz]{.tool data-bs-toggle="tooltip" data-bs-title="kilozem"} along the Equator, our longitude will differ by about one [centimilliparallel]{.tool data-bs-toggle="tooltip" data-bs-title="a hundred thousandth of a parallel"} and our [sto]{.tool data-bs-toggle="tooltip" data-bs-title="solar time offset"} will change by roughly one [b]{.tool data-bs-toggle="tooltip" data-bs-title="beat"} or one [centimilliday]{.tool data-bs-toggle="tooltip" data-bs-title="a hundred thousandth of a day"}.

In other words, a [sto]{.tool data-bs-toggle="tooltip" data-bs-title="solar time offset"} that has five digits can be accurate to within one [b]{.tool data-bs-toggle="tooltip" data-bs-title="beat"}.

As we move along a [meridan](https://en.wikipedia.org/wiki/Meridian_(geography)#:~:text=the%20locus%20connecting%20points%20of%20equal%20longitude) away from the Equator towards the North or South Pole, the length of a [&lambda;]{.tool data-bs-toggle="tooltip" data-bs-title="parallel"} decreases, while our longitude and [sto]{.tool data-bs-toggle="tooltip" data-bs-title="solar time offset"} remain unchanged.
