...
The code can convert between a Zone [0]{.color0} [tod]{.tool data-bs-toggle="tooltip" data-bs-title="time of day"} and a [UTC]{.tool data-bs-toggle="tooltip" data-bs-title="Coordinated Universal Time"} [hms]{.tool data-bs-toggle="tooltip" data-bs-title="hour minute second"} triplet. According to Dec and all four of the programming languages used above, [UTC]{.tool data-bs-toggle="tooltip" data-bs-title="Coordinated Universal Time"} does not have any [leap seconds](https://en.wikipedia.org/wiki/Leap_second#:~:text=one%2Dsecond%20adjustment). In Dec, leap days can increase the duration of a year from 365 to 366 days, but days always have the same duration and therefore cannot have leap seconds.

Instead of changing the duration of a day, Dec handles leap seconds by adding them to a time zone offset ([tzo]{.tool data-bs-toggle="tooltip" data-bs-title="time zone offset"}). When a leap second needs to be inserted, Dec simply shifts the [tzo]{.tool data-bs-toggle="tooltip" data-bs-title="time zone offset"} by 1/8640 decidays. If we add the [tzo]{.tool data-bs-toggle="tooltip" data-bs-title="time zone offset"} selected by the range input below to the Zone [0]{.color0} [tod]{.tool data-bs-toggle="tooltip" data-bs-title="time of day"}, we get x.xxxx. If we also add 27 leap seconds, the [tod]{.tool data-bs-toggle="tooltip" data-bs-title="time of day"} will be x.xxxx and the [tzo]{.tool data-bs-toggle="tooltip" data-bs-title="time zone offset"} will be x/320.
