...
When the subtrahend is the timestamp of an event, the difference can be the time elapsed since the event. Dec timestamps typically consist of a "year of era" ([yoe]{.tool data-bs-toggle="tooltip" data-bs-title="year of era"}), a [yda]{.tool data-bs-toggle="tooltip" data-bs-title="yearly day aggregate"}, and a [tzo]{.tool data-bs-toggle="tooltip" data-bs-title="time zone offset"}, but we can omit the [tzo]{.tool data-bs-toggle="tooltip" data-bs-title="time zone offset"} if it is zero. If we replace the [yda]{.tool data-bs-toggle="tooltip" data-bs-title="yearly day aggregate"} with a subtrahend and difference, we can omit the [yoe]{.tool data-bs-toggle="tooltip" data-bs-title="year of era"} and then calculate it later using the equations below:

$$\text{x} = \text{eda} - \text{subtrahend} - \text{difference}$$

$$\text{coe} = \Biggl \lfloor \frac{\begin{cases}\text{x}&{\text{if } \text{x} \geq 0;}\\\text{x}-146096&{\text{otherwise.}}\end{cases}}{146097} \Biggr \rfloor$$

$$\text{doc} = \text{x} - \text{coe} \times 146097$$
