...
Plot.plot({
  ...
  marginLeft: 75,
  y: { label: null },
  x: { grid: true, label: "Population (billions)", labelOffset: 42, transform: d => d / 1e9 },
  marks: [
...
:::{.overflowequation style="overflow-x:auto;overflow-y:hidden;"}
$$\text{da} = \arccos\left( \frac{\text{costau(0.252314)} - \text{sintau(sda)} \times \text{sintau($\phi$)}}{\text{costau(sda)} \times \text{costau($\phi$)}} \right) \div \pi$$
:::
