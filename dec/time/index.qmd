...
To obtain a [da]{.tool data-bs-toggle="tooltip" data-bs-title="half day arc"}

:::{.overflowequation style="overflow-x:auto;overflow-y:hidden;"}
$$\text{hda} = \arccos\left( \frac{\text{costau(0.252314)} - \text{sintau(sda)} \times \text{sintau($\phi$)}}{\text{costau(sda)} \times \text{costau($\phi$)}} \right) \div \tau$$
:::

:::{.overflowequation style="overflow-x:auto;overflow-y:hidden;"}
$$\text{fda} = \arccos\left( \frac{\text{costau(0.252314)} - \text{sintau(sda)} \times \text{sintau($\phi$)}}{\text{costau(sda)} \times \text{costau($\phi$)}} \right) \div \pi$$
:::
