...
Click the map🗺️below⬇️to change the positions📍of Points [0]{.red} and [1]{.azul}. The "Reset" button brings the points back to their default positions📍. By default, these two points are 1 [decitaur]{.under .tool data-bs-toggle="tooltip" data-bs-title="a tenth of the circumference of Earth"} ($1\text d\tau r$) apart: [Point 0]{.red} is at [8]{.red} [decilambdas]{.under .tool data-bs-toggle="tooltip" data-bs-title="tenths of a circle of longitude"} ($\text d\href{https://en.wikipedia.org/wiki/Longitude#:~:text=denoted%20by%20the%20Greek%20letter%20lambda}{\lambda}$) and [0]{.red} [deciphis]{.under .tool data-bs-toggle="tooltip" data-bs-title="tenths of a circle of latitude"} ($\text d\href{https://en.wikipedia.org/wiki/Latitude#:~:text=denoted%20by%20the%20Greek%20lower%2Dcase%20letter%20phi}{\phi}$), which is [Santa Fe Island](https://en.wikipedia.org/wiki/Santa_Fe_Island#:~:text=a%20small%20island%20of%2024%20square%20kilometres%20(9.3%C2%A0sq%C2%A0mi)%20which%20lies%20in%20the%20middle%20of%20the%20Gal%C3%A1pagos%20Archipelago%20in%20Ecuador)🏝️in the [Galápagos archipelago](https://en.wikipedia.org/wiki/Gal%C3%A1pagos_Islands#:~:text=an%20archipelago%20of%20volcanic%20islands%20in%20the%20Eastern%20Pacific), and [Point 1]{.azul} is at [8]{.azul}$\text d\href{https://en.wikipedia.org/wiki/Longitude#:~:text=denoted%20by%20the%20Greek%20letter%20lambda}{\lambda}$ and [1]{.azul}$\text d\href{https://en.wikipedia.org/wiki/Latitude#:~:text=denoted%20by%20the%20Greek%20lower%2Dcase%20letter%20phi}{\phi}$, which is [Memphis, Tennessee](https://en.wikipedia.org/wiki/Memphis,_Tennessee#:~:text=a%20city%20in%20the%20U.S.%20state%20of%20Tennessee).

An airplane✈️flying at an average speed of 100$\text m\tau r\over\text d$ could travel between the default Point [0]{.red} and [1]{.azul} positions📍in 1d. Currently, [Point 0]{.red} is at [\${Math.floor(long2turn(Place_A[0], 3))}]{.red} [millilambdas]{.under .tool data-bs-toggle="tooltip" data-bs-title="thousandths of a circle of longitude"} ($\text m\href{https://en.wikipedia.org/wiki/Longitude#:~:text=denoted%20by%20the%20Greek%20letter%20lambda}{\lambda}$) and [\${Math.floor(lati2turn(Place_A[1], 3))}]{.red} [milliphi]{.under .tool data-bs-toggle="tooltip" data-bs-title="thousandths of a circle of latitude"} ($\text m\href{https://en.wikipedia.org/wiki/Latitude#:~:text=denoted%20by%20the%20Greek%20lower%2Dcase%20letter%20phi}{\phi}$), and [Point 1]{.azul} is at [\${Math.floor(long2turn(Place_B[0], 3))}]{.azul}$\text m\href{https://en.wikipedia.org/wiki/Longitude#:~:text=denoted%20by%20the%20Greek%20letter%20lambda}{\lambda}$ and [\${Math.floor(lati2turn(Place_B[1], 3))}]{.azul}$\text m\href{https://en.wikipedia.org/wiki/Latitude#:~:text=denoted%20by%20the%20Greek%20lower%2Dcase%20letter%20phi}{\phi}$. At an average speed of \${travelspeed}$\text m\tau r\over\text d$, we could cover the \${distance_mtaur} millitaur ($\text m\tau r$) distance between Points [0]{.red} and [1]{.azul} in ${traveltime} millidays (md).
...
We can think of [centimeridians]{.under .tool data-bs-toggle="tooltip" data-bs-title="hundredths of a meridian"} per day ($\text c\tau r\over\text d$) as a percent (%) and [millimeridians]{.under .tool data-bs-toggle="tooltip" data-bs-title="thousandths of a meridian"} per day ($\text m\tau r\over\text d$) as a [permille](https://en.wikipedia.org/wiki/Per_mille#:~:text=indicates%20parts%20per%20thousand) (‰) of the equatorial speed at which Earth🌏rotates on its axis. Conversion of $\text m\tau r$ to kilometers (km) or meters (m) and days to hours (h) or seconds (s) is straightforward: 1$\text m\tau r$ = 40km = 40000m, 1d = 24h = 86400s, and 1$\text m\tau r\over\text d$ = 1.[6]{style="text-decoration-line:overline;"}$\text{km}\over\text h$ = 2.16$\text m\over\text s$.
...
permission to land The Dec analogs of meters and seconds of a meter (m) is called **z**one **e**quatorial **m**icrowidth or **zem** (z). 
