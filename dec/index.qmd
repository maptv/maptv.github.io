...
The distinguishing characteristics of Dec are its simplicity and consistency. These qualities are evident when comparing Dec and [UTC](https://en.wikipedia.org/wiki/Coordinated_Universal_Time#:~:text=the%20primary%20time%20standard%20globally%20used%20to%20regulate%20clocks%20and%20time) time zones using the toggle✅inputs beneath the world🌏map🗺️below⬇️. The 10 Dec time zones are all 1 [deciturn]{.under .tool data-bs-toggle="tooltip" data-bs-title="a tenth of a turn"} wide, whereas the 40 UTC time zones shown on the map frequently deviate from a width of 41⅔ [milliturns]{.under .tool data-bs-toggle="tooltip" data-bs-title="thousandths of a turn"} to conform to political and geographic boundaries.

By default, the 
Using the toggle✅inputs, we supplement the map with more than 
by the world 🌏map 🗺️ below ⬇️. By default, the map shows that 
