...
Dec time⏳measurement is comparable to the [ISO🌐8601](https://en.wikipedia.org/wiki/ISO_8601#:~:text=an%20international%20standard%20covering%20the%20worldwide%20exchange%20and%20communication%20of%20date%20and%20time%2Drelated%20data) international date📅and time⏳standard. In particular, the ISO🌐[yyyy]{.yellow}-[mm]{.mulberry}-[dd]{.magenta}T[hh]{.hardwood}:[mm]{.maroon}:[ss]{.sienna}+[hh]{.hardwood}:[mm]{.maroon} format is equivalent to the Dec snap🫰[year]{.yellow}+[day.clock]{.cyan}-[z]{.lime} format. Both formats represent a [point in time](https://en.m.wikipedia.org/wiki/Instant#:~:text=an%20infinitesimal%20interval%20in%20time) and have multiple components that are organized by scale from the largest to the smallest.
...
The [doy]{.under .tool data-bs-toggle="tooltip" data-bs-title="day-of-year"} in a middle of the Dec format acts as the Dec analog of a month, day of month dom, hour, minute, and second.

The integer part of the [doy]{.under .tool data-bs-toggle="tooltip" data-bs-title="day-of-year"}, , identifies a day in the given year and the fractional part is the time of day tod: . The Dec and ISO years are the same for the first 306 days of the Dec year. When the [doy]{.under .tool data-bs-toggle="tooltip" data-bs-title="day-of-year"} is greater than or equal to [306]{.under .tool data-bs-toggle="tooltip" data-bs-title="January 1"}, the Dec year is one less than the ISO year.
...
, 
The Dec analog of UTC+00:00, Zone [0]{.lime}, is on the left side of the map🗺️below.


The Dec and ISO years are the same for the first 306 days of the Dec year. When the [doy]{.under .tool data-bs-toggle="tooltip" data-bs-title="day-of-year"} is greater than or equal to [306]{.under .tool data-bs-toggle="tooltip" data-bs-title="January 1"}, the Dec year is one less than the ISO year.


The [doy]{.under .tool data-bs-toggle="tooltip" data-bs-title="day-of-year"} does more than just identify a specific moment in time.

big endian and thus start with the the largest unit, the year. , start with a year, and end with a time zone. 

The [doy]{.under .tool data-bs-toggle="tooltip" data-bs-title="day-of-year"} [day.clock]{.cyan} in a snap🫰

The current ISO🌐8601 [combined date📅and time⏳](https://en.wikipedia.org/wiki/ISO_8601#Combined_date_and_time_representations:~:text=A%20single%20point%20in%20time%20can%20be%20represented%20by%20concatenating%20a%20complete%20date%20expression%2C%20the%20letter%20%22T%22%20as%20a%20delimiter%2C%20and%20a%20valid%20time%20expression)in the [UTC+00:00](https://en.wikipedia.org/wiki/UTC%2B00:00#:~:text=a%20time%20offset%20from%20UTC%20of%20%2B00%3A00) time⏳zone is [\${String(isoYear).padStart(4, "0")}]{.yellow}-[\${String(month).padStart(2, "0")}]{.mulberry}-[\${String(decDotm).padStart(2, "0")}]{.magenta}T[\${String(isoHour).padStart(2, "0")}]{.hardwood}:[\${String(isoMinute).padStart(2, "0")}]{.maroon}:[\${String(isoSecond).padStart(2, "0")}]{.sienna}+[00]{.hardwood}:[00]{.maroon}. 

the Dec[\${String(decYear).padStart(4, "0")}]{.yellow}+[\${String(decDate).padStart(3, "0")}]{.cyan}.[\${decTime.toFixed(5).slice(2)}]{.cyan}+[0]{.lime}.
 snap🫰
