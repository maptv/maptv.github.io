...
In both the ISO format, , and Dec format, year+day.clock-z, the year is at the beginning and the time zone is at the end. The number in the middle of the Dec format, which is called a day-of-year ([doy]{.under .tool data-bs-toggle="tooltip" data-bs-title="day-of-year"}), acts as the Dec analog of a month, day of month dom, hour, minute, and second. The integer part of the [doy]{.under .tool data-bs-toggle="tooltip" data-bs-title="day-of-year"}, , identifies a day in the given year and the fractional part is the time of day tod: . The Dec and ISO years are the same for the first 306 days of the Dec year. When the [doy]{.under .tool data-bs-toggle="tooltip" data-bs-title="day-of-year"} is greater than or equal to [306]{.under .tool data-bs-toggle="tooltip" data-bs-title="January 1"}, the Dec year is one less than the ISO year.


The ISO🌐8601 format is [year]{.yellow}-[mm]{.mulberry}-[dd]{.magenta}T[hh]{.hardwood}:[mm]{.maroon}:[ss]{.sienna}+[hh]{.hardwood}:[mm]{.maroon}.
