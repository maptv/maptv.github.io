...
In the scope of time⏳measurement, Dec is comparable to the [ISO🌐8601](https://en.wikipedia.org/wiki/ISO_8601#:~:text=an%20international%20standard%20covering%20the%20worldwide%20exchange%20and%20communication%20of%20date%20and%20time%2Drelated%20data) international date📅and time⏳standard. The ISO🌐8601 [combined date📅and time⏳representation](https://en.wikipedia.org/wiki/ISO_8601#Combined_date_and_time_representations:~:text=A%20single%20point%20in%20time%20can%20be%20represented%20by%20concatenating%20a%20complete%20date%20expression%2C%20the%20letter%20%22T%22%20as%20a%20delimiter%2C%20and%20a%20valid%20time%20expression) of the current [UTC+00:00](https://en.wikipedia.org/wiki/UTC%2B00:00#:~:text=a%20time%20offset%20from%20UTC%20of%20%2B00%3A00) time⏳, [\${String(isoYear).padStart(4, "0")}]{.yellow}-[\${String(month).padStart(2, "0")}]{.mulberry}-[\${String(decDotm).padStart(2, "0")}]{.magenta}T[\${String(isoHour).padStart(2, "0")}]{.hardwood}:[\${String(isoMinute).padStart(2, "0")}]{.maroon}:[\${String(isoSecond).padStart(2, "0")}]{.sienna}+[00]{.hardwood}:[00]{.maroon}, is equivalent to the Dec snap🫰[\${String(decYear).padStart(4, "0")}]{.yellow}+[\${String(decDate).padStart(3, "0")}]{.cyan}.[\${decTime.toFixed(5).slice(2)}]{.cyan}+[0]{.lime}. The Dec analog of the UTC+00:00, Zone [0]{.lime}, is shown on the left side of the map🗺️below.
