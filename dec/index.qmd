...
The color🎨wheel compass🧭below⬇️rotates🔄in response to the [Observable](https://observablehq.com) [range](https://observablehq.com/@observablehq/input-range)🎚️input and [hue bar](https://observablehq.com/@paavanb/progressive-color-picker)📊input beneath it. These inputs are capable of selecting all three [additive](https://en.wikipedia.org/wiki/Primary_color#:~:text=summing%20the%20spectral%20power%20distributions%20(the%20intensity%20of%20each%20wavelength)%20of%20the%20individual%20light%20sources) ([red]{.red}=0, [green]{.lime}=1/3=.[3]{style="text-decoration-line:overline;"}, [blue]{.azul}=2/3=.[6]{style="text-decoration-line:overline;"}) and all three [subtractive](https://en.wikipedia.org/wiki/Primary_color#:~:text=predicts%20the%20resultant%20spectral%20power%20distribution%20of%20light%20filtered%20through%20overlaid%20partially%20absorbing%20materials) ([yellow]{.yellow}=1/6=.1[6]{style="text-decoration-line:overline;"}, [cyan]{.cyan}=1/2=0.5, [magenta]{.magenta}=5/6=.8[3]{style="text-decoration-line:overline;"}) [primary colors](https://en.wikipedia.org/wiki/Primary_color#:~:text=colorants%20or%20colored%20lights%20that%20can%20be%20mixed%20in%20varying%20amounts%20to%20produce%20a%20gamut%20of%20colors), because the integer milliturn shown by the range🎚️input, \${rainbowMtr0}, is converted to a degree and rounded: .
