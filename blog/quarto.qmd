...
To demonstrate some of the many free website hosting options, I published four identical blogs using different hosts: <https://maptv.quarto.pub>, <https://maptv.netlify.app>, <https://maptv.github.io>, and <https://maptv.gitlab.io>. If you want to host your site on [Quarto Pub](https://quartopub.com), [Netlify](https://www.netlify.com), or [GitHub Pages](https://pages.github.com), the Quarto [publishing documentation](https://quarto.org/docs/publishing/#getting-started) is all you need.

::: {.callout-warning}
GitLab Pages is not officially supported by Quarto! If you are just starting out, you should choose one of the other options and skip down to @sec-nav.
:::
...
::: {#exm-qp}
```{.sh}
alias qp="quarto publish --no-prompt --no-browser --no-render quarto-pub; quarto publish --no-prompt --no-browser --no-render netlify; quarto publish --no-prompt --no-browser --no-render gh-pages;"
```
:::
