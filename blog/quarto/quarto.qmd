...
With `quarto` `publish`, you can render your site and then deploy it with one [shell](https://en.wikipedia.org/wiki/Unix_shell#:~:text=A%20Unix%20shell%20is%20a%20command%2Dline%20interpreter%20or%20shell%20that%20provides%20a%20command%20line%20user%20interface%20for%20Unix%2Dlike%20operating%20systems.) command. Using `quarto` `publish` is the easiest and simplest way to update a Quarto site, but I nevertheless greatly prefer to use the Git workflow shown in @fig-git.
