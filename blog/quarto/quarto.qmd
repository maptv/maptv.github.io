...
If you want to have your website hosted on GitHub Pages, you will need [set `gh-pages` as your source branch](https://quarto.org/docs/publishing/github-pages.html#source-branch). For GitLab Pages, you will need to add a `.gitlab-ci.yml` file to your repo and update your `_quarto.yml` file as shown in @exm-yml.
