...
To set up [G3] alongside [G2], all we have to do is create a `.github/workflows` directory and add a `publish.yml` file. @exm-curl contains the `publish.yml` file I use for my own site and the shell code that can used to obtain this file.
...
After pushing the `.github/workflows/publish.yml` file, you can check the GitHub Actions :e
