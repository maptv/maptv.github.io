...
To solve this issue, I used the [`link-external-filter`](https://quarto.org/docs/output-formats/html-basics.html#external-links:~:text=the%20current%20tab).-,link%2Dexternal%2Dfilter,-A%20regular%20expression) property with this [regular expression](https://en.wikipedia.org/wiki/Regular_expression#:~:text=A%20regular%20expression%20(shortened%20as%20regex%20or%20regexp)%2C%5B1%5D%20sometimes%20referred%20to%20as%20rational%20expression%2C%5B2%5D%5B3%5D%20is%20a%20sequence%20of%20characters%20that%20specifies%20a%20match%20pattern%20in%20text.): `'^(?:http:|https:)\/\/www\.maptv\.(github|gitlab|netlify|quarto)'`.
