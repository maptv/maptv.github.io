...
This blog post is the third focuses on the use of [Quarto](https://quarto.org/#:~:text=An%20open%2Dsource%20scientific%20and%20technical%20publishing%20system) to author and publish digital content. As the third post in my [tools](..#category=tool) blog post series, which is summarized by @fig-navchart, and depends on the. is my blog post on [Quarto](https://quarto.org/#:~:text=An%20open%2Dsource%20scientific%20and%20technical%20publishing%20system). The subsequent posts in the series demonstrate how to use [Observable](https://quarto.org/docs/computations/ojs), [Jupyter](https://quarto.org/docs/reference/cells/cells-jupyter), and [Knitr](https://quarto.org/docs/reference/cells/cells-knitr) to execute code in Quarto documents.
...
flowchart TB
   ...
   click E "../knitr"
   click F "../jupyter"
   style C stroke:#99f,stroke-width:4px
```
