...
I will save my adventures with LLM for a [future post](llm.qmd). For now, I focus on tips for installing tools and setting up a project to use Git version control.
