...
My personal site is hosted on both [GitHub Pages](https://maptv.github.io) and [GitLab Pages](https://maptv.gitlab.io). To add or update the content on my site, I go through the steps in the standard Git workflow shown in @fig-git.
...
Briefly, `git` `add` labels changes to be included in a collection called a [commit](https://en.wikipedia.org/wiki/Commit_(version_control)#:~:text=In%20version%20control%20systems%2C%20a%20commit%20is%20an%20operation%20which%20sends%20the%20latest%20changes%20of%20the%20source%20code%20to%20the%20repository%2C%20making%20these%20changes%20part%20of%20the%20head%20revision%20of%20the%20repository.) by `git` `commit` and sent to a  `push`, which is . Commits can 
