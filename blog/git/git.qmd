...
Every Codespaces instance is pre-equipped with many commonly used tools, but we can use scripts like `setup.sh` to add anything that may be missing. [Codespaces](https://docs.github.com/en/codespaces) can allow to stay productive even when you are not on your own computer and you can keep your settings consistent across your remote and local development environments with [Settings Sync](https://docs.github.com/en/codespaces/setting-your-user-preferences/personalizing-github-codespaces-for-your-account#settings-sync).
