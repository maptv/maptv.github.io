...
Rather than repeat the basic information already available elsewhere, I will share some advanced techniques along with the fundamental knowledge needed to understand how they work. The topics covered are technical in nature, but my goal is to make the content on my blog as accessible as possible.

I followed the Quarto documentation to [create a blog](https://quarto.org/docs/websites/website-blog.html) and [publish it](https://quarto.org/docs/publishing/) to [GitHub Pages](https://quarto.org/docs/publishing/github-pages.html), Quarto Pub](https://quarto.org/docs/publishing/quarto-pub.html), and [Netlify](https://quarto.org/docs/publishing/netlify.html). All three of these are awesome free hosting options, but Quarto Pub is easiest to set up, while Netlify and GitHub offer additional features such as [Continuous Integration](https://quarto.org/docs/publishing/netlify.html#continuous-integration) and [GitHub Actions](https://quarto.org/docs/publishing/github-pages.html#github-action).

so the major differentiating factor is the domain: <https://maptv.github.io>, <https://maptv.quarto.pub>, or <https://maptv.netlify.app>. GitHub Pages may be more difficult if you are not already comfortable using the [git version control system](https://en.wikipedia.org/wiki/Git#:~:text=Git%20(/%C9%A1%C9%AAt/)%5B8%5D%20is%20a%20distributed%20version%20control%20system%5B9%5D%20that%20tracks%20changes%20in%20any%20set%20of%20computer%20files%2C%20usually%20used%20for%20coordinating%20work%20among%20programmers%20who%20are%20collaboratively%20developing%20source%20code%20during%20software%20development.), but 
