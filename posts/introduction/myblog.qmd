...
JavaScript, Python, and Lua are programming languages that have all have interesting origins to their names. JavaScript is named after Java☕, Python🐍is named after the [Monty Python](https://en.wikipedia.org/wiki/Monty_Python#:~:text=Monty%20Python%20(also%20collectively%20known%20as%20the%20Pythons)%5B2%5D%5B3%5D%20were%20a%20British%20comedy%20troupe%20formed%20in%201969) comedy troupe, and Lua is the Portuguese🇵🇹word for moon🌕!

::: panel-tabset
### JavaScript

``` {.javascript filename="index.qmd"}
<script>
