...
If you are not sure where to begin, I recommend starting with my articles on [Dec](dec){.bi .bi-arrow-repeat}, a measurement system that I created, and then continuing on my [Quarto](quarto){.bi .bi-markdown} section to learn about how I customized website to show Dec dates in every article and the navigation bar.
